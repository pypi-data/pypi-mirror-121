...
PREFERRED_VERSION = VersionInfo.parse("2.28.3")
...
class Saml2Aws(SAMLClient):
    ...
    def _login(self, show_prompt=False, force=False):
        ...
        if force or self.options.disable_caches or not self.has_creds():
            options["cache_saml"] = False
