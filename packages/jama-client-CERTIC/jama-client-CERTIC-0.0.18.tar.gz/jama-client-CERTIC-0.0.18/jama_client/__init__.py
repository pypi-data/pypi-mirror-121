...
class Client:
    ...
    def add_collection(
        self, title: str, parent_id: int = None, project_id: int = None
    ) -> Optional[Dict]:
        """
        ...
        ```
        """
        return self.__call("add_collection", [title, parent_id, project_id])
    ...
    def advanced_search(
        self, search_terms: List[Dict], project_id: int
    ) -> Dict[str, List]:
        """
        ...
        ```
        """
        return self.__call("advanced_search", [search_terms, project_id])
    ...
    def collection(
        self, collection_id: int = None, project_id: int = None
    ) -> Optional[Dict]:
        """
        ...
        ```
        """
        return self.__call("collection", [collection_id, project_id])
    ...
    def simple_search(self, query: str, project_id: int) -> Dict[str, List]:
        """
        ...
        ```
        """
        return self.__call("simple_search", [query, project_id])
