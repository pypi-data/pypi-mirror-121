...
class Distiller(Model):
    ...
    Args:
        student (tf.keras.Model): the student model
        teacher (tf.keras.Model): the well trained teacher model
    """
    ...
    def compile(self,
        ...
        Args:
            optimizer (tf.keras.optimizers.Optimizer): Keras optimizer
                for the student weights
            metrics (tf.keras.metrics.Metric): Keras metrics for evaluation
            student_loss_fn (tf.keras.losses.Loss): loss function of difference
                between student predictions and ground-truth
            distillation_loss_fn (tf.keras.losses.Loss): loss function of
