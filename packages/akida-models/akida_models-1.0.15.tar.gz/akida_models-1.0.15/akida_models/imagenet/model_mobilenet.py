...
def mobilenet_cats_vs_dogs_pretrained():
    ...
    file_hash = 'd65eb369844d6fa4ce5cee85c41ef3a662620d1a05b838df94c8d173b8f92b2c'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def mobilenet_imagenette_pretrained(alpha=1.0):
    ...
    if alpha == 1.0:
        ...
        file_hash = '99f9534763aaee3d92483c4b9c546370c094e78b48595d32ed41fb55020c2ea7'
    elif alpha == 0.5:
        model_name = 'mobilenet_imagenette_224_alpha_50_iq8_wq4_aq4.h5'
        file_hash = '45aab85907cee98a37077923df1e71b34aab146b98578dc05d316c7b2e7a6535'
    elif alpha == 0.25:
        model_name = 'mobilenet_imagenette_224_alpha_25_iq8_wq4_aq4.h5'
        file_hash = 'e8603c872b427ae6f530cfc46707a1c78ac227c8270cfa0278a292b3ff28b913'
    else:
        raise ValueError(
            f"Requested model with alpha={alpha} is not available.")
...
def mobilenet_faceidentification_pretrained():
    """
    Helper method to retrieve a `mobilenet_imagenet` model that was trained on
    ...
    """
    model_name = 'mobilenet_faceidentification_iq8_wq4_aq4.h5'
    file_hash = 'd12f1dbd40267b483056728252eb56f578403071dcd472e39143319d6c84096c'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def mobilenet_faceverification_pretrained():
    """
    Helper method to retrieve a `mobilenet_imagenet` model that was trained on
    ...
    """
    model_name = 'mobilenet_faceverification_iq8_wq4_aq4.h5'
    file_hash = 'ee54055f6baa38339c9f45632a0ef37c8b617fe81b9e68b709845b5d1a711919'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
