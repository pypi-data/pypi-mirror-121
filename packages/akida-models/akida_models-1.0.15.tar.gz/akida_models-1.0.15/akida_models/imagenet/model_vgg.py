...
def vgg_imagenet_pretrained():
    ...
    file_hash = '4f67883ef8b149454acd1525c77021f9d032579b0653ada4732a0d21185013ae'
...
def vgg_melanoma_pretrained():
    ...
    file_hash = 'b5788f56280149c5414ef8221c6632681fbfad715cf1a3cc25c079773d7dc779'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def vgg_odir5k_pretrained():
    ...
    file_hash = '32f8e6a035fdd21987f11f1a605e6f2e194d364ca7c3e52c4e9b40f523df44fd'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def vgg_retinal_oct_pretrained():
    ...
    file_hash = '0301b24ec7c33ac5d350618adaf8dd3300b62fc0655009d8326feb6f718a3ea8'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def vgg_ecg_pretrained():
    """
    Helper method to retrieve a `vgg_imagenet` model that was trained on ECG
    classification Physionet2017 dataset.

    Returns:
        tf.keras.Model: a Keras Model instance.

    """
    model_name = 'vgg11_ecg_iq8_wq4_aq4.h5'
    file_hash = '5a7ac2acc298fc599c412dd8c59ca7d0d6f1ce68a96ac56af7e2b293a4b52f4b'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
