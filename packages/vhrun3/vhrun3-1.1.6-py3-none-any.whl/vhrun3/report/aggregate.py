...
def aggregate(summary, test_path):
    flag_dict["flag"] = True  # 这句很重要，因为是全局变量
    step_datas = summary.step_datas
    ...
    return aggregated_summary, flag_dict["flag"]
