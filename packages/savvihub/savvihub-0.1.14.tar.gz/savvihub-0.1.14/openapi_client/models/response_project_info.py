...
class ResponseProjectInfo(object):
    ...
    def __init__(self, cached_git_default_branch=None, cached_git_http_url_to_repo=None, cached_git_owner_slug=None, cached_git_repo_slug=None, cached_git_ssh_url_to_repo=None, created_dt=None, description=None, experiment_summary=None, git_provider=None, id=None, is_connected=None, is_public=None, name=None, organization=None, primary_owner=None, type=None, updated_dt=None, volume_id=None, local_vars_configuration=None):  # noqa: E501
