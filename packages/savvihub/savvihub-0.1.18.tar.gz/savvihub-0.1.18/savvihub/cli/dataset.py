...
def download_dest_path_prompter(
    ...
    return click.prompt("Destination path",
                        default=f"./{ctx.obj['dataset_name']}" if ctx.obj.get("dataset_name") else ".")
...
@cli.vessl_command()
@vessl_argument("name", type=click.STRING, required=True, prompter=dataset_name_prompter)
@vessl_argument("source", type=click.Path(exists=True), required=True, prompter=generic_prompter("Source path"))
@vessl_argument("dest", type=click.Path(), required=True, prompter=generic_prompter("Destination path", default="/"))
@organization_name_option
...
@cli.vessl_command()
@vessl_argument("name", type=click.STRING, required=True, prompter=dataset_name_prompter, callback=dataset_name_callback)
@vessl_argument("source", type=click.Path(), required=True, prompter=generic_prompter("Source path", default="/"))
...
@cli.vessl_command()
@vessl_argument("name", type=click.STRING, required=True, prompter=dataset_name_prompter)
@vessl_argument("source", type=click.Path(), required=True, prompter=generic_prompter("Source path"))
@vessl_argument("dest", type=click.Path(), required=True, prompter=generic_prompter("Destination path"))
