...
class ResponseOrganizationInfo(object):
    ...
    def __init__(self, aws_external_id=None, created_dt=None, credit_balance=None, default_kernel_cluster=None, default_region=None, description=None, display_name=None, id=None, is_public=None, name=None, primary_owner_id=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
