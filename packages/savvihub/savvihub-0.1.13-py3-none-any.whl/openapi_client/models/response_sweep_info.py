...
class ResponseSweepInfo(object):
    ...
    def __init__(self, algorithm=None, cli_driven_project=None, created_by=None, created_dt=None, early_stopping_spec=None, env_vars=None, experiment_summary=None, histories=None, id=None, kernel_cluster=None, kernel_cluster_node=None, kernel_image=None, kernel_resource_spec=None, max_experiment_count=None, max_failed_experiment_count=None, message=None, name=None, objective=None, objective_step_median=None, organization=None, parallel_experiment_count=None, project=None, search_space=None, source_code_link=None, start_command=None, status=None, status_last_updated=None, status_reason=None, suggestion_histories=None, updated_dt=None, version_control_project=None, volume_mounts=None, local_vars_configuration=None):  # noqa: E501
