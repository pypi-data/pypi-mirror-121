...
class ProtoVolumeMountRequest(object):
    ...
    def __init__(self, dataset=None, dataset_version=None, empty_dir=None, local=None, mount_path=None, mount_type=None, output=None, project=None, readonly=None, volume=None, local_vars_configuration=None):  # noqa: E501
    ...
    def mount_type(self, mount_type):
        ...
        allowed_values = ["empty-dir", "project", "dataset", "dataset-version", "output", "volume", "local"]  # noqa: E501
