...
class OrmExperiment(object):
    ...
    def __init__(self, created_dt=None, distributed_spec=None, edges=None, experiment_created_by=None, experiment_plot_volume=None, experiment_project=None, experiment_sweep=None, id=None, immutable_slug=None, is_distributed=None, message=None, metrics_summary=None, name=None, number=None, termination_protection=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
