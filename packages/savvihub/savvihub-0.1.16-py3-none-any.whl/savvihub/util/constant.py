...
VESSL_LOG_LEVEL = (
    os.environ.get("SAVVIHUB_LOG")
    if os.environ.get("SAVVIHUB_LOG") in VESSL_LOG_LEVEL_LEVELS
...
ACCESS_TOKEN_ENV_VAR = "SAVVIHUB_ACCESS_TOKEN"
DEFAULT_ORGANIZATION_ENV_VAR = "SAVVIHUB_DEFAULT_ORGANIZATION"
CREDENTIALS_FILE_ENV_VAR = "SAVVIHUB_CREDENTIALS_FILE"
...
MOUNT_TYPE_DATSET_VERSION = "datset-version"
MOUNT_TYPE_EMPTY_DIR = "empty-dir"
MOUNT_TYPE_OUTPUT = "output"
MOUNT_TYPE_PROJECT = "project"

MOUNT_PATH_EMPTY_DIR = "/work/"
MOUNT_PATH_OUTPUT = "/output/"
MOUNT_PATH_PROJECT = "/work/{}"

PARALLEL_WORKERS = os.environ.get("SAVVIHUB_PARALLEL_WORKERS", 20)

VESSL_IMAGE_PATH = "savvihub-images"
