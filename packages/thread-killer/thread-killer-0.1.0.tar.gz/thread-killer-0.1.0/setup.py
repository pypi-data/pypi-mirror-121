...
setup(
  name = 'thread-killer',         # How you named your package folder (MyLib)
  packages = ['thread-killer'],   # Chose the same as "name"
  ...
  download_url = 'https://bitbucket.fixmost.com/projects/PAYS/repos/thread-killer/browse?at=refs%2Ftags%2F0.1.0',    # I explain this later on
