...
class SekkayBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, **kwargs) -> None:
        ...
        self.default_skin = "CID_NPC_Athena_Commando_M_Apparition_Heavy"
