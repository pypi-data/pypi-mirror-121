...
class DataProduct:
    ...
    def _as_payload(self) -> dict:
        ...
        payload["streamIds"] = self.pipeline_ids
        return payload
    ...
    def _from_payload(cls, json: dict) -> Union[DtlError, "DataProduct"]:
        ...
        if last_updated_by is None:
            return DtlError("Data Product object should have a 'lastUpdatedBy' property")
        else:
            try:
        ...
        if last_updated_at is None:
            return DtlError("Data Product object should have a 'lastUpdatedAt' property")
        else:
            try:
                last_updated_at = parse(last_updated_at)
            except ValueError:
                return DtlError("The 'lastUpdatedAt' could not be parsed as a valid date")
