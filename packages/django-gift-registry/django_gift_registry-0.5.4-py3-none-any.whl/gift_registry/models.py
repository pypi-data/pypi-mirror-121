...
class Gift(models.Model):
    ...
    one_only = models.BooleanField(
        ...
        help_text=(
            ...
            'some items such as gift vouchers, you may be happy to receive multiple.'))
    ...
    def get_absolute_url(self):
        return reverse('gift_detail', kwargs={'id': self.id})
...
class Giver(models.Model):
    ...
    def secret_key(self):
        ...
        return sha1((str(self.pk) + settings.SECRET_KEY).encode('utf-8')).hexdigest()[:URL_SIGNATURE_LENGTH]
