            ...
            if random.random() < float(self._vlog_size):
                ...
                if isinstance(image, dict):
                    ...
                    if max(image["input_image"].shape) > THUMB_SIZE:
                        ...
                        cv2.imwrite(os.path.join(self._dest_path, file_thumb), cv2.cvtColor(img, cv2.COLOR_BGR2RGB))
                    else:
                    ...
                    cv2.imwrite(os.path.join(self._dest_path, filename), cv2.cvtColor(image[0], cv2.COLOR_BGR2RGB))
                    file_stat_img = os.stat(os.path.join(self._dest_path, filename))
                    ...
                    if max(image[0].shape) > THUMB_SIZE:
                        ...
                        cv2.imwrite(os.path.join(self._dest_path, file_thumb), cv2.cvtColor(image[0], cv2.COLOR_BGR2RGB))
                    file_stat_thumb = os.stat(os.path.join(self._dest_path, file_thumb))
