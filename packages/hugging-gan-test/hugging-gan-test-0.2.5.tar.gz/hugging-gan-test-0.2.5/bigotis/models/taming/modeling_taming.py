...
class TamingDecoder(ImageGenerator):
    ...
    def compute_loss(
        ...
        promtp,
        z_logits,
        return_rec_img: bool = True,
    ):

        if not return_rec_img:
            return loss
        ...
        **kwargs,
        ...
        Args:
            ...
            generation_cb (function, optional): if provided, the 
                ...
                inputs of this function will be:  loss, step, x_rec, z_logits and step
        ...
        for step in range(num_steps):
            ...
            x_rec = self.get_img_rec_from_z(z_logits)
