...
class ImageGenerator(
    ...
    def __init__(self, ):
        ...
        self.clip_input_img_size = self.clip_model.visual.input_resolution
    ...
    def augment(
        ...
        Args:
            ...
            crop_scaler (int, optional): Scale range used when cropping. Defaults to 1.

        Returns:
            torch.Tensor: augmented batch of images.
        """
        if target_img_height is None:
            target_img_height = img_batch.shape[1]
        if target_img_width is None:
            target_img_width = img_batch.shape[2]
