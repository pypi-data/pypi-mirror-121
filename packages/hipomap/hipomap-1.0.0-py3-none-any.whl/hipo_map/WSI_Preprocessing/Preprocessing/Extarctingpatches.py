from hipo_map.Preprocessing.WSI_Scanning import readWSI
from hipo_map.Preprocessing.Denoising import denoising
from hipo_map.Preprocessing.Patch_extraction_creatia import patch_extraction_random, all_patches_extarction
import cv2
