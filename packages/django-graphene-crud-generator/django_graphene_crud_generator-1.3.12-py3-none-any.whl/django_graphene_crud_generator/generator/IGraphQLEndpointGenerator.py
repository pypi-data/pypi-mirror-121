...
class IGraphQLEndpointGenerator(IGraphQLEndpointComponent, abc.ABC):
    ...
    def generate(self, **kwargs) -> TGrapheneQuery:
        ...
        def perform_query(root, info, *args, **kwargs) -> any:
            ...
            for x in self.components:
                if hasattr(x, "_graphql_body_function_decorator_native") and x._graphql_body_function_decorator_native is not None:
                ...
                elif hasattr(x, "_graphql_body_function_decorator") and x._graphql_body_function_decorator is not None:
