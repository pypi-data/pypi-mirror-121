...
from build.lib.django_graphene_crud_generator.generator.AbstractGraphQLQueryGenerator import \
...
class AbstractReadGraphQLQueryGenerator(AbstractGraphQLQueryGenerator):
    ...
    def _generate_action_description(self, build_context: GraphQLBuildtimeContext) -> List[str]:
        ...
        description = [
            ...
            that satisfies the critera represented by the query parameters.
            """
        ]
