...
class PermissionComponent(IGraphQLEndpointComponent):
    ...
    def _graphql_body_function_decorator_native(self, body_function: GrapheneGeneratorBodyFunction, runtime_context: GraphQLRuntimeContext) -> GrapheneBodyFunction:
        return auth_decorators.graphql_ensure_user_has_permissions(
            perm=self.permissions(runtime_context.build_context)
        )(body_function)
