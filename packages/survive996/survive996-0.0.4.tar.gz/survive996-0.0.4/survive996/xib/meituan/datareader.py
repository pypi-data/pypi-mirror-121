...
def read_plaintext(path, product, table_name=None, iterator=False, chunk_size=None, skip_rows=0, **kwargs):
    '''
    Parameters
    ----------
    path
    ...
    return pd.read_csv(path, skiprows=skip_rows, encoding="utf-8", sep="\|\+\|", engine="python", header=None, names=metadata[product][table_name], dtype=metadata["dtype"], iterator=iterator, chunksize=chunk_size, **kwargs)
