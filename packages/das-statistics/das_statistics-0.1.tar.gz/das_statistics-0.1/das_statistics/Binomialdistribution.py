...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        n_combination_k = math.factorial(self.n) / (math.factorial(self.n - k) * math.factorial(k))
        p_part = (self.p ** k) * (1 - self.p) ** (self.n - k)

        return n_combination_k * p_part
    ...
    def plot_bar_pdf(self):
        ...
        plt.xlabel('positive outcome count')
