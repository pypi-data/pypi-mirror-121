...
def compute_features_phone(intermediate_participant_path, output_dir_path, date_in_study, lsf_json_folder_path, decryption_password):
    # Switch
    print_stats = False
    ...
    feature5, feature6, match_time_battery = feature_engineering_ema.battery_level.create_column(df_prompt['Prompt_Local_DateTime'], intermediate_participant_path, date_in_study)
    ...
    feature7, match_time_location = feature_engineering_ema.location.create_column(df_prompt['Prompt_Local_DateTime'], intermediate_participant_path, date_in_study, decryption_password)
    ...
    feature9, match_time_screen = feature_engineering_ema.screen_status.create_column(df_prompt['Prompt_Local_DateTime'], intermediate_participant_path, date_in_study)
    ...
    feature12, feature13, match_time_lock = feature_engineering_ema.phone_lock.create_column(df_prompt['Prompt_Local_DateTime'], intermediate_participant_path, date_in_study)
