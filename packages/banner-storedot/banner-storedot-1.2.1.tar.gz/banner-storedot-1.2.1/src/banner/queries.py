...
from banner.utils.const import FIRST_NEWARE_DATA_TABLE, SECOND_NEWARE_DATA_TABLE, FIRST_NEWARE_AUX_TABLE, SECOND_NEWARE_AUX_TABLE, NW_TEMP, CACHE_CONNECTION_KWARG, TTL_KWARG
from banner.utils.neware import calc_neware_cols, calc_dq_dv
...
def neware_query_by_test(table: str, cell: int, test: int, connection: Union[Connection, str] = None, cache_connection=None, ttl=None, raw=False, dqdv=False):
    ...
    return neware_query(*neware_keys, raw=raw, dqdv=dqdv)
