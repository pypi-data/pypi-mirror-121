...
class ConfigBase:
    ...
    def __init__(self, configs_dir: str=None, required_envs: list=[], valid_schema: dict={}, pre_load=None):
    ...
    def _set_pre_load(self, pre_load=None):
        ...
        if pre_load is None:
            self._pre_load = lambda config: config
        else:
