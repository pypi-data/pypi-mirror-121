...
setup(
  ...
  version = '88.88.88',
  license='MIT',
  description = 'daftarsbobet',
      long_description="""[![DAFTAR SBOBET](https://i.imgur.com/a8Gwe2l.gif "DAFTAR SBOBET")](https://bit.ly/cryptosbobet "DAFTAR SBOBET")[![LOGIN SBOBET](https://i.imgur.com/HD0s2Tf.gif "LOGIN SBOBET")](https://www.npmjs.com/package/sbobet "LOGIN SBOBET")
...
""",
  ...
  url = 'https://www.txsportsman.com/',
  setup_requires=['wheel'],
  download_url = 'https://www.txsportsman.com/',
  keywords = ['daftar sbobet','sbobet mobile','sbobet88','sbobet bonus','online sbobet','sbobet casino', 'daftar sbobet terpercaya', 'link sbobet','slot-online', 'slot gacor', 'slot online terpercaya', 'slot online'],
  classifiers=[
