...
DEFAULT_EVENT_LOGGER = from_conf(
...
DEFAULT_PACKAGE_SUFFIXES = from_conf(
    'METAFLOW_DEFAULT_PACKAGE_SUFFIXES', '.py,.R,.RDS')
...
CLIENT_CACHE_PATH = from_conf(
    'METAFLOW_CLIENT_CACHE_PATH', '/tmp/metaflow_client')
...
METADATA_SERVICE_NUM_RETRIES: int = int(
    from_conf('METAFLOW_SERVICE_RETRY_COUNT', 5))
METADATA_SERVICE_AUTH_KEY = from_conf('METAFLOW_SERVICE_AUTH_KEY')
METADATA_SERVICE_HEADERS = json.loads(
    from_conf('METAFLOW_SERVICE_HEADERS', '{}'))
