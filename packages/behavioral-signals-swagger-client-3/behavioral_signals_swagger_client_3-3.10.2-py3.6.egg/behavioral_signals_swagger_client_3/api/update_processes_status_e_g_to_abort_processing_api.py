...
class UpdateProcessesStatusEGToAbortProcessingApi(object):
    ...
    def update_processes(self, cid, **kwargs):  # noqa: E501
        ...
        :param ProcessesUpdate processes_update: List of process ids to update status for
    ...
    def update_processes_with_http_info(self, cid, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'processes_update']  # noqa: E501
        ...
        body_params = None
        if 'processes_update' in params:
            body_params = params['processes_update']
        # HTTP header `Accept`
