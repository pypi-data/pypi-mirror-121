...
class ResultJSONKpi(object):
    ...
    def __init__(self, escalation=None, resolution=None, agentperfscore=None, satisfaction=None, propensity=None, success=None, negativity=None, agent_empathy=None, trends=None, compliance=None):  # noqa: E501
    ...
    def negativity(self, negativity):
        ...
        :type: float
        """
        if negativity is not None and negativity > 1:  # noqa: E501
            raise ValueError("Invalid value for `negativity`, must be a value less than or equal to `1`")  # noqa: E501
        if negativity is not None and negativity < 0:  # noqa: E501
            raise ValueError("Invalid value for `negativity`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def agent_empathy(self):
        ...
        Probability that the agent exhibits empathy  # noqa: E501
    ...
    def agent_empathy(self, agent_empathy):
        ...
        :type: float
        """
        if agent_empathy is not None and agent_empathy > 1:  # noqa: E501
            raise ValueError("Invalid value for `agent_empathy`, must be a value less than or equal to `1`")  # noqa: E501
        if agent_empathy is not None and agent_empathy < 0:  # noqa: E501
            raise ValueError("Invalid value for `agent_empathy`, must be a value greater than or equal to `0`")  # noqa: E501
