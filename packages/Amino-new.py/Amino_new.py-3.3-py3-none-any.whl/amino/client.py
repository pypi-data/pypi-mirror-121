...
class Client(Callbacks, SocketHandler):
    ...
    def login(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/auth/login", json=data,headers=self.web_headers)
        self.run_socket()
    ...
    def register(self, nickname: str, email: str, password: str, verificationCode: str, deviceId: str = device.device_id):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/auth/register", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def restore(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/account/delete-request/cancel", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def logout(self):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/auth/logout", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else:
            self.authenticated = False
            self.json = None
    ...
    def configure(self, age: int, gender: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/persona/profile/basic", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def verify(self, email: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/auth/check-security-validation", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def request_verify_code(self, email: str, resetPassword: bool = False):
        ...
        **Returns**
        ...
        data = (data)
        response = requests.post(f"{self.apie}/g/s/auth/request-security-validation", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def activate_account(self, email: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/auth/activate-email", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def delete_account(self, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/account/delete-request", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def change_password(self, email: str, password: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/auth/reset-password", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def check_device(self, deviceId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/device", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: self.configured = True; return response.status_code

    def get_account_info(self):
        response = requests.get(f"{self.apie}/g/s/account", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def upload_media(self, file: BinaryIO, fileType: str):
        ...
        **Returns**
        ...
        data = file.read()
        response = requests.post(f"{self.apie}/g/s/media/upload", data=data, headers=headers.Headers(type=t, data=data, deviceId=self.device_id).headers, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_eventlog(self):
        response = requests.get(f"{self.apie}/g/s/eventlog/profile?language=en", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def sub_clients(self, start: int = 0, size: int = 25):
        ...
        **Returns**
        ...
        response = requests.get(f"{self.apie}/g/s/community/joined?v=1&start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_user_info(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/user-profile/{userId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_chat_threads(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/chat/thread?type=joined-me&start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_chat_thread(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/chat/thread/{chatId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.Thread(json.loads(response.text)["thread"]).Thread

    def get_chat_users(self, chatId: str, start: int = 0, size: int = 25):
        response = requests.get(f"{self.apie}/g/s/chat/thread/{chatId}/member?start={start}&size={size}&type=default&cv=1.2", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def join_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apie}/g/s/chat/thread/{chatId}/member/{self.userId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def leave_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apie}/g/s/chat/thread/{chatId}/member/{self.userId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def start_chat(self, userId: [str, list], message: str, title: str = None, content: str = None, isGlobal: bool = False, publishToGlobal: bool = False):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/chat/thread", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def invite_to_chat(self, userId: [str, list], chatId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/chat/thread/{chatId}/member/invite", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def kick(self, userId: str, chatId: str, allowRejoin: bool = True):
        ...
        response = requests.delete(f"{self.apie}/g/s/chat/thread/{chatId}/member/{userId}?allowRejoin={allowRejoin}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def get_message_info(self, chatId: str, messageId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/chat/thread/{chatId}/message/{messageId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_community_info(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s-x{comId}/community/info?withInfluencerList=1&withTopicList=true&influencerListOrderStrategy=fansCount", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def search_community(self, aminoId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/search/amino-id-and-link?q={aminoId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_user_following(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/user-profile/{userId}/joined?start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_user_followers(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/user-profile/{userId}/member?start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.UserProfileList(json.loads(response.text)["userProfileList"]).UserProfileList
    ...
    def get_user_visitors(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/user-profile/{userId}/visitors?start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_blocked_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/block?start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.UserProfileList(json.loads(response.text)["userProfileList"]).UserProfileList
    ...
    def get_blog_info(self, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None):
        if blogId or quizId:
            ...
            response = requests.get(f"{self.apie}/g/s/blog/{blogId}", headers=self.web_headers)
            if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
            else: return objects.GetBlogInfo(json.loads(response.text)).GetBlogInfo

        elif wikiId:
            response = requests.get(f"{self.apie}/g/s/item/{wikiId}", headers=self.web_headers)
            if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
            else: return objects.GetWikiInfo(json.loads(response.text)).GetWikiInfo

        elif fileId:
            response = requests.get(f"{self.apie}/g/s/shared-folder/files/{fileId}", headers=self.web_headers)
            if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_blog_comments(self, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None, sorting: str = "newest", start: int = 0, size: int = 25):
        ...
        if blogId or quizId:
            if quizId is not None: blogId = quizId
            response = requests.get(f"{self.apie}/g/s/blog/{blogId}/comment?sort={sorting}&start={start}&size={size}", headers=self.web_headers)
        elif wikiId: response = requests.get(f"{self.apie}/g/s/item/{wikiId}/comment?sort={sorting}&start={start}&size={size}", headers=self.web_headers)
        elif fileId: response = requests.get(f"{self.apie}/g/s/shared-folder/files/{fileId}/comment?sort={sorting}&start={start}&size={size}", headers=self.web_headers)
        else: raise exceptions.SpecifyType()
    ...
    def get_blocker_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/block/full-list?start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_wall_comments(self, userId: str, sorting: str, start: int = 0, size: int = 25):
        ...
        **Returns**
        ...
        response = requests.get(f"{self.apie}/g/s/user-profile/{userId}/g-comment?sort={sorting}&start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.CommentList(json.loads(response.text)["commentList"]).CommentList
    ...
    def flag(self, reason: str, flagType: int, userId: str = None, blogId: str = None, wikiId: str = None, asGuest: bool = False):
        ...
        **Returns**
        ...
        data = (data)
        response = requests.post(f"{self.apie}/g/s/{flg}", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def send_message(self, chatId: str, message: str = None, messageType: int = 0, file: BinaryIO = None, fileType: str = None, replyTo: str = None, mentionUserIds: list = None, stickerId: str = None, embedId: str = None, embedType: int = None, embedLink: str = None, embedTitle: str = None, embedContent: str = None, embedImage: BinaryIO = None):
        ...
        **Returns**
        ...
        data = (data)
        response = requests.post(f"{self.apie}/g/s/chat/thread/{chatId}/message", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def mark_as_read(self, chatId: str, messageId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/chat/thread/{chatId}/mark-as-read", headers=self.parse_headers(), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def visit(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/user-profile/{userId}?action=visit", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def follow(self, userId: [str, list]):
        ...
        **Returns**
        ...
        if isinstance(userId, str):
            response = requests.post(f"{self.apie}/g/s/user-profile/{userId}/member", headers=self.web_headers)

        elif isinstance(userId, list):
            data = ({"targetUidList": userId, "timestamp": int(timestamp() * 1000)})
            response = requests.post(f"{self.apie}/g/s/user-profile/{self.userId}/joined", json=data,headers=self.web_headers)
    ...
    def unfollow(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apie}/g/s/user-profile/{userId}/member/{self.userId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def block(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apie}/g/s/block/{userId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def unblock(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apie}/g/s/block/{userId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def join_community(self, comId: str, invitationId: str = None):
        ...
        **Returns**
        ...
        data =(data)
        self.web_headers["cookie"]=f'sid={self.sid}'
        response = requests.post(f"{self.apie}/x{comId}/s/community/join", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def request_join_community(self, comId: str, message: str = None):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        data = ({"message": message, "timestamp": int(timestamp() * 1000)})
        response = requests.post(f"{self.apie}/x{comId}/s/community/membership-request", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def leave_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apie}/x{comId}/s/community/leave", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def flag_community(self, comId: str, reason: str, flagType: int, isGuest: bool = False):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/x{comId}/s/{flg}", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def set_privacy_status(self, isAnonymous: bool = False, getNotifications: bool = False):
        ...
        **Returns**
        ...
        data = (data)
        response = requests.post(f"{self.apie}/g/s/account/visit-settings", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def set_amino_id(self, aminoId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/account/change-amino-id", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def get_linked_communities(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/user-profile/{userId}/linked-community", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def reorder_linked_communities(self, comIds: list):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        data = ({"ndcIds": comIds, "timestamp": int(timestamp() * 1000)})
        response = requests.post(f"{self.apie}/g/s/user-profile/{self.userId}/linked-community/reorder", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def add_linked_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apie}/g/s/user-profile/{self.userId}/linked-community/{comId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def remove_linked_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.apie}/g/s/user-profile/{self.userId}/linked-community/{comId}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None):
        ...
        **Returns**
        ...
        if userId:
            ...
            data = (data)
            response = requests.post(f"{self.apie}/g/s/user-profile/{userId}/g-comment", json=data,headers=self.web_headers)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = (data)
            response = requests.post(f"{self.apie}/g/s/blog/{blogId}/g-comment", json=data,headers=self.web_headers)

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = (data)
            response = requests.post(f"{self.apie}/g/s/item/{wikiId}/g-comment", json=data,headers=self.web_headers)
    ...
    def delete_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        if userId: response = requests.delete(f"{self.apie}/g/s/user-profile/{userId}/g-comment/{commentId}", headers=self.web_headers)
        elif blogId: response = requests.delete(f"{self.apie}/g/s/blog/{blogId}/g-comment/{commentId}", headers=self.web_headers)
        elif wikiId: response = requests.delete(f"{self.apie}/g/s/item/{wikiId}/g-comment/{commentId}", headers=self.web_headers)
        else: raise exceptions.SpecifyType
        ...
        **Returns**
        ...
        if blogId:
            if isinstance(blogId, str):
                data["eventSource"] = "UserProfileView"
                data = (data)
                response = requests.post(f"{self.apie}/g/s/blog/{blogId}/g-vote?cv=1.2", json=data,headers=self.web_headers)

            elif isinstance(blogId, list):
                data["targetIdList"] = blogId
                data = (data)
                response = requests.post(f"{self.apie}/g/s/feed/g-vote", json=data,headers=self.web_headers)
            ...
            data["eventSource"] = "PostDetailView"
            data = (data)
            response = requests.post(f"{self.apie}/g/s/item/{wikiId}/g-vote?cv=1.2", json=data,headers=self.web_headers)
    ...
    def unlike_blog(self, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        if blogId: response = requests.delete(f"{self.apie}/g/s/blog/{blogId}/g-vote?eventSource=UserProfileView", headers=self.web_headers)
        elif wikiId: response = requests.delete(f"{self.apie}/g/s/item/{wikiId}/g-vote?eventSource=PostDetailView", headers=self.web_headers)
        else: raise exceptions.SpecifyType
    ...
    def like_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
        ...
        if userId:
            data["eventSource"] = "UserProfileView"
            data = (data)
            response = requests.post(f"{self.apie}/g/s/user-profile/{userId}/comment/{commentId}/g-vote?cv=1.2&value=1", json=data,headers=self.web_headers)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = (data)
            response = requests.post(f"{self.apie}/g/s/blog/{blogId}/comment/{commentId}/g-vote?cv=1.2&value=1", json=data,headers=self.web_headers)

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = (data)
            response = requests.post(f"{self.apie}/g/s/item/{wikiId}/comment/{commentId}/g-vote?cv=1.2&value=1", json=data,headers=self.web_headers)
    ...
    def unlike_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        if userId: response = requests.delete(f"{self.apie}/g/s/user-profile/{userId}/comment/{commentId}/g-vote?eventSource=UserProfileView", headers=self.web_headers)
        elif blogId: response = requests.delete(f"{self.apie}/g/s/blog/{blogId}/comment/{commentId}/g-vote?eventSource=PostDetailView", headers=self.web_headers)
        elif wikiId: response = requests.delete(f"{self.apie}/g/s/item/{wikiId}/comment/{commentId}/g-vote?eventSource=PostDetailView", headers=self.web_headers)
        else: raise exceptions.SpecifyType
    ...
    def get_membership_info(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/membership?force=true", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_ta_announcements(self, language: str = "en", start: int = 0, size: int = 25):
        ...
        **Returns**
        ...
        response = requests.get(f"{self.apie}/g/s/announcement?language={language}&start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_wallet_info(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/wallet", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_wallet_history(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/wallet/coin/history?start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_from_code(self, code: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/link-resolution?q={code}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_from_id(self, objectId: str, objectType: int, comId: str = None):
        ...
        **Returns**
        ...
        if comId: response = requests.post(f"{self.apie}/g/s-x{comId}/link-resolution", json=data,headers=self.web_headers)
        else: response = requests.post(f"{self.apie}/g/s/link-resolution", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.FromCode(json.loads(response.text)["linkInfoV2"]).FromCode
    ...
    def get_supported_languages(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/community-collection/supported-languages?start=0&size=100", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def claim_new_user_coupon(self):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.apie}/g/s/coupon/new-user-coupon/claim", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def get_subscriptions(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/store/subscription?objectType=122&start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def get_all_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.get(f"{self.apie}/g/s/user-profile?type=recent&start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def accept_host(self, chatId: str, requestId: str):
        ...
        response = requests.post(f"{self.apie}/g/s/chat/thread/{chatId}/transfer-organizer/{requestId}/accept", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def link_identify(self, code: str):
        response = requests.get(f"{self.apie}/g/s/community/link-identify?q=http%3A%2F%2Faminoapps.com%2Finvite%2F{code}", headers=self.web_headers)
    ...
    def invite_to_vc(self, chatId: str, userId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/chat/thread/{chatId}/vvchat-presenter/invite", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def wallet_config(self, level: int):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.apie}/g/s/wallet/ads/config", json=data,headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code

    def get_avatar_frames(self, start: int = 0, size: int = 25):
        response = requests.get(f"{self.apie}/g/s/avatar-frame?start={start}&size={size}", headers=self.web_headers)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
