...
class Binomial(Distribution):
    ...
    def __add__(self, other):
        ...
        """Function to add together two Binomial jmg_distributions with equal p
        ...
        # TODO: Define addition for two binomial jmg_distributions. Assume that the
        # p values of the two jmg_distributions are the same. The formula for
        # summing two binomial jmg_distributions with different p values is more complicated,
        # so you are only expected to implement the case for two jmg_distributions with equal p.
        ...
        #   When adding two binomial jmg_distributions, the p value remains the same
        #   The new n value is the sum of the n values of the two jmg_distributions.
    ...
    def __repr__(self):
        ...
        #
        #       with the values replaced by whatever the actual jmg_distributions values are
