...
class JobListItem(QtWidgets.QTreeWidgetItem):
    ...
    def _update(self):
        ...
        self.setText(2, j['job_label'])
        self.setText(3, j['owner'])
        self.setText(4, j['pool'])
        self.setText(5, str(j['priority']))
        self.setText(6, j.get('node', ''))

        self.setText(7, str(j['paused']))
        self.setText(8, str(j['in_progress']))
        self.setText(9, str(j['done']))

        self.setText(10, j['creator'])
        
        ts = j['created_on']
        date_str = time.ctime(ts)

        self.setText(11, date_str)
        self.setText(12, str(ts))
        self.setText(13, j['jid'])
...
class JobList(QtWidgets.QTreeWidget):
    ...
    def __init__(self, parent, session):
        ...
        self.setColumnHidden(7, True) # Done
        self.setColumnHidden(8, True) # In Progress
        self.setColumnHidden(9, True) # Paused
