...
*StacApi* | [**describe_collection**](docs/StacApi.md#describe_collection) | **GET** /stac/collections/{collectionId} | Describe the feature collection with id &#x60;collectionId&#x60;
*StacApi* | [**get_api**](docs/StacApi.md#get_api) | **GET** /stac/api | OpenAPI
*StacApi* | [**get_collections**](docs/StacApi.md#get_collections) | **GET** /stac/collections | The feature collections in the dataset
*StacApi* | [**get_conformance_declaration**](docs/StacApi.md#get_conformance_declaration) | **GET** /stac/conformance | Conformance
*StacApi* | [**get_feature**](docs/StacApi.md#get_feature) | **GET** /stac/collections/{collectionId}/items/{featureId} | Fetch a single feature
*StacApi* | [**get_features**](docs/StacApi.md#get_features) | **GET** /stac/collections/{collectionId}/items | Fetch features
*StacApi* | [**get_item_search**](docs/StacApi.md#get_item_search) | **GET** /stac/search | Search STAC items with simple filtering.
*StacApi* | [**get_landing_page**](docs/StacApi.md#get_landing_page) | **GET** /stac | Landing page
*StacApi* | [**post_item_search**](docs/StacApi.md#post_item_search) | **POST** /stac/search | Search STAC items with full-featured filtering.
...
## Documentation For Models
 ...
 - [ConformanceClasses](docs/ConformanceClasses.md)
 - [Count](docs/Count.md)
 - [Crs](docs/Crs.md)
 ...
 - [StacFeatureCollection](docs/StacFeatureCollection.md)
 - [StacLink](docs/StacLink.md)
