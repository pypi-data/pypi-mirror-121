...
complete --command yt-dlp --long-option ignore-errors --short-option i --description 'Ignore download and postprocessing errors. The download will be considered successfull even if the postprocessing fails'
...
complete --command yt-dlp --long-option ignore-no-formats-error --description 'Ignore "No video formats" error. Usefull for extracting metadata even if the videos are not actually available for download (experimental)'
...
complete --command yt-dlp --long-option check-formats --description 'Check that the formats selected are actually downloadable'
complete --command yt-dlp --long-option no-check-formats --description 'Do not check that the formats selected are actually downloadable'
...
complete --command yt-dlp --long-option embed-metadata --description 'Embed metadata to the video file. Also adds chapters to file unless --no-add-chapters is used (Alias: --add-metadata)'
...
complete --command yt-dlp --long-option remove-chapters --description 'Remove chapters whose title matches the given regular expression. This option can be used multiple times'
complete --command yt-dlp --long-option no-remove-chapters --description 'Do not remove any chapters from the file (default)'
complete --command yt-dlp --long-option force-keyframes-at-cuts --description 'Force keyframes around the chapters before removing/splitting them. Requires a reencode and thus is very slow, but the resulting video may have fewer artifacts around the cuts'
...
complete --command yt-dlp --long-option sponsorblock-mark --description 'SponsorBlock categories to create chapters for, separated by commas. Available categories are all, sponsor, intro, outro, selfpromo, interaction, preview, music_offtopic. You can prefix the category with a "-" to exempt it. See https://wiki.sponsor.ajay.app/index.php/Segment_Categories for description of the categories. Eg: --sponsorblock-mark all,-preview'
complete --command yt-dlp --long-option sponsorblock-remove --description 'SponsorBlock categories to be removed from the video file, separated by commas. If a category is present in both mark and remove, remove takes precedence. The syntax and available categories are the same as for --sponsorblock-mark'
