...
import datetime
from .cognito_utils import perform_infinstor_login, token_renewer, check_for_custom_token,\
        read_token_file, get_customerinfo, setup_token_for_mlflow, bootstrap_config_values_from_mlflow_rest_if_needed
    ...
    def get(self, path=""):
        ...
        if (check_for_custom_token()):
            ...
            if (service):
                ...
                rv = json.dumps({"authenticated": False, "service": service, "mlflowTrackingUri": muri})
            else:
                builtins.log.info("service unknown")
                rv = json.dumps({"authenticated": False, "mlflowTrackingUri": muri})
