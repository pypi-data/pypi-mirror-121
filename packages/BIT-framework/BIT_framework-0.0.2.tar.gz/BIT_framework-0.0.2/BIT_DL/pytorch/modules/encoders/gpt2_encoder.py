...
from BIT_DL.pytorch.modules.pretrained.gpt2 import PretrainedGPT2Mixin
...
class GPT2Encoder(EncoderBase, PretrainedGPT2Mixin):
    ...
    :class:`~BIT_DL.pytorch.modules.PretrainedGPT2Mixin` for a brief description
    of GPT2.

    This module basically stacks
    :class:`~BIT_DL.pytorch.modules.WordEmbedder`,
    :class:`~BIT_DL.pytorch.modules.PositionEmbedder`,
    :class:`~BIT_DL.pytorch.modules.TransformerEncoder`.

    Args:
        pretrained_model_name (optional): a `str`, the name
            of pre-trained model (e.g., ``gpt2-small``). Please refer to
            :class:`~BIT_DL.pytorch.modules.PretrainedGPT2Mixin` for
    ...
    def default_hparams():
        ...
        * If the above two are `None`, the encoder arch is defined by the
        ...
        `"decoder"`: dict
            ...
            See :func:`~BIT_DL.pytorch.modules.TransformerDecoder.default_hparams`
            for details.
