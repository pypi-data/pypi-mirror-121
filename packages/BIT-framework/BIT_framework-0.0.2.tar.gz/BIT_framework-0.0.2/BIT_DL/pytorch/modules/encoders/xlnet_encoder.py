...
from BIT_DL.pytorch.modules.pretrained.xlnet_utils import (
    ...
    params_except_in)
from BIT_DL.pytorch.utils.utils import dict_fetch, sum_tensors
...
class XLNetEncoder(EncoderBase, PretrainedXLNetMixin):
    ...
    :class:`~BIT_DL.pytorch.modules.PretrainedXLNetMixin` for a brief description
    of XLNet.

    Args:
        pretrained_model_name (optional): a `str`, the name
            of pre-trained model (e.g., ``xlnet-based-cased``). Please refer to
            :class:`~BIT_DL.pytorch.modules.PretrainedXLNetMixin` for
