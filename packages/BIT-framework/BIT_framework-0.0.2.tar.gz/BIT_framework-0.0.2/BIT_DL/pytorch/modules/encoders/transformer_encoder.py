...
from BIT_DL.pytorch.utils import transformer_attentions as attn
from BIT_DL.pytorch.utils.utils import sequence_mask
...
def default_transformer_poswise_net_hparams(input_dim: int,
    ...
    :class:`~BIT_DL.pytorch.modules.FeedForwardNetwork` as a position-wise network
    used in :class:`~BIT_DL.pytorch.modules.TransformerEncoder` and
    :class:`~BIT_DL.pytorch.modules.TransformerDecoder`.
...
class TransformerEncoder(EncoderBase):
    ...
    :class:`~BIT_DL.pytorch.modules.MultiheadAttentionEncoder`,
    ...
    def default_hparams():
        ...
        `"multihead_attention"`: dict
            ...
            See :class:`~BIT_DL.pytorch.modules.MultiheadAttentionEncoder` for
            details.
