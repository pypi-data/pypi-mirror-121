...
from BIT_DL.pytorch.core.layers import identity, Identity
from BIT_DL.pytorch.module_base import ModuleBase
from BIT_DL.pytorch.modules.decoders import decoder_helpers as helpers
from BIT_DL.pytorch.modules.decoders.decoder_helpers import Helper
from BIT_DL.pytorch.utils import utils
from BIT_DL.pytorch.utils.dtypes import torch_bool
...
def _make_output_layer(layer: Optional[Union[nn.Module, torch.Tensor]],
    ...
    - If ``layer`` is :method:`BIT_DL.pytorch.core.identity`, identity function is
...
class DecoderBase(ModuleBase, Generic[State, Output], ABC):
    ...
    See :class:`~BIT_DL.pytorch.modules.BasicRNNDecoder` for the arguments.
    ...
    def create_helper(self, *,
        ...
        for both :class:`~BIT_DL.pytorch.modules.BasicRNNDecoder` and
        :class:`~BIT_DL.pytorch.modules.AttentionRNNDecoder`.
        ...
        2. The :attr:`helper` argument: An instance of subclass of
           :class:`~BIT_DL.pytorch.modules.decoders.decoder_helpers.Helper`. This
           provides a superset of decoding strategies than above, for example:

            - :class:`~BIT_DL.pytorch.modules.TrainingHelper` corresponding to the
              "train_greedy" strategy.
            - :class:`~BIT_DL.pytorch.modules.ScheduledEmbeddingTrainingHelper` and
              :class:`~BIT_DL.pytorch.modules.ScheduledOutputTrainingHelper` for
              scheduled sampling.
            - :class:`~BIT_DL.pytorch.modules.SoftmaxEmbeddingHelper` and
              :class:`~BIT_DL.pytorch.modules.GumbelSoftmaxEmbeddingHelper` for
    ...
    def initialize(self, helper: Helper, inputs: Optional[torch.Tensor],
        ...
        Args:
            helper: The :class:`~BIT_DL.pytorch.modules.Helper` instance to use.
