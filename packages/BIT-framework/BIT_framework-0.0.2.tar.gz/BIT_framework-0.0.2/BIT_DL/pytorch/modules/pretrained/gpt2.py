...
class PretrainedGPT2Mixin(PretrainedMixin, ABC):
    ...
    We provide the following GPT2 classes:
      ...
      * :class:`~BIT_DL.pytorch.modules.GPT2Encoder` for text encoding.
      * :class:`~BIT_DL.pytorch.modules.GPT2Decoder` for text generation and
        decoding.
      * :class:`~BIT_DL.pytorch.modules.GPT2Classifier` for text classification and
        sequence tagging.
