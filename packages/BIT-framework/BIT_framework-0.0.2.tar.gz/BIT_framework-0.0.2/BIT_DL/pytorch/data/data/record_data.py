...
from BIT_DL.pytorch.data.data.data_base import DatasetBase, DataSource
from BIT_DL.pytorch.data.data.dataset_utils import Batch, padded_batch
from BIT_DL.pytorch.hyperparams import HParams
from BIT_DL.pytorch.utils.dtypes import get_numpy_dtype
...
def _default_record_dataset_hparams():
    ...
    See :meth:`BIT_DL.pytorch.data.RecordData.default_hparams` for details.
    """
    return {
        "files": [],
        "feature_types": None,
