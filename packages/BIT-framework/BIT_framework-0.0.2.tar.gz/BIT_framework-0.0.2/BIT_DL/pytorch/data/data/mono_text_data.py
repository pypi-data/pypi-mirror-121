...
from BIT_DL.pytorch.data.data.data_base import DataSource
...
def _default_mono_text_dataset_hparams():
    ...
    See :meth:`BIT_DL.pytorch.MonoTextData.default_hparams` for details.
    """
    return {
        "files": [],
...
class MonoTextData(TextDataBase[List[str], List[str]]):
    ...
    def default_hparams():
        ...
        1. For the hyperparameters in the :attr:`"dataset"` field:
          ...
          `"vocab_file"`: str
              ...
              Used to create an instance of :class:`~BIT_DL.pytorch.data.Vocab`.
          ...
          `"embedding_init"`: dict
              ...
              :meth:`BIT_DL.pytorch.data.Embedding.default_hparams`.
        ...
        hyperparameters:
          ...
          `"bucket_length_fn"`: str or callable
              ...
              :mod:`BIT_DL.pytorch.custom` module.
    ...
    def make_embedding(emb_hparams, token_to_id_map):
        ...
        an instance of :class:`BIT_DL.pytorch.data.Embedding`.
        """
        embedding = None
    ...
    def vocab(self) -> Vocab:
        r"""The vocabulary, an instance of :class:`~BIT_DL.pytorch.data.Vocab`.
        """
        return self._vocab
