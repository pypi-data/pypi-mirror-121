...
from BIT_DL.pytorch.data.data.data_base import (
    DataSource, FilterDataSource, ZipDataSource)
from BIT_DL.pytorch.data.data.dataset_utils import Batch, padded_batch
from BIT_DL.pytorch.data.data.mono_text_data import (
    MonoTextData, _LengthFilterMode, _default_mono_text_dataset_hparams)
from BIT_DL.pytorch.data.data.text_data_base import (
    TextDataBase, TextLineDataSource)
from BIT_DL.pytorch.data.embedding import Embedding
from BIT_DL.pytorch.data.vocabulary import SpecialTokens, Vocab
...
def _default_paired_text_dataset_hparams():
    ...
    See :meth:`BIT_DL.pytorch.data.PairedTextData.default_hparams` for details.
    """
...
class PairedTextData(TextDataBase[Tuple[List[str], List[str]],
    ...
    def default_hparams():
        ...
        1. Hyperparameters in the :attr:`"source_dataset"` and
           ...
           in :meth:`BIT_DL.pytorch.data.MonoTextData.default_hparams`, for source
        ...
        2. For the **general** hyperparameters, see
           :meth:`BIT_DL.pytorch.data.DatasetBase.default_hparams` for details.

        3. For **bucketing** hyperparameters, see
           :meth:`BIT_DL.pytorch.data.MonoTextData.default_hparams` for details,
    ...
    def make_embedding(src_emb_hparams, src_token_to_id_map,
        ...
        provided), and returns respective :class:`BIT_DL.pytorch.data.Embedding`
        instances.
        """
    ...
    @property
    def vocab(self):
        r"""A pair instances of :class:`~BIT_DL.pytorch.data.Vocab` that are source
    ...
    def source_vocab(self):
        r"""The source vocab, an instance of :class:`~BIT_DL.pytorch.data.Vocab`.
        """
        return self._src_vocab

    @property
    def target_vocab(self):
        r"""The target vocab, an instance of :class:`~BIT_DL.pytorch.data.Vocab`.
        """
