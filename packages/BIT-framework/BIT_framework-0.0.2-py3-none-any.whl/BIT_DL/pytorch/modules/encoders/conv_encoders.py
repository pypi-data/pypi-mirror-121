...
from BIT_DL.pytorch.modules.networks.conv_networks import Conv1DNetwork
...
class Conv1DEncoder(Conv1DNetwork, EncoderBase):
    ...
    Wraps :class:`~BIT_DL.pytorch.modules.Conv1DNetwork` to be a subclass of
    :class:`~BIT_DL.pytorch.modules.EncoderBase`. Has exact the same functionality
    with :class:`~BIT_DL.pytorch.modules.Conv1DNetwork`.
    """
    ...
    def default_hparams() -> Dict[str, Any]:
        ...
        The same as :meth:`~BIT_DL.pytorch.modules.Conv1DNetwork.default_hparams`
        of :class:`~BIT_DL.pytorch.modules.Conv1DNetwork`, except that the default
