...
from BIT_DL.pytorch.core.cell_wrappers import LSTMCell, RNNCellBase
from BIT_DL.pytorch.hyperparams import HParams
from BIT_DL.pytorch.modules.encoders.encoder_base import EncoderBase
from BIT_DL.pytorch.modules.networks.conv_networks import _to_list
from BIT_DL.pytorch.utils.rnn import bidirectional_dynamic_rnn, dynamic_rnn
...
class BidirectionalRNNEncoder(RNNEncoderBase):
    ...
    def default_hparams() -> Dict[str, Any]:
        ...
        `"rnn_cell_bw"`: dict
            ...
            The default value is defined in
            :meth:`~BIT_DL.pytorch.core.default_rnn_cell_hparams`.
        ...
        `"output_layer_fw"`: dict
            ...
            :meth:`~BIT_DL.pytorch.modules.UnidirectionalRNNEncoder` for details.
