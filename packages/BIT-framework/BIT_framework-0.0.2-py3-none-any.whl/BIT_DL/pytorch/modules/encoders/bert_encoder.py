...
from BIT_DL.pytorch.modules.embedders.position_embedders import PositionEmbedder
...
from BIT_DL.pytorch.modules.pretrained.bert import PretrainedBERTMixin
...
class BERTEncoder(EncoderBase, PretrainedBERTMixin):
    ...
    :class:`~BIT_DL.pytorch.modules.PretrainedBERTMixin` for a brief description
    of BERT.

    This module basically stacks
    :class:`~BIT_DL.pytorch.modules.WordEmbedder`,
    :class:`~BIT_DL.pytorch.modules.PositionEmbedder`,
    :class:`~BIT_DL.pytorch.modules.TransformerEncoder` and a dense
    pooler.

    Args:
        pretrained_model_name (optional): a `str`, the name
            of pre-trained model (e.g., ``bert-base-uncased``). Please refer to
            :class:`~BIT_DL.pytorch.modules.PretrainedBERTMixin` for
    ...
    def default_hparams():
        ...
        * If the above two are `None`, the encoder arch is defined by the
        ...
        `"encoder"`: dict
            ...
            See :func:`~BIT_DL.pytorch.modules.TransformerEncoder.default_hparams`
            for details.
