...
from BIT_DL.pytorch.core import layers, Identity
from BIT_DL.pytorch.modules.embedders.embedders import WordEmbedder
from BIT_DL.pytorch.modules.encoder_decoders.encoder_decoder_base\
    import EncoderDecoderBase
from BIT_DL.pytorch.modules.encoders import T5Encoder
from BIT_DL.pytorch.modules.decoders import T5Decoder
from BIT_DL.pytorch.modules.pretrained.t5 import PretrainedT5Mixin
...
class T5EncoderDecoder(EncoderDecoderBase, PretrainedT5Mixin):
    ...
    :class:`~BIT_DL.pytorch.modules.PretrainedT5Mixin` for a brief description
    of T5.

    This module basically stacks
    :class:`~BIT_DL.pytorch.modules.WordEmbedder`,
    :class:`~BIT_DL.pytorch.modules.T5Encoder`, and
    :class:`~BIT_DL.pytorch.modules.T5Decoder`.

    Args:
        pretrained_model_name (optional): a `str`, the name
            of pre-trained model (e.g., ``T5-Small``). Please refer to
            :class:`~BIT_DL.pytorch.modules.PretrainedT5Mixin` for
    ...
    def default_hparams():
        ...
        * If the above two are `None`, the encoder arch is defined by the
        ...
        `"encoder"`: dict
            ...
            See :func:`~BIT_DL.pytorch.modules.T5Encoder.default_hparams`
            for details.

        `"decoder"`: dict
            Hyperparameters for the `T5Decoder`.
            See :func:`~BIT_DL.pytorch.modules.T5Decoder.default_hparams`
            for details.
    ...
    def forward(self,  # type: ignore
        ...
        Returns:
            ...
            - :attr:`decoder_output`: An instance of
              :class:`~BIT_DL.pytorch.modules.TransformerDecoderOutput` which
