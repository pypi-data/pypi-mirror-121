...
from BIT_DL.pytorch.modules.pretrained.pretrained_base import PretrainedMixin
from BIT_DL.pytorch.modules.pretrained.xlnet_utils import (
...
class PretrainedXLNetMixin(PretrainedMixin, ABC):
    ...
    We provide the following XLNet classes:
      ...
      * :class:`~BIT_DL.pytorch.modules.XLNetEncoder` for text encoding.
      * :class:`~BIT_DL.pytorch.modules.XLNetDecoder` for text generation and
        decoding.
      * :class:`~BIT_DL.pytorch.modules.XLNetClassifier` for text classification
        and sequence tagging.
      * :class:`~BIT_DL.pytorch.modules.XLNetRegressor` for text regression.
