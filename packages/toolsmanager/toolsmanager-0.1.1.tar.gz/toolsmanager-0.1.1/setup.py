...
# Metadata
NAME = "toolsmanager"
VERSION = get_version("src/toolsmanager/consts.py")
LICENSE = "MIT"
DESCRIPTION = "Tool to manage tools (installing from git, adding commands, aliases, variables, ...)"
...
ZIP_SAFE = False
ENTRY_POINTS = {"console_scripts": ["toolsmanager = toolsmanager.__main__:main"]}
