...
class TestCompareResult(unittest.TestCase):
    def test_float_check(self):
        compare.use_delta_for_checksum = True
        result = compare(
            [12, 12.11, 12.121, 12.345, 12.123567],
            [12, 12.12, 12.122, 12.3456, 12.1235]
        )
        verify = {
            1: {'Хотели': 12.11, 'Получили': 12.12},
            2: {'Хотели': 12.121, 'Получили': 12.122},
            3: {'Хотели': 12.345, 'Получили': 12.3456}
        }
