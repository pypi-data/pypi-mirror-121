...
class ConvertXmindToExcel:
    ...
    def convert_multiple_file(self, xmind_path, excel_file_path, ignore_layer_number):
        ...
        for path, dir_list, file_list in xmind_dir:
            ...
            df.to_excel(writer, sheet_name='case_data', index=False, header=False)
...
if __name__ == '__main__':
    xmind_file_path = '/Users/xue/Desktop/testcases/test3.xmind'
    excel_file_path = '/Users/xue/Desktop/testcases/test3.xlsx'
    ignore_layer_number = 1
    para_list = ['/Users/xue/Desktop/testcases/', '/Users/xue/Desktop/testcases/test.xlsx', '1']

    #ConvertXmindToExcel().convert(para_list[0], para_list[1], ignore_layer_number=para_list[2])

    #para_list = sys.argv[1:]
    ConvertXmindToExcel().convert(xmind_file_path, excel_file_path)
