    ...
    """
{
    ...
    "license": "Apache-2.0",
    "url": "https://github.com/kimisme9386/cdk-codepipeline-status.git",
    ...
    "project_urls": {
        "Source": "https://github.com/kimisme9386/cdk-codepipeline-status.git"
    },
    "package_dir": {
        "": "src"
    },
    ...
    "package_data": {
        "cdk_codepipeline_badge_notification._jsii": [
            "cdk-codepipeline-badge-notification@0.1.45.jsii.tgz"
        ],
        "cdk_codepipeline_badge_notification": [
            "py.typed"
        ]
