...
class Notification:
    def __init__(
        ...
        *,
        ...
        '''
        :param ssm_google_chat_web_hook_url: (experimental) google chat ewb hook url from ssm parameter.
        :param ssm_slack_web_hook_url: (experimental) Slack webhook url from ssm parameter.
        :param ssm_telegram_web_hook_url: (experimental) telegram web hook url from from ssm parameter.
    ...
    def ssm_google_chat_web_hook_url(self) -> typing.Optional[builtins.str]:
        '''(experimental) google chat ewb hook url from ssm parameter.
    ...
    def ssm_telegram_web_hook_url(self) -> typing.Optional[builtins.str]:
        '''(experimental) telegram web hook url from from ssm parameter.
