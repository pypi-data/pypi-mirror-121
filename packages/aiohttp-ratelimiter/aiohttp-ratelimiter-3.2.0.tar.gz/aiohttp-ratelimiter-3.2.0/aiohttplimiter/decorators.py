...
class Limiter:
    ...
    def limit(self, ratelimit: str, keyfunc: Callable = None, exempt_ips: Optional[set] = None, middleware_count: int = None, raise_503: Optional[bool] = None) -> Callable:
        def wrapper(func: Callable) -> RateLimitDecorator:
            ...
            return RateLimitDecorator(keyfunc=_keyfunc, ratelimit=ratelimit, exempt_ips=_exempt_ips, middleware_count=_middleware_count, num_calls=self.num_calls, last_reset=self.last_reset, raise_503=raise_503)(func)
        return wrapper
