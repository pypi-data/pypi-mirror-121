...
class DataPipelineClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client)
    ...
    def activate_pipeline(
        ...
        *,
        pipelineId: str,
        parameterValues: Sequence["ParameterValueTypeDef"] = None,
        startTimestamp: Union[datetime, str] = None
    ) -> Dict[str, Any]:
        """
        Validates the specified pipeline and starts processing pipeline tasks.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.activate_pipeline)
    ...
    def add_tags(self, *, pipelineId: str, tags: Sequence["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.add_tags)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.can_paginate)
    ...
    def create_pipeline(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.create_pipeline)
    ...
    def deactivate_pipeline(self, *, pipelineId: str, cancelActive: bool = None) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.deactivate_pipeline)
    ...
    def delete_pipeline(self, *, pipelineId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.delete_pipeline)
    ...
    def describe_objects(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.describe_objects)
    ...
    def describe_pipelines(self, *, pipelineIds: Sequence[str]) -> DescribePipelinesOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.describe_pipelines)
    ...
    def evaluate_expression(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.evaluate_expression)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.generate_presigned_url)
    ...
    def get_pipeline_definition(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.get_pipeline_definition)
    ...
    def list_pipelines(self, *, marker: str = None) -> ListPipelinesOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.list_pipelines)
    ...
    def poll_for_task(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.poll_for_task)
    ...
    def put_pipeline_definition(
        ...
        *,
        ...
        parameterObjects: Sequence["ParameterObjectTypeDef"] = None,
        parameterValues: Sequence["ParameterValueTypeDef"] = None
    ) -> PutPipelineDefinitionOutputTypeDef:
        """
        Adds tasks, schedules, and preconditions to the specified pipeline.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.put_pipeline_definition)
    ...
    def query_objects(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.query_objects)
    ...
    def remove_tags(self, *, pipelineId: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.remove_tags)
    ...
    def report_task_progress(
        self, *, taskId: str, fields: Sequence["FieldTypeDef"] = None
    ) -> ReportTaskProgressOutputTypeDef:
        """
        Task runners call `ReportTaskProgress` when assigned a task to acknowledge that
        it has the task.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.report_task_progress)
    ...
    def report_task_runner_heartbeat(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.report_task_runner_heartbeat)
    ...
    def set_status(self, *, pipelineId: str, objectIds: Sequence[str], status: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.set_status)
    ...
    def set_task_status(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.set_task_status)
    ...
    def validate_pipeline_definition(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Client.validate_pipeline_definition)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Paginator.DescribeObjects)
    ...
    def get_paginator(self, operation_name: Literal["list_pipelines"]) -> ListPipelinesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Paginator.ListPipelines)
    ...
    def get_paginator(self, operation_name: Literal["query_objects"]) -> QueryObjectsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/datapipeline.html#DataPipeline.Paginator.QueryObjects)
