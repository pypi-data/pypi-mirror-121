...
class ptmultiviews:
    def __init__(self, args):
        ...
        self.without_requested_url = args.without_requested_url
    ...
    def _enumerate_files(self, url):
        ...
        if r.status_code == 406:
            ...
            requested_file = None
            if self.without_requested_url:
                requested_file = url.split("/")[-1]
...
def parse_args():
    ...
    parser.add_argument("-wr", "--without-requested-url", action="store_true")
