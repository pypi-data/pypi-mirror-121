...
class GroupClone(TestGroup):
    ...
    have a different qualified identifier. Use `HasGoal.set_id` to change
    the identifier if necessary; the ID system will automatically append
    a -number suffix to non-unique identifiers at rendering time of
    course.
    """
