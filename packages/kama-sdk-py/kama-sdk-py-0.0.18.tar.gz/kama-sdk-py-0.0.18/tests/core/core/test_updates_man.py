...
from kama_sdk.core.core.config_man import config_man, USER_VARS_LVL, USER_INJ_VARS_LVL
...
from kama_sdk.model.variable import manifest_variable
...
class TestUpdatesMan(ClusterTest):
  ...
  def test_preview_with_interfering(self):
    actual = updates_man.preview(release, consts.APP_SPACE_ID)
    print(actual)
    # TODO assert!
