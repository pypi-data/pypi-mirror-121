...
setuptools.setup(
    ...
    version="0.0.3", #版本号，下次修改后再提交的话只需要修改当前的版本号就可以了
    author="唐国钦", #作者
    ...
    REQUIRED = [
        ...
        'opencv-python','openpyxl','Pillow','PyAutoGUI','PyMySQL','requests','requests-toolbelt',
        'Scrapy','scrapy-splash','selenium','xlrd'
    ],
