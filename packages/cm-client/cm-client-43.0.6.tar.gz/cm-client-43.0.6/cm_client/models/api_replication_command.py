...
class ApiReplicationCommand(object):
    ...
    def __init__(self, id=None, name=None, start_time=None, end_time=None, active=None, success=None, result_message=None, result_data_url=None, cluster_ref=None, service_ref=None, role_ref=None, host_ref=None, parent=None, children=None, can_retry=None, hdfs_result=None, hive_result=None, hive_on_tez_result=None):
        """
