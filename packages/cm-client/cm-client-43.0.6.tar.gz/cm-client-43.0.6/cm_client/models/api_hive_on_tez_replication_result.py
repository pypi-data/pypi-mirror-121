...
class ApiHiveOnTezReplicationResult(object):
    ...
    def __init__(self, type=None, status=None, error=None, tables_current=None, tables_total=None, functions_current=None, functions_total=None, events_current=None, events_total=None, policies_current=None, policies_total=None, entities_current=None, entities_total=None):
        """
