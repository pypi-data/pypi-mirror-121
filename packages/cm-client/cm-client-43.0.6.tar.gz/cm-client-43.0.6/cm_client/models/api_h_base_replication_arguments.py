...
class ApiHBaseReplicationArguments(object):
    ...
    def __init__(self, source_h_base_service=None, target_peer_id=None, target_cluster_key=None, end_point_class_name=None, namespaces=None, tables=None, replication_properties=None):
        """
