...
@click.option(
    "--topology",
    required=True,
    type=click.Choice(["STB->TV", "TV", "STB->AVR->TV", "TV->AVR"], case_sensitive=True),
    help="The a/v topology that is currently being configured for the device."
         " [\"STB->TV\" | \"TV\" | \"STB->AVR->TV\" | \"TV->AVR\"]."
...
@click.option(
    ...
    illegal_if_not={'topology': 'STB->TV'},
    is_flag=True,
