...
[boto3.WorkMailMessageFlow 1.18.52](https://boto3.amazonaws.com/v1/documentation/api/1.18.52/reference/services/workmailmessageflow.html#WorkMailMessageFlow)
