...
class FieldDerivative(Field):
    ...
    def __init__(self):
        _field.FieldDerivative_swiginit(self, _field.new_FieldDerivative())
...
class FieldNodeValue(Field):
    ...
    def __init__(self):
        _field.FieldNodeValue_swiginit(self, _field.new_FieldNodeValue())
...
class FieldIsOnFace(Field):
    ...
    def __init__(self):
        _field.FieldIsOnFace_swiginit(self, _field.new_FieldIsOnFace())
