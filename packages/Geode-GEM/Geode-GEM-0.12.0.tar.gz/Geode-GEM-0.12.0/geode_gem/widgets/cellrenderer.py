...
class GeodeGtkCellRendererCombo(CommonCellRenderer, Gtk.CellRendererCombo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        CommonCellRenderer.__init__(
            self, Gtk.CellRendererCombo, *args, **kwargs)
    ...
    def append_widget(self, widget, *args, **kwargs):
        ...
        if isinstance(widget, Gtk.TreeModel):
            self.set_property("model", widget)
...
class GeodeGtkCellRendererSpin(CommonCellRenderer, Gtk.CellRendererSpin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        CommonCellRenderer.__init__(
            self, Gtk.CellRendererSpin, *args, **kwargs)
