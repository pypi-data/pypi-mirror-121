...
class CommonWindow(object):
    ...
    def add_external_link_help(self, title, uri):
        """ Add a link button to dialog interface
        ...
        image = GeodeGtk.Image(
            set_from_icon_name=(Icons.Symbolic.INTERNET, Gtk.IconSize.BUTTON),
        )

        linkbutton = GeodeGtk.LinkButton(
            title,
            set_image=image,
            set_uri=uri,
        )

        self.grid_actions.pack_start(linkbutton, False, False, 0)
