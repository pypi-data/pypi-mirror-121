...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        # self.p = self.calculate_mean()
        # self.stdev = self.calculate_stdev()
        # return self.p, self.n, self.stdev
    ...
    def plot_bar_pdf(self):
        ...
        # interval = 1.0 * (max_range - min_range) / self.n
        #
        # x = []
        # y = []
        #
        ...
        # axes[0].set_title('Normed Bar of Data')
    ...
    def __add__(self, other):
        ...
        """Function to add together two Binomial cpetreanu-gaussian-binomial with equal p
        ...
        # DONE: Define addition for two binomial cpetreanu-gaussian-binomial. Assume that the
        # p values of the two cpetreanu-gaussian-binomial are the same. The formula for
        # summing two binomial cpetreanu-gaussian-binomial with different p values is more complicated,
        # so you are only expected to implement the case for two cpetreanu-gaussian-binomial with equal p.
        ...
        #   When adding two binomial cpetreanu-gaussian-binomial, the p value remains the same
        #   The new n value is the sum of the n values of the two cpetreanu-gaussian-binomial.
    ...
    def __repr__(self):
        ...
        #
        #       with the values replaced by whatever the actual cpetreanu-gaussian-binomial values are
