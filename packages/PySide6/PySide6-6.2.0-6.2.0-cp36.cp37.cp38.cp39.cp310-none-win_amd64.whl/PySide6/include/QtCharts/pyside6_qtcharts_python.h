...
enum : int {
    ...
    SBK_QTCHARTS_QLIST_QPIESLICEPTR_IDX                      = 12, // QList<QPieSlice* >
    SBK_QTCHARTS_QLIST_QCANDLESTICKSETPTR_IDX                = 13, // QList<QCandlestickSet* >
    SBK_QTCHARTS_QLIST_QBOXSETPTR_IDX                        = 14, // QList<QBoxSet* >
    SBK_QTCHARTS_QLIST_QBARSETPTR_IDX                        = 15, // QList<QBarSet* >
