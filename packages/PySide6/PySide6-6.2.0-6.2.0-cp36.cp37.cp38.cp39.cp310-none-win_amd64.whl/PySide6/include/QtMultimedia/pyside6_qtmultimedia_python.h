...
enum : int {
    ...
    SBK_QAUDIOFORMAT_SAMPLEFORMAT_IDX                        = 11,
    SBK_QAUDIOFORMAT_CHANNELCONFIG_IDX                       = 10,
    SBK_QAUDIOFORMAT_IDX                                     = 9,
    SBK_QAUDIOINPUT_IDX                                      = 12,
    SBK_QAUDIOOUTPUT_IDX                                     = 13,
    SBK_QAUDIOSINK_IDX                                       = 14,
    SBK_QAUDIOSOURCE_IDX                                     = 15,
    SBK_QCAMERA_ERROR_IDX                                    = 17,
    SBK_QCAMERA_FOCUSMODE_IDX                                = 21,
    SBK_QCAMERA_FLASHMODE_IDX                                = 20,
    SBK_QCAMERA_TORCHMODE_IDX                                = 22,
    SBK_QCAMERA_EXPOSUREMODE_IDX                             = 18,
    SBK_QCAMERA_WHITEBALANCEMODE_IDX                         = 23,
    SBK_QCAMERA_FEATURE_IDX                                  = 19,
    SBK_QFLAGS_QCAMERA_FEATURE_IDX                           = 27,
    SBK_QCAMERA_IDX                                          = 16,
    SBK_QCAMERADEVICE_POSITION_IDX                           = 25,
    SBK_QCAMERADEVICE_IDX                                    = 24,
    SBK_QCAMERAFORMAT_IDX                                    = 26,
    SBK_QIMAGECAPTURE_ERROR_IDX                              = 29,
    SBK_QIMAGECAPTURE_QUALITY_IDX                            = 31,
    SBK_QIMAGECAPTURE_FILEFORMAT_IDX                         = 30,
    SBK_QIMAGECAPTURE_IDX                                    = 28,
    SBK_QMEDIACAPTURESESSION_IDX                             = 32,
    SBK_QMEDIADEVICES_IDX                                    = 33,
    SBK_QMEDIAFORMAT_FILEFORMAT_IDX                          = 37,
    SBK_QMEDIAFORMAT_AUDIOCODEC_IDX                          = 35,
    SBK_QMEDIAFORMAT_VIDEOCODEC_IDX                          = 39,
    SBK_QMEDIAFORMAT_CONVERSIONMODE_IDX                      = 36,
    SBK_QMEDIAFORMAT_RESOLVEFLAGS_IDX                        = 38,
    SBK_QMEDIAFORMAT_IDX                                     = 34,
    SBK_QMEDIAMETADATA_KEY_IDX                               = 41,
    SBK_QMEDIAMETADATA_IDX                                   = 40,
    SBK_QMEDIAPLAYER_PLAYBACKSTATE_IDX                       = 45,
    SBK_QMEDIAPLAYER_MEDIASTATUS_IDX                         = 44,
    SBK_QMEDIAPLAYER_ERROR_IDX                               = 43,
    SBK_QMEDIAPLAYER_IDX                                     = 42,
    SBK_QMEDIARECORDER_QUALITY_IDX                           = 49,
    SBK_QMEDIARECORDER_ENCODINGMODE_IDX                      = 47,
    SBK_QMEDIARECORDER_RECORDERSTATE_IDX                     = 50,
    SBK_QMEDIARECORDER_ERROR_IDX                             = 48,
    SBK_QMEDIARECORDER_IDX                                   = 46,
    SBK_QMEDIATIMERANGE_IDX                                  = 51,
    SBK_QMEDIATIMERANGE_INTERVAL_IDX                         = 52,
    SBK_QSOUNDEFFECT_LOOP_IDX                                = 54,
    SBK_QSOUNDEFFECT_STATUS_IDX                              = 55,
    SBK_QSOUNDEFFECT_IDX                                     = 53,
    SBK_QVIDEOFRAME_HANDLETYPE_IDX                           = 57,
    SBK_QVIDEOFRAME_MAPMODE_IDX                              = 58,
    SBK_QVIDEOFRAME_IDX                                      = 56,
    SBK_QVIDEOFRAMEFORMAT_PIXELFORMAT_IDX                    = 61,
    SBK_QVIDEOFRAMEFORMAT_DIRECTION_IDX                      = 60,
    SBK_QVIDEOFRAMEFORMAT_YCBCRCOLORSPACE_IDX                = 62,
    SBK_QVIDEOFRAMEFORMAT_IDX                                = 59,
    SBK_QVIDEOSINK_IDX                                       = 63,
    SBK_QtMultimedia_IDX_COUNT                               = 64
};
