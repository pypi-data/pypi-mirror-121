...
from .messages import Message, RemoteAssetMessage
...
class ParametersBatch(object):
    ...
    def __init__(self, base_interval):
        # type: (float) -> None
        """Creates new instance of parameters bbatch. The base_interval value will be used as initial interval
        ...
        self.last_time = 0.0
        self.items = {}  # type: Dict[str, Tuple[Message, int]]
    ...
    def append(self, message, offset):
        ...
        if message.param is not None:
            name = message.param["paramName"]
        elif message.params is not None:
            name = message.params["paramName"]
        else:
            return False
    ...
    def accept(self, callback, unconditional=False):
        # type: (Callable[[Message, int], None], bool) -> bool
    ...
    def _accept(self, callback):
        # type: (Callable[[Message, int], None]) -> None
