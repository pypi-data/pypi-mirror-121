...
def solve_twophase(m: int,  # Number of salesmen
    ...
    for _m in range(m):
        if len(assigned_cities[_m]) == 0:  # Not assigned to any city
            ...
            tour_length[_m] = 2 * cdist(depot_coord, city_coord[city_i - 1:city_i, :], metric='euclidean')
        else:
            ...
            tour = [replacer(n, n) for n in tour]
...
#     info = solve_twophase(m=2, n=10, tsp_heuristics='NI')
