...
class KX_2DFilter:
    ...
    def addOffScreen(self, slots, width=-1, height=-1, mipmap: bool = False):
...
class KX_FontObject:
    ''' A Font object. It is possible to use attributes from :type: ~bpy.types.TextCurve
    '''
...
class KX_Scene:
    ...
    def addObject(self,
        ...
        :type time: float
        :param dupli: Full duplication of object data (materials...).
        :type dupli: bool
