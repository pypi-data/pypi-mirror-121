...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.5.0-alpha.1632753198+a097a42f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.5.0-alpha.1632753198+a097a42f`
                """)
            else:
                raise
