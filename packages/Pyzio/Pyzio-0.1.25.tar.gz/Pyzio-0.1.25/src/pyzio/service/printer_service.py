...
class PrinterService:
	...
	def add_sensor(self, phasio_id: str, name: str, sensor_type: SensorType) -> None:
	...
	def register_candidate(self, printer_name, printer_model, printer_material) -> Tuple[str, str, str]:
		return self._brainer_client.register_candidate(printer_name, printer_model, printer_material)