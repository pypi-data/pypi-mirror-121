...
LOGGING = {
    ...
    'formatters': {
        ...
        'color-detail-info': {
            'format': f'{StdoutColors.TXTGRAY}[%(asctime)s]{StdoutColors.ENDC} {StdoutColors.OKBLUE}[%(levelname)s]{StdoutColors.ENDC} {StdoutColors.TXTGRAY}[%(threadName)s:%(thread)d] [%(module)s:%(lineno)d]{StdoutColors.ENDC} %(message)s'
        },
        'sys-color-detail-info': {
            'format': f'{StdoutColors.TXTGRAY}[%(asctime)s]{StdoutColors.ENDC} {StdoutColors.OKBLUE}[%(levelname)s]{StdoutColors.ENDC} {StdoutColors.TXTGRAY}[%(threadName)s:%(thread)d] [%(module)s:%(lineno)d] {StdoutColors.ENDC}%(message)s'
        },
        ...
        'color-error': {
            'format': f'[%(asctime)s] {StdoutColors.FAIL}[%(levelname)s]{StdoutColors.ENDC} [%(threadName)s:%(thread)d] [%(module)s:%(lineno)d] %(message)s'},
    ...
    'handlers': {
        ...
        'console-sys-detail-info': {'level': 'INFO', 'formatter': 'sys-color-detail-info', 'class': 'logging.StreamHandler'},
    ...
    'loggers': {
        ...
        'sys-detail-info': {'handlers': ['console-sys-detail-info'], 'level': 'INFO', 'propagate': False},
...
OK = f'{StdoutColors.OKGREEN}[OK]{StdoutColors.ENDC}'
FAIL = f'{StdoutColors.FAIL}[FAIL]{StdoutColors.ENDC}'
SYS = f'{StdoutColors.FAIL}[FAIL]{StdoutColors.ENDC}'
...
Logger.sys_info = logging.getLogger('sys-detail-info').info
