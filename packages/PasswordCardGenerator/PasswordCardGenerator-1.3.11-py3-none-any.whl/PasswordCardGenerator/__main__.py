...
import PasswordCardGenerator.Web as Web
import PasswordCardGenerator.GUI as GUI
from random import choices, randint
from os import path
import argparse

# for generating the keyword we need a few (1000) words
...
parser.add_argument("--web", action="store_true", help="Start the Web version")
...
# print password if flag is set
if args.pwd:
    print("Password: ", card.get_password(keyword))

# saving the card
filename = None
## save as png if flag is set
if args.png:
    # creating filename
...
if args.txt:
    ...
    # changing the file ending to the right ending
