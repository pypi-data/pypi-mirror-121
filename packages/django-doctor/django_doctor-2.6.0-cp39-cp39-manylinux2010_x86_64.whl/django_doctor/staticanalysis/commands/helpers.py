...
from django_doctor.staticanalysis import checker, meta, helpers, render, transformer, message_templates
...
class Message(dict):
    ...
    def documentation_links(self):
        return [helpers.get_hyperlink(message_id) for message_id in self['message_ids']]
