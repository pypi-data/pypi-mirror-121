...
# GenerateL1OutputData Task
generate_l1_output_data = Workflow(
    process_category="test", process_name="generate_l1_output_data", workflow_package=__package__
)
generate_calibrated_data.add_node(task=GenerateL1OutputData, upstreams=None)
