...
# MESSAGES FOR INVALID DATA          
    ...
    def cluster_data(self, data, analyte_name=["ANALYTE_NAME"], n_clusters=4, filter=False, col=None, equals=[], year_interval=5, return_clusters=False ):
        data = data.copy()
        if(filter):
            ...
            filter_wells = list(filter_res.STATION_ID.unique())
            intersect_wells = list(set(query_wells) & set(filter_wells))
        ...
        ax.set_ylabel("Log concentration", fontsize=20)
