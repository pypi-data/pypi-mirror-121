...
def get_user_data_dir(appname):
    ...
    return result.joinpath(appname)


def get_log_file_name():
    from datetime import datetime
    filename = datetime.now().strftime('%Y-%m-%d.log')
    return os.path.join(get_user_data_dir('mabledso'), filename) 
...
class LoggerClass():
    ...
    def __init__(self, level):
        ...
        self.logger = logging.getLogger('mabledso')
    ...
    ### maps mabledso log verbosity to internal verbosity
