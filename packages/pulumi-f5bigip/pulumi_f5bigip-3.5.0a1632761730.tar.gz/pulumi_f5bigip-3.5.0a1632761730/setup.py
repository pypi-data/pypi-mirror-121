...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '3.5.0-alpha.1632761730+2ae0e4aa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 3.5.0-alpha.1632761730+2ae0e4aa`
                """)
            else:
                raise
