...
class GraphQLHelper(object):
    ...
    def represent_input_argument(self, field: graphene.ObjectType) -> bool:
        """
        ...
        if isinstance(field, graphene.Argument):
            return GraphQLHelper.represent_input_argument(field.type)
    ...
    def argument_optional_input(cls, input_type: type, default_value: any, description: str = None) -> graphene.Argument:
        ...
        return graphene.Argument(input_type, required=True, default_value=default_value, description=description)
