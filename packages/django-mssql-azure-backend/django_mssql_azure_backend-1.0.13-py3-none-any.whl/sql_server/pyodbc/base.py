...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_new_connection(self, conn_params):
        ...
        # import re
        # connstr = re.sub('attrs_before.*?};', '', connstr)
        # print('after connection String--> ', connstr)
        cstr_parts['attrs_before'] = {1256: bytearray(token_struct)}
        print('atts_before Key: ',cstr_parts['attrs_before'])
        ...
        while conn is None:
            try:
                ...
                conn = Database.connect(connstr,
                                        attrs_before=cstr_parts['attrs_before'],
                                        unicode_results=unicode_results,
                                        timeout=timeout)
            except Exception as e:
                print('Error occurred during connect: ', e)
