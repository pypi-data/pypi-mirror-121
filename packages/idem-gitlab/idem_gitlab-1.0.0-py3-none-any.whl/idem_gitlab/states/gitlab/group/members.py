...
async def present(
    ...
    **Autogenerated function**
    ...
    before = hub.exec.request.json.get(
        ctx,
        url=f"{ctx.acct.endpoint_url}/groups/{project_id}/members",
        data={},
        success_codes=[200],
    )
    if before["status"]:
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            $ idem describe gitlab.group.members
    """
    ...
    async for project in hub.exec.gitlab.request.paginate(
        ...
        async for ret in hub.exec.gitlab.request.paginate(
            ctx, url=f"{ctx.acct.endpoint_url}/groups/{project_id}/members"
        ):
            result[f"/groups-{project_id}-group.members-{ret['id']}"] = {
                "gitlab.group.members.present": [
