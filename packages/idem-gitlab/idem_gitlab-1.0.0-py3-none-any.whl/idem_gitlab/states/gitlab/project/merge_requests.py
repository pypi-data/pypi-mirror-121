    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              gitlab.project.merge_requests.present:
                - name: value
                - project_id: value
    ...
    before = hub.exec.request.json.get(
        ctx,
        url=f"{ctx.acct.endpoint_url}/projects/{project_id}/merge_requests",
        data={},
        success_codes=[200],
    )
    if before["status"]:
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              gitlab.project.merge_requests.absent:
                - name: value
                - project_id: value
                - merge_request_iid: value
    """
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            $ idem describe gitlab.project.merge_requests
    """
    ...
    async for project in hub.exec.gitlab.request.paginate(
        ...
        async for ret in hub.exec.gitlab.request.paginate(
            ctx, url=f"{ctx.acct.endpoint_url}/projects/{project_id}/merge_requests"
        ):
            result[f"/projects-{project_id}-project.merge_requests-{ret['id']}"] = {
                "gitlab.project.merge_requests.present": [
