"""Action related classes for the cyberrl environment.

This module contains the different action classes that are used
to implement actions within a cyberrl environment, along within the
...
class FlatActionSpace(spaces.Discrete):
    """Flat Action space for cyberrl environment.
...
class ParameterisedActionSpace(spaces.MultiDiscrete):
    """A parameterised action space for cyberrl environment.
