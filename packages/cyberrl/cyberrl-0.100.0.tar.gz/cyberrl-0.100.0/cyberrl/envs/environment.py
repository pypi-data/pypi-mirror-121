""" The main Environment class for cyberrl: cyberrlEnv.

The cyberrlEnv class is the main interface for agents interacting with cyberrl.
"""
import gym
import numpy as np
...
class cyberrlEnv(gym.Env):
    ...
    def step(self, action):
        ...
        dict
            ...
            (see :func:`cyberrl.env.action.ActionResult.info`)
        """
