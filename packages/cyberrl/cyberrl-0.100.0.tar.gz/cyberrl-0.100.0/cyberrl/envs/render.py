"""This module contains functions and classes for rendering cyberrl """
import math
import random
...
try:
    ...
    warnings.warn(
        ...
        f"exception: \"{type(ex)} {ex}\". CyberRL can still run but GUI "
        f"functionality may not work as expected."
    )
...
class Viewer:
    """A class for visualizing the network state from cyberrlEnv"""
...
class EpisodeViewer:
    """Displays sequence of observations from cyberrlEnv in a seperate window"""
