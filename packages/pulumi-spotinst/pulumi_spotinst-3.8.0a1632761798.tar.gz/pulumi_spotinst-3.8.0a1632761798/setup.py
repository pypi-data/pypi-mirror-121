...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.8.0-alpha.1632761798+6e7d8607'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.8.0-alpha.1632761798+6e7d8607`
                """)
            else:
                raise
