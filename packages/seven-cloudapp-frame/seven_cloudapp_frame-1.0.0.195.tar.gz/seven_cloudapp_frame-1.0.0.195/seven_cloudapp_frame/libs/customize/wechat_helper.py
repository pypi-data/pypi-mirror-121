...
@LastEditTime: 2021-09-29 19:09:05
...
class WeChatPayRequest(object):
    ...
    def get_prepay_id(self, unifiedorder_url, params):
        ...
        if prepay_id:
            ...
            return invoke_result_data
        params = WeChatHelper.get_sign(params, self.api_key)
        respone = requests.post(unifiedorder_url, self.convert_request_xml(params), headers={'Content-Type': 'application/xml'})
...
class WeChatPayReponse(object):
    ...
    def check_sign(self):
        ...
        del params['sign']
        sign = WeChatHelper.get_sign(params, self.api_key)['sign']  # 本地签名
