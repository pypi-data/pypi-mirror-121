...
@LastEditTime: 2021-09-28 17:56:19
...
class WechatPayNotifyHandler(ClientBaseHandler):
    """
...
class WechatRefundNotifyHandler(ClientBaseHandler):
    """
    ...
    def post_async(self):
        ...
        try:
            ...
            if result_code == "FAIL":
                return self.write(wechat_refund_reponse.convert_response_xml(response_result["err_code_des"], False))
            invoke_result_data = self.business_process_executing(self.request_params)
            if invoke_result_data.success == False:
...
class TiktokPayNotifyHandler(ClientBaseHandler):
    """
...
class TiktokRefundNotifyHandler(ClientBaseHandler):
    """
