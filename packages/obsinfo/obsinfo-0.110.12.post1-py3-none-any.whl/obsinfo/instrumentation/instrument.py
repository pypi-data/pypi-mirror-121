...
class Instrument(object):    # Was a Channel subclass, but don't see why
    ...
    def __init__(self, attributes_dict, channel_modif={}):
        ...
        """
        # print(f'Instrument(attributes_dict=..., {channel_modif=})')
        ...
        # correct delay
        self.integrate_component_stages_into_single_list()
    ...
    def integrate_component_stages_into_single_list(self):
        """
        ...
        for this_stage in stages[1:]:
            ...
            # 2b) Verify continuity of sample rate, calculate/verify delay
