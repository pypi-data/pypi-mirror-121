...
class Channel(object):
    ...
    Attributes:
        ...
        obspy_channel (class *obspy.core.inventory.channel.Channel): The
            attributes of this *obsinfo* object ):
    """
    ...
    def __init__(self, channel_label, attributes_dict, locations,
        ...
        """
        # print(f'Channel({channel_label=}, attributes_dict=..., {locations=}, '
        #       f'{start_date=}, {end_date=}, {equipment=}, {channel_default=},'
        #       f' {channel_mods_dict=})')
    ...
    def to_obspy(self, equipment):
        ...
        preamp = self.instrument.preamplifier.equipment.obspy_equipment \
