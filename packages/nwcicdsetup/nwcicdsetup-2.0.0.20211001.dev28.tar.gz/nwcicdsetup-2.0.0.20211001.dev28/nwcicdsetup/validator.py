...
from nwcicdsetup.nwservice import NWService, NWServiceContext, NWTask
...
async def validate(general_config_path: str):
    ...
    try:
        ...
        context = NWServiceContext(CircleCIContext.create_dummy_env(
        ), services, general_config, str(cwd.resolve()))
