    ...
    """
{
    ...
    "package_data": {
        "cdk_stepfunctions_redshift._jsii": [
            "cdk-stepfunctions-redshift@1.122.0.jsii.tgz"
        ],
        "cdk_stepfunctions_redshift": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-eventbridge-sqs==1.122.0",
        "aws-solutions-constructs.aws-lambda-dynamodb==1.122.0",
        "aws-solutions-constructs.aws-sqs-lambda==1.122.0",
