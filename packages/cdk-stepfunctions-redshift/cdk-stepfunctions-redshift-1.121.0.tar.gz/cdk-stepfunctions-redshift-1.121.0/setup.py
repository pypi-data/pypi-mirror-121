    ...
    """
{
    ...
    "package_data": {
        "cdk_stepfunctions_redshift._jsii": [
            "cdk-stepfunctions-redshift@1.121.0.jsii.tgz"
        ],
        "cdk_stepfunctions_redshift": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-python==1.121.0",
        ...
        "aws-cdk.aws-stepfunctions-tasks==1.121.0",
        "aws-cdk.aws-stepfunctions==1.121.0",
        "aws-cdk.core==1.121.0",
        "aws-solutions-constructs.aws-eventbridge-sqs==1.121.0",
        "aws-solutions-constructs.aws-lambda-dynamodb==1.121.0",
        "aws-solutions-constructs.aws-sqs-lambda==1.121.0",
