...
*DataJobsDeploymentApi* | [**deployment_enable**](docs/DataJobsDeploymentApi.md#deployment_enable) | **PATCH** /data-jobs/for-team/{team_name}/jobs/{job_name}/deployments/{deployment_id} | Enable/disable the deployment of a Data Job. When disabled, the Data Job will not be executed. | (Stable)
