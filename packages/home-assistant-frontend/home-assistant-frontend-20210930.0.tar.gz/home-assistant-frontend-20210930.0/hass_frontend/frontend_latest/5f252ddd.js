...
`,E=(e,t,r)=>{const o=getComputedStyle(t).getPropertyValue(`--weather-icon-${e}`);return o?i.dy`
  ...
  ${p.has(e)?i.YP`
    ...
    `}},{kind:"method",key:"renderEntity",value:function(e){var r;const i=this.hass.states[e.entity];return i?t.dy`
      <div
        class="entity"
        .config=${e}
        @action=${this._handleAction}
      ...
      >
        ...
        ${this._config.show_state&&!1!==e.show_state?t.dy`
              <div>
                ${"sensor"!==(0,d.M)(e.entity)||i.attributes.device_class!==p.F||u.V_.includes(i.state)?e.show_last_changed?(0,l.G)(new Date(i.last_changed),this.hass.locale):(0,h.D)(this.hass.localize,i,this.hass.locale):t.dy`
        ...
        <div class="content">
          ...
          <div class="info">
            <div class="name-state">
              <div class="state">
                ${(0,c.D)(this.hass.localize,i,this.hass.locale)}
              </div>
              <div class="name">
                ${this._config.name||(0,d.C)(i)}
              </div>
            </div>
            <div class="temp-attribute">
              <div class="temp">
                ${(0,u.u)(i.attributes.temperature,this.hass.locale)}&nbsp;<span>${(0,y.pv)(this.hass,"temperature")}</span>
              </div>
              <div class="attribute">
                ${void 0!==this._config.secondary_info_attribute?t.dy`
                      ...
                      ${"wind_speed"===this._config.secondary_info_attribute?(0,y.NF)(this.hass,i.attributes.wind_speed,i.attributes.wind_bearing):t.dy`
                            ${(0,u.u)(i.attributes[this._config.secondary_info_attribute],this.hass.locale)}
    ...
    `}}]}}),i.oi)}}]);
//# sourceMappingURL=5f252ddd.js.map