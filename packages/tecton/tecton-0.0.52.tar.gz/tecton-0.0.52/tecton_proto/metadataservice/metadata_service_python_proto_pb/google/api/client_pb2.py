...
method_signature = _descriptor.FieldDescriptor(
  ...
  serialized_options=None, json_name='methodSignature', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
...
default_host = _descriptor.FieldDescriptor(
  ...
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='defaultHost', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
