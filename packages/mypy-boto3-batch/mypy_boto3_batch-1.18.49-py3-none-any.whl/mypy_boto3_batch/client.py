...
class BatchClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.can_paginate)
    ...
    def cancel_job(self, *, jobId: str, reason: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.cancel_job)
    ...
    def create_compute_environment(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.create_compute_environment)
    ...
    def create_job_queue(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.create_job_queue)
    ...
    def delete_compute_environment(self, *, computeEnvironment: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.delete_compute_environment)
    ...
    def delete_job_queue(self, *, jobQueue: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.delete_job_queue)
    ...
    def deregister_job_definition(self, *, jobDefinition: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.deregister_job_definition)
    ...
    def describe_compute_environments(
        self,
        *,
        computeEnvironments: Sequence[str] = None,
        maxResults: int = None,
        nextToken: str = None
    ) -> DescribeComputeEnvironmentsResponseTypeDef:
        """
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.describe_compute_environments)
    ...
    def describe_job_definitions(
        self,
        *,
        jobDefinitions: Sequence[str] = None,
        maxResults: int = None,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.describe_job_definitions)
    ...
    def describe_job_queues(
        self, *, jobQueues: Sequence[str] = None, maxResults: int = None, nextToken: str = None
    ) -> DescribeJobQueuesResponseTypeDef:
        """
        Describes one or more of your job queues.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.describe_job_queues)
    ...
    def describe_jobs(self, *, jobs: Sequence[str]) -> DescribeJobsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.describe_jobs)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.generate_presigned_url)
    ...
    def list_jobs(
        ...
        *,
        ...
        maxResults: int = None,
        nextToken: str = None,
        filters: Sequence["KeyValuesPairTypeDef"] = None
    ) -> ListJobsResponseTypeDef:
        """
        Returns a list of Batch jobs.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.list_jobs)
    ...
    def list_tags_for_resource(self, *, resourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.list_tags_for_resource)
    ...
    def register_job_definition(
        ...
        *,
        ...
        tags: Mapping[str, str] = None,
        platformCapabilities: Sequence[PlatformCapabilityType] = None
    ) -> RegisterJobDefinitionResponseTypeDef:
        """
        Registers an Batch job definition.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.register_job_definition)
    ...
    def submit_job(
        ...
        *,
        ...
        dependsOn: Sequence["JobDependencyTypeDef"] = None,
        parameters: Mapping[str, str] = None,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.submit_job)
    ...
    def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.tag_resource)
    ...
    def terminate_job(self, *, jobId: str, reason: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.terminate_job)
    ...
    def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.untag_resource)
    ...
    def update_compute_environment(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.update_compute_environment)
    ...
    def update_job_queue(
        ...
        *,
        ...
        state: JQStateType = None,
        priority: int = None,
        computeEnvironmentOrder: Sequence["ComputeEnvironmentOrderTypeDef"] = None
    ) -> UpdateJobQueueResponseTypeDef:
        """
        Updates a job queue.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Client.update_job_queue)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Paginator.DescribeComputeEnvironments)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Paginator.DescribeJobDefinitions)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Paginator.DescribeJobQueues)
    ...
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.49/reference/services/batch.html#Batch.Paginator.ListJobs)
