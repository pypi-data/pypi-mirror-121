...
package_data = \
{'': ['*'],
 'onelearn.datasets': ['data/adult.csv.zip',
                       'data/adult.csv.zip',
                       'data/adult.csv.zip',
                       'data/adult.csv.zip',
                       'data/adult.csv.zip',
