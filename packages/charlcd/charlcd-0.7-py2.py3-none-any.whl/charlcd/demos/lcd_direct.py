...
from charlcd.drivers.i2cm import I2C as I2CM # NOQA pylint: disable=I0011,F0401
...
def test6():
    """" module i2c"""
    i2c_20x4 = I2CM(0x27, 1)
    lcd_1 = lcd.CharLCD(20, 4, i2c_20x4, 1, 1)
    lcd_1.init()

    lcd_1.write('-First blarg1 aaa!')
    lcd_1.write('-Second blarg2 !', 0, 1)
    lcd_1.write('-Third blarg3 !', 0, 2)
