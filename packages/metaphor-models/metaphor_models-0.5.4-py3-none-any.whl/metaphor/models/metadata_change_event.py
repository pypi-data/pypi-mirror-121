...
class DbtMacro:
    ...
    def from_dict(obj: Any) -> 'DbtMacro':
        ...
        return DbtMacro(depends_on_macros, name, package_name, sql, unique_id)
...
class DbtModel:
    ...
    def from_dict(obj: Any) -> 'DbtModel':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        return DbtModel(id, aspect_type, compiled_sql, created_at, description, entity_id, fields, dbt_model_id, latest, macros, materialization, source_datasets, source_models, tests, url)
...
class LookerExplore:
    ...
    def from_dict(obj: Any) -> 'LookerExplore':
        ...
        tags = from_union([lambda x: from_list(from_str, x), from_none], obj.get("tags"))
        url = from_union([from_str, from_none], obj.get("url"))
        return LookerExplore(id, aspect_type, base_view, created_at, description, entity_id, extends, fields, filters, looker_explore_id, joins, label, latest, tags, url)
...
class LookerView:
    ...
    def from_dict(obj: Any) -> 'LookerView':
        ...
        source_dataset = from_union([from_str, from_none], obj.get("sourceDataset"))
        url = from_union([from_str, from_none], obj.get("url"))
        return LookerView(id, aspect_type, created_at, dimensions, entity_id, extends, filters, looker_view_id, label, latest, measures, source_dataset, url)
    ...
    def to_dict(self) -> dict:
        ...
        result["sourceDataset"] = from_union([from_str, from_none], self.source_dataset)
        result["url"] = from_union([from_str, from_none], self.url)
        return result
