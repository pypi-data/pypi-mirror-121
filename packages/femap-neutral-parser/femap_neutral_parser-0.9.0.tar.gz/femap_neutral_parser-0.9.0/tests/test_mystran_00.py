...
def test_vectors_agg(neutral, f_neutral):
    ...
    vec = neutral.vectors(("disp::t1", "disp::t2", "disp::t3"))
    f_vec = neutral.vectors(("disp::t1", "disp::t2", "disp::t3"))
...
def test_info(neutral):
    ...
    expected = [
        ...
        " * disp::r2 -> R2 rotation",
        " * disp::r3 -> R3 rotation",
        " * force_applied::t_total -> RSS applied force",
        " * force_applied::t1 -> T1 applied force",
        " * force_applied::t2 -> T2 applied force",
        " * force_applied::t3 -> T3 applied force",
        " * force_applied::r_total -> RSS applied moment",
        " * force_applied::r1 -> R1 applied moment",
        " * force_applied::r2 -> R2 applied moment",
        " * force_applied::r3 -> R3 applied moment",
        " * force_reac::t_total -> RSS SPC force",
        " * force_reac::t1 -> T1 SPC force",
        " * force_reac::t2 -> T2 SPC force",
        " * force_reac::t3 -> T3 SPC force",
        " * force_reac::r_total -> RSS SPC moment",
        " * force_reac::r1 -> R1 SPC moment",
        " * force_reac::r2 -> R2 SPC moment",
        " * force_reac::r3 -> R3 SPC moment",
        ...
        " * force_cbar::shear1 -> BAR EndB Pl1 Shear Force",
        " * force_cbar::shear2 -> BAR EndB Pl2 Shear Force",
        " * force_cbar::axial -> BAR EndA Axial Force",
        " * force_cbar::torque -> BAR EndA Torque",
...
def test_get_local_forces(neutral):
    df = neutral.get("force_cbar", asdf=True)
