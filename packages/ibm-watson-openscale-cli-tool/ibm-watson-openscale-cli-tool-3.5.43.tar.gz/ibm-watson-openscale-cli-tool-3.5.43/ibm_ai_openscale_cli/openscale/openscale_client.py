...
from ibm_ai_openscale_cli.utility_classes.constants import DRIFT_ARCHIVE_ENV_MAPPING, WML_SPARK_VERSION_SUPPORT_MAPPING
...
class OpenScaleClient(OpenScaleReset):
    ...
    def trigger_monitors(self):
        ...
        trigger_monitors = True
        if self._args.mrm and not self.is_mrm_prod:
            trigger_monitors = False
