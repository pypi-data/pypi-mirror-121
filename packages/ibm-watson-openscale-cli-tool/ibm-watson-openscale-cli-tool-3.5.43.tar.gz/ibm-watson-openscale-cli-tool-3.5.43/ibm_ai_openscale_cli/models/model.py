...
from ibm_ai_openscale_cli.utility_classes.constants import WML_SPARK_VERSION_SUPPORT_MAPPING
...
class Model:
    ...
    def __init__(self, name, args, model_instances=1):
        ...
        if "Challenger" not in self.name:
            ...
            model_meta_filename = Model.MODEL_META_FILENAME
            model_content_filename = Model.MODEL_CONTENT_FILENAME
