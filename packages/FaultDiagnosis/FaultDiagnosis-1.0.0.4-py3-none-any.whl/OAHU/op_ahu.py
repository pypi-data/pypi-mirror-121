...
# (3)운용공조기 정상상태 예측 급기팬 전력량 산출(KSB 회귀모델에 운용공조기 10일치 정상데이터 사용)
def op_normal_predict(StartDate, EndDate, EquipmentClassCode, EquipmentNo, SiteCode, BuildingNo, ZoneNo):
    ...
    fault_data = T_AHU_SENSING_INFO(EquipmentClassCode, EquipmentNo, SiteCode, BuildingNo, ZoneNo)
...
def op_best_poly_reg_model(fault_predict, Y_pred1, Y_prediction2, AirCondition, EquipmentClassCode, EquipmentNo,
    ...
    val = (
    EquipmentClassCode, EquipmentNo, SiteCode, BuildingNo, ZoneNo, CoolHeatInd, s_cvrmse, s_wsd, s_cramerd, poly_degree,
    sdate)
