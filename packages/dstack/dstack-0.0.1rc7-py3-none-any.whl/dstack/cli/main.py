...
from dstack.cli import logs, run, stop, artifacts, status, register, login, logout, token, runners, repo_init, \
    auto_scale, resume
...
def main():
    ...
    repo_init.register_parsers(subparsers)
    auto_scale.register_parsers(subparsers)
