...
namespace __pythran_operators2d
{
  ...
  struct invlaplacian_fft
  {
    ...
    struct type
    {
      ...
      typedef typename pythonic::returnable<typename __combined<__type6,__type8,__type5>::type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 >
  ...
  struct __for_method__OperatorsPseudoSpectral2D__get_phases_random
  {
    ...
    struct type
    {
      ...
      typedef decltype(pythonic::operator_::sub(std::declval<__type8>(), std::declval<__type25>())) __type28;
      typedef typename __combined<__type26,__type28>::type __type29;
      typedef decltype(pythonic::operator_::mul(std::declval<__type29>(), std::declval<__type9>())) __type31;
      typedef decltype(pythonic::operator_::mul(std::declval<__type31>(), std::declval<__type11>())) __type33;
      typedef decltype(pythonic::operator_::add(std::declval<__type18>(), std::declval<__type25>())) __type35;
      typedef decltype(pythonic::operator_::sub(std::declval<__type18>(), std::declval<__type25>())) __type37;
      typedef typename __combined<__type35,__type37>::type __type38;
      typedef decltype(pythonic::operator_::mul(std::declval<__type38>(), std::declval<__type19>())) __type40;
      typedef decltype(pythonic::operator_::mul(std::declval<__type40>(), std::declval<__type21>())) __type42;
      typedef decltype(pythonic::operator_::add(std::declval<__type33>(), std::declval<__type42>())) __type43;
      typedef typename pythonic::returnable<decltype(pythonic::types::make_tuple(std::declval<__type23>(), std::declval<__type43>()))>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 >
  ...
  typename __for_method__OperatorsPseudoSpectral2D__dealiasing_setofvar::type<argument_type0, argument_type1, argument_type2>::result_type __for_method__OperatorsPseudoSpectral2D__dealiasing_setofvar::operator()(argument_type0&& self__has_to_dealiase, argument_type1&& self_where_dealiased, argument_type2&& sov) const
  {
    ...
    if (self__has_to_dealiase)
    {
      ...
      {
        long  __target140412143463536 = n0;
        for (long  i0=0L; i0 < __target140412143463536; i0 += 1L)
        {
          {
            long  __target140412143563296 = n1;
            for (long  i1=0L; i1 < __target140412143563296; i1 += 1L)
            {
              if (self_where_dealiased.fast(pythonic::types::make_tuple(i0, i1)))
              {
                {
                  long  __target140412143564784 = nk;
                  for (long  ik=0L; ik < __target140412143564784; ik += 1L)
                  {
  ...
  typename invlaplacian_fft::type<argument_type0, argument_type1, argument_type2>::result_type invlaplacian_fft::operator()(argument_type0&& a_fft, argument_type1&& Kn_not0, argument_type2&& rank) const
  {
    ...
    typedef double __type7;
    typedef container<typename std::remove_reference<__type7>::type> __type8;
    typename pythonic::assignable<typename __combined<__type6,__type8,__type5>::type>::type invlap_afft = pythonic::operator_::div(a_fft, Kn_not0);
  ...
  typename __for_method__OperatorsPseudoSpectral2D__get_phases_random::type<argument_type0, argument_type1, argument_type2, argument_type3>::result_type __for_method__OperatorsPseudoSpectral2D__get_phases_random::operator()(argument_type0&& self_KX, argument_type1&& self_KY, argument_type2&& self_deltax, argument_type3&& self_deltay) const
  {
    ...
    typename pythonic::assignable<typename __combined<__type7,__type11,__type15>::type>::type __tuple0 = pythonic::builtins::functor::tuple{}(pythonic::builtins::functor::map{}(__for_method__OperatorsPseudoSpectral2D__get_phases_random_lambda0(), pythonic::builtins::functor::range{}(2L)));
    ...
    {NULL, NULL, 0, NULL}
            ...
            PYTHRAN_MODULE_INIT(operators2d)(void) {
                ...
                PyObject * theDoc = Py_BuildValue("(sss)",
                                                  "0.9.11",
                                                  "2021-06-01 17:17:23.584433",
                                                  "c4b5aecc04ee16eb947f7453cf442818619ecfe20630a0c014c894bec98dd442");
                if(! theDoc)
                    PYTHRAN_RETURN;
