...
namespace __pythran_solver
{
  ...
  struct compute_fb_fft
  {
    ...
    struct type
    {
      ...
      typedef decltype(pythonic::operator_::neg(std::declval<__type0>())) __type3;
      ...
      typedef decltype(pythonic::operator_::sub(std::declval<__type3>(), std::declval<__type8>())) __type9;
      typedef __type0 __ptype0;
      typedef typename pythonic::returnable<typename __combined<__type1,__type9>::type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 >
...
PYTHRAN_MODULE_INIT(solver)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.11",
                                      "2021-06-01 17:17:26.490968",
                                      "ca64738ac72b8583d476b42cf33e87131c3e9bdd5ac33bef15882ee94f7b26ed");
    if(! theDoc)
        PYTHRAN_RETURN;
