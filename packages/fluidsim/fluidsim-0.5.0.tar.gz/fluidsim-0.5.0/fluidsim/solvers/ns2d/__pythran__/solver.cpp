...
namespace __pythran_solver
{
  ...
  struct compute_Frot
  {
    ...
    struct type
    {
      ...
      typedef decltype(pythonic::operator_::add(std::declval<__type5>(), std::declval<__type14>())) __type15;
      typedef decltype(pythonic::operator_::mul(std::declval<__type4>(), std::declval<__type15>())) __type16;
      typedef decltype(pythonic::operator_::sub(std::declval<__type3>(), std::declval<__type16>())) __type17;
      typedef typename pythonic::returnable<typename __combined<__type7,__type17>::type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 , typename argument_type4 = long>
...
PYTHRAN_MODULE_INIT(solver)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.11",
                                      "2021-06-01 17:17:25.769137",
                                      "83a77b616bc907e0e85839da8b5c8f290f0dffc9ccaa9712337cdefdf1c186a4");
    if(! theDoc)
        PYTHRAN_RETURN;
