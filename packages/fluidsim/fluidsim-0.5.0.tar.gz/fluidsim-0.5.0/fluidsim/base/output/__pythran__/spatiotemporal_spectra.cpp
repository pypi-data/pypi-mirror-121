...
namespace __pythran_spatiotemporal_spectra
{
  ...
  struct find_index_first_l
  {
    ...
    struct type
    {
      ...
      typedef typename pythonic::returnable<typename std::tuple_element<0,typename std::remove_reference<__type3>::type>::type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 >
  ...
  struct get_arange_minmax
  {
    ...
    struct type
    {
      ...
      typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::builtins::functor::len{})>::type>::type __type9;
      typedef decltype(std::declval<__type9>()(std::declval<__type4>())) __type11;
      typedef typename pythonic::lazy<__type11>::type __type12;
      typedef find_index_first_g __type13;
      typedef typename std::remove_cv<typename std::remove_reference<argument_type2>::type>::type __type15;
      typedef decltype(std::declval<__type13>()(std::declval<__type4>(), std::declval<__type15>())) __type16;
      typedef typename pythonic::lazy<__type16>::type __type17;
      typedef typename __combined<__type12,__type17>::type __type18;
      typedef typename pythonic::returnable<decltype(std::declval<__type0>()(std::declval<__type8>(), std::declval<__type18>()))>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 >
  ...
  {
    {
      static typename __transonic__::type::result_type tmp_global = pythonic::types::make_tuple(pythonic::types::str("0.4.10"));
      return tmp_global;
    }
  }
  template <typename argument_type0 , typename argument_type1 >
  ...
  typename get_arange_minmax::type<argument_type0, argument_type1, argument_type2>::result_type get_arange_minmax::operator()(argument_type0&& times, argument_type1&& tmin, argument_type2&& tmax) const
  {
    ...
    typedef typename __combined<__type1,__type6>::type __type7;
    typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::builtins::functor::len{})>::type>::type __type8;
    typedef decltype(std::declval<__type8>()(std::declval<__type3>())) __type10;
    typedef typename pythonic::lazy<__type10>::type __type11;
    typedef find_index_first_g __type12;
    typedef typename std::remove_cv<typename std::remove_reference<argument_type2>::type>::type __type14;
    typedef decltype(std::declval<__type12>()(std::declval<__type3>(), std::declval<__type14>())) __type15;
    typedef typename pythonic::lazy<__type15>::type __type16;
    typedef typename __combined<__type11,__type16>::type __type17;
    typename pythonic::lazy<__type7>::type start;
    typename pythonic::lazy<__type17>::type stop;
...
PYTHRAN_MODULE_INIT(spatiotemporal_spectra)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.12.post1",
                                      "2021-09-02 20:49:28.201216",
                                      "c573a76224f8bdaf57929389733f8b78d89198fa81131e5e9649b1b9d8babfd4");
    if(! theDoc)
        PYTHRAN_RETURN;
