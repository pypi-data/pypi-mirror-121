...
namespace __pythran_increments
{
  ...
  struct strfunc_from_pdf
  {
    ...
    struct type
    {
      ...
      typedef decltype(pythonic::builtins::getattr(pythonic::types::attr::SIZE{}, std::declval<__type2>())) __type7;
      ...
      typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::builtins::functor::abs{})>::type>::type __type12;
      typedef typename pythonic::assignable<typename std::remove_cv<typename std::remove_reference<argument_type2>::type>::type>::type __type13;
      typedef typename pythonic::assignable<decltype(std::declval<__type12>()(std::declval<__type13>()))>::type __type15;
      typedef typename __combined<__type13,__type15>::type __type16;
      typedef long __type18;
      typedef decltype(pythonic::types::make_tuple(std::declval<__type9>(), std::declval<__type18>())) __type19;
      typedef decltype(std::declval<__type16>()[std::declval<__type19>()]) __type20;
      typedef decltype(pythonic::operator_::sub(std::declval<__type20>(), std::declval<__type20>())) __type25;
      typedef decltype(std::declval<__type12>()(std::declval<__type25>())) __type26;
      ...
      typedef decltype(std::declval<__type28>()[std::declval<__type9>()]) __type30;
      typedef decltype(std::declval<__type16>()[std::declval<__type9>()]) __type33;
      typedef typename std::remove_cv<typename std::remove_reference<argument_type3>::type>::type __type34;
      typedef decltype(pythonic::builtins::pow(std::declval<__type33>(), std::declval<__type34>())) __type35;
      typedef decltype(pythonic::operator_::mul(std::declval<__type30>(), std::declval<__type35>())) __type36;
      typedef decltype(std::declval<__type27>()(std::declval<__type36>())) __type37;
      typedef decltype(pythonic::operator_::mul(std::declval<__type26>(), std::declval<__type37>())) __type38;
      typedef container<typename std::remove_reference<__type38>::type> __type39;
      typedef __type0 __ptype0;
      typedef typename pythonic::returnable<typename __combined<__type11,__type39,__type10>::type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 , typename argument_type4 = bool>
  ...
  typename strfunc_from_pdf::type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4>::result_type strfunc_from_pdf::operator()(argument_type0&& rxs, argument_type1&& pdf, argument_type2&& values, argument_type3&& order, argument_type4 absolute) const
  {
    ...
    typedef typename pythonic::assignable<decltype(std::declval<__type1>()(std::declval<__type0>()))>::type __type3;
    typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::numpy::functor::empty{})>::type>::type __type4;
    ...
    typedef typename pythonic::assignable<decltype(std::declval<__type4>()(std::declval<__type6>()))>::type __type7;
    typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::builtins::functor::range{})>::type>::type __type8;
    typedef decltype(pythonic::builtins::getattr(pythonic::types::attr::SIZE{}, std::declval<__type5>())) __type10;
    ...
    typedef typename __combined<__type7,__type13>::type __type14;
    typedef typename __combined<__type0,__type3>::type __type15;
    typedef long __type17;
    typedef decltype(pythonic::types::make_tuple(std::declval<__type12>(), std::declval<__type17>())) __type18;
    typedef decltype(std::declval<__type15>()[std::declval<__type18>()]) __type19;
    typedef decltype(pythonic::operator_::sub(std::declval<__type19>(), std::declval<__type19>())) __type24;
    ...
    typedef typename std::remove_cv<typename std::remove_reference<argument_type1>::type>::type __type27;
    typedef decltype(std::declval<__type27>()[std::declval<__type12>()]) __type29;
    typedef decltype(std::declval<__type15>()[std::declval<__type12>()]) __type32;
    typedef typename std::remove_cv<typename std::remove_reference<argument_type3>::type>::type __type33;
    typedef decltype(pythonic::builtins::pow(std::declval<__type32>(), std::declval<__type33>())) __type34;
    typedef decltype(pythonic::operator_::mul(std::declval<__type29>(), std::declval<__type34>())) __type35;
    typedef decltype(std::declval<__type26>()(std::declval<__type35>())) __type36;
    typedef decltype(pythonic::operator_::mul(std::declval<__type25>(), std::declval<__type36>())) __type37;
    typedef container<typename std::remove_reference<__type37>::type> __type38;
    typename pythonic::assignable<typename std::remove_cv<typename std::iterator_traits<typename std::remove_reference<__type11>::type::iterator>::value_type>::type>::type irx;
    typename pythonic::assignable<typename __combined<__type0,__type3>::type>::type values_ = values;
    typename pythonic::assignable<typename __combined<__type14,__type38,__type13>::type>::type S_order = pythonic::numpy::functor::empty{}(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, rxs));
    if (absolute)
    {
      values_ = pythonic::builtins::functor::abs{}(values_);
    }
    {
      long  __target140412135143936 = pythonic::builtins::getattr(pythonic::types::attr::SIZE{}, rxs);
      for (long  irx=0L; irx < __target140412135143936; irx += 1L)
      {
...
PYTHRAN_MODULE_INIT(increments)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.11",
                                      "2021-06-01 17:17:24.987135",
                                      "bcc8a21e2c95b98e36ebb91382a8e5faf04fafc035f42ede96c041d56990c478");
    if(! theDoc)
        PYTHRAN_RETURN;
