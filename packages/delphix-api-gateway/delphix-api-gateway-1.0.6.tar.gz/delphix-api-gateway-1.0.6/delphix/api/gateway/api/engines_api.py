    ...
    def __init__(self, api_client=None):
        ...
        def __get_engine_by_id(
            ...
            **kwargs
            ...
            >>> thread = api.get_engine_by_id(engine_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_engine_by_id = _Endpoint(
            settings={
                'response_type': (Engine,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/engines/{engineId}',
                'operation_id': 'get_engine_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_engines = _Endpoint(
            settings={
                'response_type': (ListEnginesResponse,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/engines',
