...
class MediaControlViewModel(ViewModelBase):
    ...
    def _onUiEvent(self, uiEvent: UiEvent) -> None:
        ...
        self._updateVideoPosition(position=self._mediaState.adjustedPosition, duration=self._mediaState.duration)
    ...
    def _signalVideoPositionUpdate(self) -> None:
        if self._mediaState.playerState == CastPlayerState.Playing:
            self._updateVideoPosition(
                position=self._mediaState.adjustedPosition,
    ...
    def _signalClickedStop(self) -> None:
        self.services.castController.stop()  # TODO: Make it possible to replay movie!
    ...
    def _signalClickedMuteRemote(self) -> None:
        self.services.castController.setMute(not self._mediaState.volumeMuted)
