...
class AnalysisJob(object):
    ...
    def __init__(self, id=None, analysis_id=None, type=None, project_id=None, execution_id=None, status=None, statuses=None, outputs=None, model_batch_jobs=None, process_jobs=None, feature_sub_categories=None, config=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
