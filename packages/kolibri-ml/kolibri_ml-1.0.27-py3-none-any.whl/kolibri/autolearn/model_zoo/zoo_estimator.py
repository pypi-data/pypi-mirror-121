...
#        self.models=[self.load_model_from_parameters(get_model(classifier))[1] for classifier in selected_models if get_model(classifier) is not None]
        self.X_sampled=None
        self.y_sampled=None
...
#            elif self.get_parameter('evaluate-performance'):
        ...
        print(print(tabulate(scores, headers='keys', tablefmt='psql'))
)
