...
def catagorize_xml(
    ...
    rule = ""
    OPERATOR_TO_BE = "PropertyIsEqualTo"
    if operator == "=":
        OPERATOR_TO_BE = "PropertyIsEqualTo"
    elif operator == ">=":
        OPERATOR_TO_BE = "PropertyIsGreaterThanOrEqualTo"
    elif operator == "<=":
        OPERATOR_TO_BE = "PropertyIsLessThanOrEqualTo"
    elif operator == "<":
        OPERATOR_TO_BE = "PropertyIsLessThan"
    elif operator == ">":
        OPERATOR_TO_BE = "PropertyIsGreaterThan"
    for value, color in zip(values, palette_hex):
        if geom_type == "point":
            ...
            """.format(
                column_name, value, color, OPERATOR_TO_BE
            )
