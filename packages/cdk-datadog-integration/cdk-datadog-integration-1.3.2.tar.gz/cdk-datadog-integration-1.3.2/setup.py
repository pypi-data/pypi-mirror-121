    ...
    """
{
    ...
    "package_data": {
        "cdk_datadog_integration._jsii": [
            "cdk-datadog-integration@1.3.2.jsii.tgz"
        ],
        "cdk_datadog_integration": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-cloudformation>=1.39.0, <2.0.0",
        "aws-cdk.aws-s3>=1.39.0, <2.0.0",
        "aws-cdk.aws-secretsmanager>=1.39.0, <2.0.0",
        "aws-cdk.core>=1.39.0, <2.0.0",
