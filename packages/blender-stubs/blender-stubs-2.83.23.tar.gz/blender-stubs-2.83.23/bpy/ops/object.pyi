...
def metaball_add(type: str = 'BALL', radius: float = 2.0, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def quadriflow_remesh(use_paint_symmetry: bool = True, use_preserve_sharp: bool = False, use_preserve_boundary: bool = False, preserve_paint_mask: bool = False, smooth_normals: bool = False, mode: str = 'FACES', target_ratio: float = 1.0, target_edge_length: float = 0.1, target_faces: int = 4000, mesh_area: float = -1, seed: int = 0) -> None:
...
def volume_add(align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
