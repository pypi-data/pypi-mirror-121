...
:func:`vertex_group_copy_to_linked`
...
def add(radius: float = 1.0, type: str = 'EMPTY', enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def add_named(linked: bool = False, name: str = '') -> None:
...
def armature_add(radius: float = 1.0, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def bake(type: str = 'COMBINED', pass_filter: typing.Set[str] = {}, filepath: str = '', width: int = 512, height: int = 512, margin: int = 16, use_selected_to_active: bool = False, cage_extrusion: float = 0.0, cage_object: str = '', normal_space: str = 'TANGENT', normal_r: str = 'POS_X', normal_g: str = 'POS_Y', normal_b: str = 'POS_Z', save_mode: str = 'INTERNAL', use_clear: bool = False, use_cage: bool = False, use_split_materials: bool = False, use_automatic_name: bool = False, uv_layer: str = '') -> None:
...
def camera_add(enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def collection_instance_add(name: str = 'Collection', collection: str = '', align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def convert(target: str = 'MESH', keep_original: bool = False) -> None:
...
def drop_named_image(filepath: str = '', relative_path: bool = True, name: str = '', align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def effector_add(type: str = 'FORCE', radius: float = 1.0, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def empty_add(type: str = 'PLAIN_AXES', radius: float = 1.0, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def gpencil_add(radius: float = 1.0, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), type: str = 'EMPTY') -> None:
...
def gpencil_modifier_apply(apply_as: str = 'DATA', modifier: str = '') -> None:
...
def gpencil_modifier_remove(modifier: str = '') -> None:
...
def light_add(type: str = 'POINT', radius: float = 1.0, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def lightprobe_add(type: str = 'CUBEMAP', radius: float = 1.0, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def make_override_library(object: str = 'DEFAULT') -> None:
...
def make_single_user(type: str = 'SELECTED_OBJECTS', object: bool = False, obdata: bool = False, material: bool = False, animation: bool = False) -> None:
...
def metaball_add(type: str = 'BALL', radius: float = 1.0, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def modifier_apply(apply_as: str = 'DATA', modifier: str = '') -> None:
...
def modifier_remove(modifier: str = '') -> None:
...
def multires_subdivide(modifier: str = '') -> None:
...
def proxy_make(object: str = 'DEFAULT') -> None:
...
def quadriflow_remesh(use_paint_symmetry: bool = True, use_preserve_sharp: bool = False, use_preserve_boundary: bool = False, use_mesh_curvature: bool = False, preserve_paint_mask: bool = False, smooth_normals: bool = False, mode: str = 'FACES', target_ratio: float = 1.0, target_edge_length: float = 0.1, target_faces: int = 4000, mesh_area: float = -1, seed: int = 0) -> None:
...
def quick_fluid(style: str = 'BASIC', initial_velocity: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), show_flows: bool = False, start_baking: bool = False) -> None:
...
def select_pattern(pattern: str = '*', case_sensitive: bool = False, extend: bool = True) -> None:
...
def select_random(percent: float = 50.0, seed: int = 0, action: str = 'SELECT') -> None:
...
def shaderfx_remove(shaderfx: str = '') -> None:
...
def speaker_add(enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def text_add(radius: float = 1.0, enter_editmode: bool = False, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def vertex_group_copy_to_linked() -> None:
...
def vertex_group_lock(action: str = 'TOGGLE') -> None:
