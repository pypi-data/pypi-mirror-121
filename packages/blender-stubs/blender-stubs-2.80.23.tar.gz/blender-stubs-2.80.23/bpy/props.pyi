...
def BoolProperty(name: str = '', description: str = '', default: typing.Any = False, options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, subtype: str = 'NONE', update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def BoolVectorProperty(name: str = '', description: str = '', default: typing.Sequence[typing.Any] = (False, False, False), options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, subtype: str = 'NONE', size: int = 3, update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def CollectionProperty(type: typing.Type = None, name: str = '', description: str = '', options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}) -> None:
...
def EnumProperty(items: typing.Sequence[typing.Tuple[str, ...]], name: str = '', description: str = '', default: typing.Union[str, typing.Set[typing.Any]] = None, options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def FloatProperty(name: str = '', description: str = '', default: typing.Any = 0.0, min: float = sys.float_info.min, max: float = sys.float_info.max, soft_min: float = sys.float_info.min, soft_max: float = sys.float_info.max, step: int = 3, precision: int = 2, options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, subtype: str = 'NONE', unit: str = 'NONE', update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def FloatVectorProperty(name: str = '', description: str = '', default: typing.Sequence[typing.Any] = (0.0, 0.0, 0.0), min: float = sys.float_info.min, max: float = sys.float_info.max, soft_min: float = sys.float_info.min, soft_max: float = sys.float_info.max, step: int = 3, precision: int = 2, options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, subtype: str = 'NONE', unit: str = 'NONE', size: int = 3, update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def IntProperty(name: str = '', description: str = '', default: typing.Any = 0, min: int = -2 ** 31, max: int = 2 ** 31 - 1, soft_min: int = -2 ** 31, soft_max: int = 2 ** 31 - 1, step: int = 1, options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, subtype: str = 'NONE', update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def IntVectorProperty(name: str = '', description: str = '', default: typing.Sequence[typing.Any] = (0, 0, 0), min: int = -2 ** 31, max: int = 2 ** 31 - 1, soft_min: int = -2 ** 31, soft_max: int = 2 ** 31 - 1, step: int = 1, options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, subtype: str = 'NONE', size: int = 3, update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
...
def PointerProperty(type: typing.Type = None, name: str = '', description: str = '', options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, poll: typing.Callable = None, update: typing.Callable = None) -> None:
...
def StringProperty(name: str = '', description: str = '', default: str = '', maxlen: int = 0, options: typing.Set[typing.Any] = {'ANIMATABLE'}, tags: typing.Set[typing.Any] = {}, subtype: str = 'NONE', update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None) -> None:
