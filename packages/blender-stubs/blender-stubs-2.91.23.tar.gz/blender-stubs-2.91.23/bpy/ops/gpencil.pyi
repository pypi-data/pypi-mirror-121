...
def bake_mesh_animation(frame_start: int = 1, frame_end: int = 250, step: int = 1, angle: float = 1.22173, thickness: int = 1, seams: bool = False, faces: bool = True, offset: float = 0.001, frame_target: int = 1, target: str = '*NEW', project_type: str = 'VIEW') -> None:
...
def mesh_bake(frame_start: int = 1, frame_end: int = 250, step: int = 1, thickness: int = 1, angle: float = 1.22173, offset: float = 0.001, seams: bool = False, faces: bool = True, target: str = '', frame_target: int = 1, project_type: str = 'KEEP') -> None:
...
def trace_image(target: Object = None, thickness: int = 10, resolution: int = 5, scale: float = 1.0, sample: float = 0.0, threshold: float = 0.5, turnpolicy: str = 'MINORITY') -> None:
...
def vertex_color_brightness_contrast(mode: str = 'STROKE', brightness: float = 0.0, contrast: float = 0.0) -> None:
...
def vertex_color_hsv(mode: str = 'STROKE', h: float = 0.5, s: float = 1.0, v: float = 1.0) -> None:
...
def vertex_color_invert(mode: str = 'STROKE') -> None:
...
def vertex_color_levels(mode: str = 'STROKE', offset: float = 0.0, gain: float = 1.0) -> None:
...
def vertex_color_set(mode: str = 'STROKE', factor: float = 1.0) -> None:
