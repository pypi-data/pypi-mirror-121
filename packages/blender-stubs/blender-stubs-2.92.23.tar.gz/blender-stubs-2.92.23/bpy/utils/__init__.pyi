...
def register_class(self, cls: typing.Type) -> None:
...
def unregister_class(self, cls: typing.Any) -> None:
...
def keyconfig_set(filepath: typing.Any, report: typing.Any = None) -> None:

  ...

def load_scripts(reload_scripts: bool = False, refresh_scripts: bool = False) -> None:
...
def preset_find(name: typing.Any, preset_path: typing.Any, display_name: typing.Any = False, ext: typing.Any = '.py') -> None:
...
def app_template_paths(subdir: str = None) -> typing.Any:
...
def register_tool(tool_cls: typing.Any) -> None:
...
def script_paths(subdir: str = None, user_pref: bool = True, check_all: bool = False, use_user: typing.Any = True) -> typing.List[typing.Any]:
...
def smpte_from_frame(frame: typing.Union[int, float], fps: typing.Any = None, fps_base: typing.Any = None) -> str:
...
def smpte_from_seconds(time: int, fps: typing.Any = None, fps_base: typing.Any = None) -> str:
...
def user_resource(resource_type: typing.Any, path: typing.Any = '', create: bool = False) -> str:
...
def execfile(filepath: typing.Any, mod: typing.Any = None) -> None:
