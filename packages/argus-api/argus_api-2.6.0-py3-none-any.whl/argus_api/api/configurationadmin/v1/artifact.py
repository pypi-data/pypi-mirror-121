...
def create_artifact(
    ...
    :param str groupID: \[a\-zA\-Z0\-9\_\\\-\\.\]\*
    :param str artifactID: \[a\-zA\-Z0\-9\_\\\-\\.\]\*
    :param str version: \[a\-zA\-Z0\-9\_\\\-\\.\]\*
    :param str data: 
...
#: **DEPRECATED** : ``download_by_g_a_v`` is an alias for ``download_code_artifact_by_g_a_v``. Exists
#: only for backward compatibility - **do not use** - use ``download_code_artifact_by_g_a_v`` instead.
...
#: **DEPRECATED** : ``get_by_g_a_v`` is an alias for ``get_code_artifact_by_g_a_v``. Exists
#: only for backward compatibility - **do not use** - use ``get_code_artifact_by_g_a_v`` instead.
