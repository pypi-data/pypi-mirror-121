...
def add_alarm_mitre_relationship(
    ...
    :param str mitreCategory: ID\, external ID or short name of the MITRE category \(external ID and short name require setting additional attributes\: categoryModel\, categoryVersion\) 
    :param str categoryModel: Which threat model to use with external ID or short name of the MITRE category 
    :param str categoryVersion: Which version to use with external ID or short name of the MITRE category 
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def delete_alarm_mitre_relationship(
    ...
    :param str idOrExtIdOrShortName: ID\, external ID or short name of the MITRE category \(external ID and short name require additional query parameters\: categoryModel\, categoryVersion\)
    :param str categoryModel: Which threat model to use with external ID or short name of the MITRE category
    :param str categoryVersion: Which version to use with external ID or short name of the MITRE category
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
