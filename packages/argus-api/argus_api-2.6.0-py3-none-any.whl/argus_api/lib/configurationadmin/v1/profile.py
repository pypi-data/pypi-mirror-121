...
#: **DEPRECATED** : ``detach_by_artifact_by_g_a`` is an alias for ``detach_artifact_by_g_a``. Exists
#: only for backward compatibility - **do not use** - use ``detach_artifact_by_g_a`` instead.
