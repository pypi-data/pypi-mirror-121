...
#: **DEPRECATED** : ``list_document_watchers_2`` is an alias for ``list_document_watchers_by_path_1``. Exists
#: only for backward compatibility - **do not use** - use ``list_document_watchers_by_path_1`` instead.
list_document_watchers_2 = deprecated_alias("list_document_watchers_2")(list_document_watchers_by_path_1)
#: **DEPRECATED** : ``list_document_watchers_1`` is an alias for ``list_folder_watchers_by_path``. Exists
#: only for backward compatibility - **do not use** - use ``list_folder_watchers_by_path`` instead.
