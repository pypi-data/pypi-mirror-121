...
es_marker_standard = {
    ...
    'CD3','CD4','CD8','CD11b','CD11c','CD20','CD31','CD44','CD45','CD45RA','CD45RO','CD66b','CD68','CD74','CD90','CD103','CD123','CD134','CD162', 'CD209', 'CD271',
    'CGA',
    'CK5','CK5-6','CK7','CK8','CK14','CK17','CK18','CK19','CK-HMW',
    'CNN1','CTNNB1','ColI','ColIV','ColVI','CoxIV',
    'cPARP',
    'CSF1R',
    'DAPI-1','DAPI0','DAPI1','DAPI2','DAPI3','DAPI4','DAPI5','DAPI5Q','DAPI6','DAPI6Q','DAPI7','DAPI7Q','DAPI8','DAPI9','DAPI10','DAPI11','DAPI12','DAPI24',
    'DES',
    'Ecad','EGFR','ELN','EpCAM','ER','EZH2',
    'F4-80','FN1','FoxP3',
    'Gal3','GATA3','GATA6','gH2AX','Glut1','GRNZB',
    'H3K4','H3K27','HER2','HIF1a','HLA-DR','HLA-DR-DP-DQ','HMB45',
    'Ki67',
    'LAG3','LamAC','LamB1','LamB2','LYVE1',
    'MelanA','MHCII','MSH2','MSH6','MUC1','Myosin',
    'NFkB',
    'PCNA','PD1','PDGFRa','PDL1','PDL1ab','PDL1d','PDPN','PgR','PgRc4',
    'p53','p63','pAKT','pERK','pHH3','pMYC','pRB','pRPA','pS62MYC','pS6RP','panCK',
