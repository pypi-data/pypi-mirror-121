...
def load_exposure_df(
    ...
    df_exposure = df_load.loc[:, df_load.columns.isin(config.d_nconv['ls_color_order_axio'])]
    ...
    df_img = df_load.loc[:, ~df_load.columns.isin(config.d_nconv['ls_color_order_axio'])]
