...
class Box(Component):
    ...
    """
    children = Aspect(children=True, docstring="Elements to display.")
    clicks = Aspect(docstring="Number of times the box was clicked on.")
    column = Aspect(docstring="Display the children element in a column.Equals to css: flex-direction: column;")  # noqa: E501
    reverse = Aspect(docstring="Reverse the element order.")
    justify = Aspect(docstring="Shorthand for justify-content. Alignment for main axis. (Possible values: 'flex-start', 'flex-end', 'center', 'space-between', 'space-around', 'space-evenly')")  # noqa: E501
    align_items = Aspect(docstring="Flex property to align line items on the cross axis. (Possible values: 'flex-start', 'flex-end', 'center', 'stretch', 'baseline')")  # noqa: E501
    align_content = Aspect(docstring="Alignment across the cross axis. (Possible values: 'flex-start', 'flex-end', 'center', 'space-between', 'space-around', 'space-evenly', 'stretch')")  # noqa: E501
    wrap = Aspect(docstring="Flex wrap items onto the next line. (Possible values: 'nowrap', 'wrap', 'wrap-reverse')")  # noqa: E501
    ...
    def __init__(
            ...
            column: typing.Optional[bool] = UNDEFINED,
            reverse: typing.Optional[bool] = UNDEFINED,
            justify: typing.Optional[typing.Any] = UNDEFINED,
            align_items: typing.Optional[typing.Any] = UNDEFINED,
            align_content: typing.Optional[typing.Any] = UNDEFINED,
            wrap: typing.Optional[typing.Any] = UNDEFINED,
        ...
        """
        :param children: Elements to display.
        :param clicks: Number of times the box was clicked on.
        :param column: Display the children element in a column. Equals to
            css: flex-direction: column;
        :param reverse: Reverse the element order.
        :param justify: Shorthand for justify-content. Alignment for main
            axis. (Possible values: 'flex-start', 'flex-end', 'center', 'space-
            between', 'space-around', 'space-evenly')
        :param align_items: Flex property to align line items on the cross
            axis. (Possible values: 'flex-start', 'flex-end', 'center',
            'stretch', 'baseline')
        :param align_content: Alignment across the cross axis. (Possible
            values: 'flex-start', 'flex-end', 'center', 'space-between',
            'space-around', 'space-evenly', 'stretch')
        :param wrap: Flex wrap items onto the next line. (Possible values:
