...
class Menu(Component):
    ...
    """
    items = Aspect(required=True)
    active = Aspect()
    button = Aspect()
    value = Aspect()
    button_component = Aspect(children=True)
    ...
    def __init__(
            self,
            items: typing.Union[typing.List[str]],
            active: typing.Optional[bool] = UNDEFINED,
            button: typing.Optional[bool] = UNDEFINED,
            value: typing.Optional[str] = UNDEFINED,
            button_component: typing.Optional[typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]] = UNDEFINED,  # noqa: E501
