...
class Panel(Component):
    ...
    """
    title = Aspect(children=True, docstring="Title of the panel.")
    content = Aspect(children=True, docstring="Content of the panel under the title")  # noqa: E501
    expandable = Aspect(docstring="Allow to expand/hide content with a button on the right side of thetitle that controls the expanded aspect.")  # noqa: E501
    expanded = Aspect(docstring="Is the panel currently expanded?")
    expanded_symbol = Aspect(default=UNDEFINED, children=True, docstring="Symbol to use as expand toggle when it is expanded.")  # noqa: E501
    expandable_symbol = Aspect(default=UNDEFINED, children=True, docstring="Symbol to use for the toggle symbol when panel content is hidden.")  # noqa: E501
    title_style = Aspect(docstring="Style of the title.")
    title_class_name = Aspect(docstring="Class name to give to the title along with ``panel-title``.")  # noqa: E501
    content_style = Aspect(docstring="Style of the content container.")
    content_class_name = Aspect(docstring="Class name for the content container.")  # noqa: E501
    ...
    def __init__(
            self,
            title: typing.Optional[typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]] = UNDEFINED,  # noqa: E501
            ...
            expandable: typing.Optional[bool] = UNDEFINED,
            expanded: typing.Optional[bool] = UNDEFINED,
            expanded_symbol: typing.Optional[typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]] = UNDEFINED,  # noqa: E501
            expandable_symbol: typing.Optional[typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]] = UNDEFINED,  # noqa: E501
            title_style: typing.Optional[typing.Dict] = UNDEFINED,
            title_class_name: typing.Optional[str] = UNDEFINED,
            content_style: typing.Optional[typing.Dict] = UNDEFINED,
            content_class_name: typing.Optional[str] = UNDEFINED,
        ...
        :param content: Content of the panel under the title
        :param expandable: Allow to expand/hide content with a button on
            the right side of the title that controls the expanded aspect.
        :param expanded: Is the panel currently expanded?
        :param expanded_symbol: Symbol to use as expand toggle when it is
            expanded.
        :param expandable_symbol: Symbol to use for the toggle symbol when
            panel content is hidden.
        :param title_style: Style of the title.
        :param title_class_name: Class name to give to the title along with
            ``panel-title``.
        :param content_style: Style of the content container.
        :param content_class_name: Class name for the content container.
