...
class Grid(Component):
    ...
    grow_cell = Aspect(docstring="Set the cell to take up the space between them.")  # noqa: E501
    equal_cell_width = Aspect(docstring="Each cell are equals in width for a total of 100% per row.")  # noqa: E501
    ...
    def __init__(
            ...
            grow_cell: typing.Optional[bool] = UNDEFINED,
            equal_cell_width: typing.Optional[bool] = UNDEFINED,
        ...
        :param grow_cell: Set the cell to take up the space between them.
        :param equal_cell_width: Each cell are equals in width for a total
            of 100% per row.
