...
def detail_string_toDatetime(string: str) -> datetime:
    """
    把字符串转成datetime 精确到秒
    :param string: '2020-01-01'
    :return:
...
def string_totime_detail(str_p):
    """时间字符串转换成时间类型"""
    """2019-01-30 15:29:08"""
...
def substract_Time_detail(dateStr1: str, dateStr2: str) -> datetime:
    """
        返回两个日期之间的差
    ...
    """
    str1 = string_totime_detail(dateStr1)
    str2 = string_totime_detail(dateStr2)
...
def dateTime_Add(dateStr: str, days=0, hours=0, minutes=0) -> datetime:
    ...
    """
    date1 = detail_string_toDatetime(dateStr)
    return date1 + datetime.timedelta(days=days, hours=hours, minutes=minutes)

def dateTime_Subtraction(dateStr: str, days=0, hours=0, minutes=0) -> datetime:
    """
...
if __name__ == '__main__':
    ...
    # print(getdate(1))
    print(dateTime_Subtraction('2021-05-01 09:00:00', hours=3))
