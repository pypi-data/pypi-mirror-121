...
"""
    ...
    def adjust_coding(new_low, new_high, keep_actuals=True):
        """Changes the mapping of the actual low and high to the coded low and high.

        If `keep_actuals` is True, the actual observed values are preserved and the internal
        coded values are adjusted. Otherwise, the internal coded values are preserved, and
        the actual observed values are adjusted accordingly. """
