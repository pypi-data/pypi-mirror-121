...
from Quanlse.Scheduler.Ion.DefaultPulseGenerator import defaultPulseGenerator
...
class SchedulerIon(Scheduler):
    ...
    """
    def __init__(self, dt: float = None, pulseGenerator: SchedulerPulseGenerator = None,
        ...
        # Initialization
        super().__init__(dt=dt, pulseGenerator=pulseGenerator, subSysNum=subSysNum, sysLevel=sysLevel)
