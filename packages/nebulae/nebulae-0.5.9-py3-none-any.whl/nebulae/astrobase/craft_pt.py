...
class SN(Craft):
    def __init__(self, craft, niters=3, eps=1e-12, scope='SN'):
        ...
        self.niters = niters
        self.eps = eps
        assert not hasattr(self.hull, self.name + "_u")
        self._register()
...
class OHEM(Craft):
    def __init__(self, loss_fn, he_ratio=0.005, np_ratio=3., thr=0.01, chnl_wise=True, scope='OHEM'):
