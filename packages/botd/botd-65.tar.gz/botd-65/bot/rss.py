...
from .run import Bus, Repeater, Runtime, Table, launch, find
from .obj import Cfg, Db, Default, Object, edit, fmt, get, last, save, update
...
def dpl(event):
    ...
    name = event.prs.args[0]
    names = get(Table.names, "rss", ["rss",])
