...
class PipelineWeakModels:
    ...
    def predict_labels(self, sentence: str,  tags: str) -> tp.Tuple[str, str]:
        """
        ...
        for step in self.pipeline:
            if isinstance(step, self.__valid_labeling_steps):
                sentence, labels = step.label_entities(tags, sentence)
            elif isinstance(step, self.__valid_correction_steps):
                sentence, labels = step.correct_tags(sentence, labels)
