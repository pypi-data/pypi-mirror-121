...
class ModelPackage(APIObject):
    ...
    @classmethod
    def create(cls, model_id=None, name=None, prediction_threshold=None):
    ...
    def list(cls):
        ...
        return [
            ...
            for x in unpaginate(initial_url=cls._list_url, initial_params=None, client=cls._client,)
        ]
