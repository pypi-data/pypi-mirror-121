...
class EntityServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AssociateAnonymousEntity = channel.unary_unary(
                '/calixa.domain.entity.EntityService/AssociateAnonymousEntity',
                request_serializer=entity__pb2.AssociatedAnonymousEntity.SerializeToString,
                response_deserializer=entity__pb2.AssociateAnonymousEntityResponse.FromString,
                )
        self.GetCustomEntityDefinitions = channel.unary_stream(
                '/calixa.domain.entity.EntityService/GetCustomEntityDefinitions',
                request_serializer=entity__pb2.GetCustomEntityDefinitionsRequest.SerializeToString,
                response_deserializer=entity__pb2.Entity.FromString,
                )
...
class EntityServiceServicer(object):
    ...
    def AddExternalAccountUserForExternalAccount(self, request, context):
        """Used by the Segment App to incrementally add ApiUsers to ApiAccounts. These
        method names are unfortunate, but they only operate on ApiUser
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def AssociateAnonymousEntity(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EntityServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AssociateAnonymousEntity': grpc.unary_unary_rpc_method_handler(
                    servicer.AssociateAnonymousEntity,
                    request_deserializer=entity__pb2.AssociatedAnonymousEntity.FromString,
                    response_serializer=entity__pb2.AssociateAnonymousEntityResponse.SerializeToString,
            ),
            'GetCustomEntityDefinitions': grpc.unary_stream_rpc_method_handler(
                    servicer.GetCustomEntityDefinitions,
                    request_deserializer=entity__pb2.GetCustomEntityDefinitionsRequest.FromString,
                    response_serializer=entity__pb2.Entity.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class EntityService(object):
    ...
    @staticmethod
    def AssociateAnonymousEntity(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.entity.EntityService/AssociateAnonymousEntity',
            entity__pb2.AssociatedAnonymousEntity.SerializeToString,
            entity__pb2.AssociateAnonymousEntityResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetCustomEntityDefinitions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.entity.EntityService/GetCustomEntityDefinitions',
            entity__pb2.GetCustomEntityDefinitionsRequest.SerializeToString,
            entity__pb2.Entity.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
