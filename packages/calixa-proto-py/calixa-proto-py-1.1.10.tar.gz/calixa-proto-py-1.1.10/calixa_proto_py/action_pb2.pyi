...
class CadenceAddPersonParams(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"cadence_id",b"cadence_id",u"person_id",b"person_id"]) -> None: ...
