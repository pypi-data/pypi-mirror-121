...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 cat /home/ntolley/Jones_Lab/hnn-core/hnn_core/mod/x86_64/cat.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ntolley/Jones_Lab/hnn-core/hnn_core/mod/cat.mod";
static const char* nmodl_file_text = 
