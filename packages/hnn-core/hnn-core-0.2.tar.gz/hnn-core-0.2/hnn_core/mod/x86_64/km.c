...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 km /home/ntolley/Jones_Lab/hnn-core/hnn_core/mod/x86_64/km.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ntolley/Jones_Lab/hnn-core/hnn_core/mod/km.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
