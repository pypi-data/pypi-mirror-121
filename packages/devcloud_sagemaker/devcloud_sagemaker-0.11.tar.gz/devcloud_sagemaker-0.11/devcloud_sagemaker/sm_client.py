...
if __name__ == "__main__":
    ...
    #print(files)
    make_tar("yolov5")
    create_training_job("datasets_simple", "yolov5.tar", "yolov5s.pt", {"instance_type":"ml.m5.xlarge", "instance_count":"1", "framework_version":"1.8.1", "hyperparameters":{"imgsz":"64", "epochs":"4"}})
    #make_tar("train.py")
