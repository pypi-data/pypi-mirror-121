def dummy_code(df, dv=None, columns='all', categorical=True, numeric=True, categorical_max_levels = 20, numeric_max_levels = 10, dummy_na=False):
    ...
    if columns =='all':
        ...
        var_list = columns
        print('Will examine the following variables as candidates for dummy coding: {var_list}')
...
def dummy_top(df=None, dv=None, columns = 'all', min_threshold = 0.05, drop_categorial=True, verbose=True):
