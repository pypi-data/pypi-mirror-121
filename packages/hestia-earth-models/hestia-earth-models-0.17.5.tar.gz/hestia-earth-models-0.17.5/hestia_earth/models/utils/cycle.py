...
def land_occupation_per_kg(cycle: dict, site: dict, primary_product: dict):
    """
    ...
    logger.debug('cycleDuration=%s, fallowCorrection=%s, land occupation/kg=%s', cycleDuration, fallowCorrection, value)
    return value
