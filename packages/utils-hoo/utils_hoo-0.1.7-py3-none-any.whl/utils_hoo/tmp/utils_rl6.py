...
if __name__ == '__main__':
    ...
    # plt.plot(rewards)
    # plt.show()
    # print(f'Mean rewards of SARSA {N} rounds: {np.mean(rewards)}.')
    # plt.figure(figsize=(12, 7))
    ...
    # plt.plot(rewards_)
    # plt.show()
    # print(f'Mean rewards of trained agent: {np.mean(rewards_)}.')
    ...
    # plt.plot(rewards)
    # plt.show()
    # print(f'Mean rewards of Exceptd-SARSA {N} rounds: {np.mean(rewards)}.')
    # plt.figure(figsize=(12, 7))
    # plt.plot(rewards[-200:])
    # plt.show()
    # # 使用学习好的agent
    ...
    # plt.plot(rewards)
    # plt.show()
    # print(f'Mean rewards of QLearning {N} rounds: {np.mean(rewards)}.')
    # plt.figure(figsize=(12, 7))
    # plt.plot(rewards[-200:])
    # plt.show()
    # # 使用学习好的agent
    ...
    # plt.plot(rewards)
    # plt.show()
    # print(f'Mean rewards of DoubleQLearning {N} rounds: {np.mean(rewards)}.')
    # plt.figure(figsize=(12, 7))
    # plt.plot(rewards[-200:])
    # plt.show()
    # # 使用学习好的agent
    ...
    plt.plot(rewards)
    plt.show()
    print(f'Mean rewards of SARSALambda {N} rounds: {np.mean(rewards)}.')
    plt.figure(figsize=(12, 7))
    plt.plot(rewards[-200:])
    plt.show()
    # 使用学习好的agent
