...
if __name__ == '__main__':
    ...
    if not os.path.exists(f'gains{N}.csv'):
        gains = []
    ...
    plot_Series(gains_pd, {'gain_rate': ('.-b', False)},
                ...
                nXticks=49, markersize=15, grids=False, figsize=(11, 7))
