...
def FindAddends_BackPack01Float(tgt_sum, alts):
    '''
    ...
    addends: 和为max_v的备选数列表
    trace: 与addends对应的备选加数索引
    values: 备选数之和跳跃点记录
    '''
...
if __name__ == '__main__':
    ...
    max_v, addends, trace, values = FindAddends_BackPack01Float(tgt_sum, alts)
    print('目标和:', tgt_sum)
    print('备选加数和:', max_v)
    print('备选加数编号:', trace)
    print('备选加数:', addends)
