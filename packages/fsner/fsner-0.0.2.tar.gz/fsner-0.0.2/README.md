...
You can use the FSNER model in three ways:

1. Install using pip: `pip install fsner`

    or

2. Install as a package: `python setup.py install` and import the model as shown in the code example below

    or

3. Change directory to `src` and import the model as shown in the code example below
