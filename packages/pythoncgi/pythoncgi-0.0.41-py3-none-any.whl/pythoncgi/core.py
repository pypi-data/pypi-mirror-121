...
from omnitools import dt2yyyymmddhhmmss, HeadersDict, ApacheHeadersDict, str2html, encodeURIComponent, dt2rfc822gmt, rfc822gmt2dt
...
arguments = FieldStorage(environ=_SERVER)
...
def _generate_response():
    ...
    if not __response.pop("cache") and status_code >= 500 and status_code <= 599:
...
def generate_range_headers(fp, disposition: str = "inline"):
    ...
    set_header("Content-Type", mimetypes.guess_type(filename) or "application/octet-stream")
