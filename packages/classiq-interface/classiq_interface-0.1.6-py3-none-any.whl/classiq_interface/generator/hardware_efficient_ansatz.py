...
AnsatzOutputs = function_params.DefaultOutputNames
AnsatzInputs = function_params.DefaultInputNames


class HardwareEfficientAnsatz(function_params.FunctionParams):
    num_qubits: pydantic.conint(ge=1) = pydantic.Field(
    ...
    depth: pydantic.conint(ge=1) = pydantic.Field(
    ...
    _input_names: Type[Enum] = pydantic.PrivateAttr(default=AnsatzInputs)
    _output_names: Type[Enum] = pydantic.PrivateAttr(default=AnsatzOutputs)
