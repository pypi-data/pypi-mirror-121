...
class Yeti:
    ...
    async def post_state(self, payload: dict[str, int]) -> None:
    ...
    async def post_loglevel(self, payload: dict[str, int]) -> None:
        """Post log level Goal Zero Yeti instance."""
        self.endpoint = "/loglevel"
        self.payload = payload
        await Yeti.send_post(self)

    async def join(self, payload: dict) -> None:
    ...
    async def password_set(self, payload: str) -> None:
