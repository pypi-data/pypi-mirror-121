...
class IPCR96x48Balanced(H5Dataset):
    """ 
    Data and further information can be found at TODO
    """

    def __init__(self, root: str, sub_set: str, transform: Optional[Callable] = None):
    ...
    @classmethod
    def from_avocado(cls, sub_set: str = 'train', transform: Optional[Callable] = None):
        return cls('/data/ldap/histopathologic/processed/mitosis_icpr/', sub_set, transform)


class IPCR96x48Unbalanced(H5Dataset):
    """ 
    Data and further information can be found at TODO
    """
...
class IPCR96x96Balanced(H5Dataset):
    """ 
    Data and further information can be found at TODO
    """
...
class IPCR96x96Unbalanced(H5Dataset):
    """ 
    Data and further information can be found at TODO
    """
