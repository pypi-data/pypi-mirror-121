...
class Midog96x96(H5Dataset):
    ...
    def from_avocado(cls, sub_set: str = 'train', transform: Optional[Callable] = None):
        return cls('/data/ldap/histopathologic/processed_read_only/MIDOG_H5/96x96', sub_set, transform)
...
class Midog224x224(H5Dataset):
    ...
    @classmethod
    def from_avocado(cls, sub_set: str = 'train', transform: Optional[Callable] = None):
        return cls('//data/ldap/histopathologic/processed_read_only/MIDOG_H5/224x224', sub_set, transform)
