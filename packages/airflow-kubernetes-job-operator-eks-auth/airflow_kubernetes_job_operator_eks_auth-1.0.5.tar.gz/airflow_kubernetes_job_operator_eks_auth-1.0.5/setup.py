...
setup(
    name="airflow_kubernetes_job_operator_eks_auth",
    version="1.0.5",
    ...
    long_description="This is a fork from @ https://github.com/LamaAni/KubernetesJobOperator",
    classifiers=[],
    author="Victor Dubé",
    author_email="",
    url="https://github.com/duferdev/KubernetesJobOperator",
