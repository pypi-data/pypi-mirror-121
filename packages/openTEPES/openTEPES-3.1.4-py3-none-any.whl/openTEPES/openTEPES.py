...
def openTEPES_run(DirName, CaseName, SolverName):
    ...
    #%% model declaration
    mTEPES = ConcreteModel('Open Generation and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 3.1.4 - September 30, 2021')
