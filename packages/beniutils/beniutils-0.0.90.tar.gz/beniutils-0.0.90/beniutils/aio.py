...
async def asyncHttpGet(url: str, headers=None, timeout: int = 30, retry: int = 3):
    initAioHttp()
...
async def asyncHttpPost(url: str, data=None, headers=None, timeout: int = 30, retry: int = 3):
    initAioHttp()
    global _currentAsyncHttpNum
