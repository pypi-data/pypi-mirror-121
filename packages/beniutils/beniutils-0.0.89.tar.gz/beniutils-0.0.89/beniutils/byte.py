...
class BytesWriter():
    ...
    def writeShort(self, value):
        self.write("h", getLimitedValue(value, -32768, 32767))             # int16
        return self

    def writeUShort(self, value):
        self.write("H", getLimitedValue(value, 0, 65535))  # int16
        return self

    def writeInt(self, value):
        self.write("i", getLimitedValue(value, -2147483648, 2147483647))  # int32
        return self

    def writeUInt(self, value):
        self.write("I", getLimitedValue(value, 0, 4294967295))  # int32
        return self

    def writeLong(self, value):
        self.write("q", getLimitedValue(value, -9223372036854775808, 9223372036854775807))  # int64
        return self

    def writeULong(self, value):
        self.write("Q", getLimitedValue(value, 0, 18446744073709551615))  # int64
        return self
