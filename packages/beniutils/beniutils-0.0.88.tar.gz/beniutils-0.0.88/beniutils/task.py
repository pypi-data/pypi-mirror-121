...
def initTask(exeWorkspace, devWorkspace, devTaskList):
...
def getPathByWorkspace(*parList) -> str:
    return getPath(_workspacePath, *parList)


def runTask(moduleName, **parDict):
