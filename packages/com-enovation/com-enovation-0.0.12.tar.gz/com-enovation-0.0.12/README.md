...
Let’s say that “Predictabilty” is about accurately predicting early enough the project outcomes (incl. beyond our own R&R), to enable timely corrective actions that increase the likelihood of achieving targets and reducing outcome variance.
...
| `graph_predictability_into_dash` | To visualize the outputs from the command `compute_date_predictability` into a graph powered by [dash](https://dash.plotly.com) |
