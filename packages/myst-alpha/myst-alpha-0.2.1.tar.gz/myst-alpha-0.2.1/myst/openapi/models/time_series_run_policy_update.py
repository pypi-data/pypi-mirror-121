...
class TimeSeriesRunPolicyUpdate(base_model.BaseModel):
    """Schema for time series run policy update requests."""

    object_: Optional[Literal["Policy"]] = Field(..., alias="object")
    uuid: Optional[str] = None
    create_time: Optional[str] = None
    update_time: Optional[str] = None
    type: Optional[Literal["TimeSeriesRunPolicy"]] = None
    creator: Optional[str] = None
    schedule_timing: Optional[Union[AbsoluteTimingCreate, RelativeTimingCreate]] = None
