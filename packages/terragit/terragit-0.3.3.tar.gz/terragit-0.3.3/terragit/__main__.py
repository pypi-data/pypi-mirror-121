...
def main():
    ...
    if sys.argv[1] =="clone":
        ...
        parser.add_argument("-p", "--project_id",  dest = "project_id",default = None, help="id of project")
        parser.add_argument("-path", "--path",  dest = "path",default = "./", help="path in which the project will be cloned")

        parser.add_argument(sys.argv[1])
        args = parser.parse_args()

        clonn =clone.Clone(args.gitlab_token ,args.gitlab_url, args.path)
