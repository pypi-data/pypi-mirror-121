...
from langma.embeddings import BareEmbedding
from langma.embeddings.abc_embedding import ABCEmbedding
from langma.generators import CorpusGenerator, Seq2SeqDataSet
from langma.logger import logger
from langma.processors import SequenceProcessor
from langma.tasks.seq2seq.decoder import AttGRUDecoder
from langma.tasks.seq2seq.encoder import GRUEncoder
...
if __name__ == "__main__":
    from langma.corpus import ChineseDailyNerCorpus
    import logging
