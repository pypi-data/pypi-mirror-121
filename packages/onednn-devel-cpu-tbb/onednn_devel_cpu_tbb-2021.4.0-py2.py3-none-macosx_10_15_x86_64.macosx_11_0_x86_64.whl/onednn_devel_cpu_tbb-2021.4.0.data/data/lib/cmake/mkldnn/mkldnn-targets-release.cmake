...
set_target_properties(MKLDNN::mkldnn PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmkldnn.2.4.dylib"
  IMPORTED_SONAME_RELEASE "libmkldnn.2.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS MKLDNN::mkldnn )
list(APPEND _IMPORT_CHECK_FILES_FOR_MKLDNN::mkldnn "${_IMPORT_PREFIX}/lib/libmkldnn.2.4.dylib" )
