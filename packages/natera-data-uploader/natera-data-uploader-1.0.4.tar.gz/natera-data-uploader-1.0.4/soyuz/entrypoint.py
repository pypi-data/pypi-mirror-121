    ...
    try:
        ...
        if params.get_action() in [Parameters.UPLOAD_ACTION, Parameters.WATCH_ACTION]:
            ...
            if params.get_action() == Parameters.UPLOAD_ACTION:
                ...
                if params.get_upload_type() == Parameters.PERSONALIS_UPLOAD:
                    uploader = PersonalisDxUploader(dx_context, settings.get_base_dir())
                ...
                uploader.ua_parameters = settings.get_ua_parameters()
                uploader.process_count = settings.get_process_count()
