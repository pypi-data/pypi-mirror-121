...
class Settings:
    ...
    DEFAULT_OPEN_PORTS: List[int] = [6443, 30080]
    ...
    DEPLOY_SAMPLE_PLAYBOOK_NAME: str = "deploy_sample.yml"
    ...
    DEPLOY_SAMPLE_PLAYBOOK_PATH: Path = ANSIBLE_TEMPLATE_DIR_PATH / DEPLOY_SAMPLE_PLAYBOOK_NAME
