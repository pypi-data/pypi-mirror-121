from django_webpack_dev_server.management.template_constants.production.reactjs_constants import PROD_REACTJS_TEMPLATE_FILES

from django_webpack_dev_server.management.template_constants.production.reactts_constants import PROD_REACTTS_TEMPLATE_FILES
...
COMMON_TEMPLATE_FILES = [
    (APP_DIRECTORY_NAME, 'urls.py',
     COMMON_TEMPLATES_URLS_DICT['urls.py-tpl']),

    (APP_DIRECTORY_NAME, 'views.py',
     COMMON_TEMPLATES_URLS_DICT['views.py-tpl']),

    (SRC_DIRECTORY_NAME, 'djangologo.png',
     COMMON_TEMPLATES_URLS_DICT['djangologo.png']),

    (TEMPLATES_DIRECTORY_NAME, 'index.html',
