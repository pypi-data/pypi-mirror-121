...
DEV_REACTJS_TEMPLATES_PATHS_DICT = {
    'package.json-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTJS, 'package.json-tpl'),
    'webpack.config.js-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTJS, 'webpack.config.js-tpl'),
    'babel.config.json-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTJS, 'babel.config.json-tpl'),
    'App.js-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTJS, 'App.js-tpl'),
    'index.js-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTJS, 'index.js-tpl'),
    'App.css-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTJS, 'App.css-tpl'),
    'reactlogo.png': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTJS, 'reactlogo.png')
}
...
DEV_REACTJS_TEMPLATE_FILES = [
    ...
    (SRC_DIRECTORY_NAME, 'App.js',
     DEV_REACTJS_TEMPLATES_PATHS_DICT['App.js-tpl']),

    (SRC_DIRECTORY_NAME, 'index.js',
     DEV_REACTJS_TEMPLATES_PATHS_DICT['index.js-tpl']),

    (SRC_DIRECTORY_NAME, 'App.css',
     DEV_REACTJS_TEMPLATES_PATHS_DICT['App.css-tpl']),
