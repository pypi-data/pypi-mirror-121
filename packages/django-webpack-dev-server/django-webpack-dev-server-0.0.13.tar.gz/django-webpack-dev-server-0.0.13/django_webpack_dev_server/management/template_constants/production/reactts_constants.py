...
PROD_REACTTS_TEMPLATE_FILES = [
    ...
    (SRC_DIRECTORY_NAME, 'App.tsx',
     REACTTS_TEMPLATES_URLS_DICT['App.tsx-tpl']),

    (SRC_DIRECTORY_NAME, 'index.tsx',
     REACTTS_TEMPLATES_URLS_DICT['index.tsx-tpl']),

    (SRC_DIRECTORY_NAME, 'App.css',
     REACTTS_TEMPLATES_URLS_DICT['App.css-tpl']),

    (SRC_DIRECTORY_NAME, 'reactlogo.png',
     REACTTS_TEMPLATES_URLS_DICT['reactlogo.png']),
]
