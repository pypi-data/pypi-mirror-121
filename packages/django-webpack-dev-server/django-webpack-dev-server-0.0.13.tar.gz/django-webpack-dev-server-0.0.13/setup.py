...
package_description = 'A Django app to create configuration files for frontend libraries.'
...
setup(
    ...
    download_url='https://github.com/Jitensid/django-webpack-dev-server/archive/refs/tags/0.0.13.tar.gz',
