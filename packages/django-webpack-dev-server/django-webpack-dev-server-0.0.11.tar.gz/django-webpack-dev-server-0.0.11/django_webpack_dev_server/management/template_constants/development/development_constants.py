...
DEV_COMMON_TEMPLATES_PATHS_DICT = {
    'urls.py-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, COMMON_ASSETS_DIRECTORY, 'urls.py-tpl'),
    'views.py-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, COMMON_ASSETS_DIRECTORY, 'views.py-tpl'),
    'index.html-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, COMMON_ASSETS_DIRECTORY, 'index.html-tpl'),
    'djangologo.png': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, COMMON_ASSETS_DIRECTORY, 'djangologo.png')
}

# Development template files which are common for any frontend library or framework
DEV_COMMON_TEMPLATE_FILES = [
    (APP_DIRECTORY_NAME, 'urls.py', os.path.join(
        DEVELOPMENT_ASSETS_DIRECTORY_PATH, COMMON_ASSETS_DIRECTORY, 'urls.py-tpl')),

    (APP_DIRECTORY_NAME, 'views.py', os.path.join(
        DEVELOPMENT_ASSETS_DIRECTORY_PATH, COMMON_ASSETS_DIRECTORY, 'views.py-tpl')),

    (SRC_DIRECTORY_NAME, 'djangologo.png', os.path.join(
        DEVELOPMENT_ASSETS_DIRECTORY_PATH, COMMON_ASSETS_DIRECTORY, 'djangologo.png')),

    (TEMPLATES_DIRECTORY_NAME, 'index.html', os.path.join(
