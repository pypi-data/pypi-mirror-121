...
DEV_REACTTS_TEMPLATES_PATHS_DICT = {
    'package.json-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'package.json-tpl'),
    'webpack.config.js-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'webpack.config.js-tpl'),
    'babel.config.json-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'babel.config.json-tpl'),
    'tsconfig.json-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'tsconfig.json-tpl'),
    'module.d.ts-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'module.d.ts-tpl'),
    'App.tsx-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'App.tsx-tpl'),
    'index.tsx-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'index.tsx-tpl'),
    'App.css-tpl': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'App.css-tpl'),
    'reactlogo.png': os.path.join(DEVELOPMENT_ASSETS_DIRECTORY_PATH, REACTTS, 'reactlogo.png')
}
...
DEV_REACTTS_TEMPLATE_FILES = [
    ...
    (SRC_DIRECTORY_NAME, 'App.tsx',
     DEV_REACTTS_TEMPLATES_PATHS_DICT['App.tsx-tpl']),

    (SRC_DIRECTORY_NAME, 'index.tsx',
     DEV_REACTTS_TEMPLATES_PATHS_DICT['index.tsx-tpl']),

    (SRC_DIRECTORY_NAME, 'App.css',
     DEV_REACTTS_TEMPLATES_PATHS_DICT['App.css-tpl']),
