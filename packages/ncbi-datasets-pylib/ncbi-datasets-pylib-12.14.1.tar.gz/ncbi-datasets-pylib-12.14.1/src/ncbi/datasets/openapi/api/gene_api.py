...
class GeneApi(object):
    ...
    def download_gene_package(
        ...
        **kwargs
        ...
        kwargs['gene_ids'] = \
            gene_ids
        if accept and self.download_gene_package_endpoint.headers_map:
            updated_header_maps = self.download_gene_package_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.download_gene_package_endpoint.headers_map = updated_header_maps
    ...
    def download_gene_package_post(
        ...
        **kwargs
        ...
        kwargs['v1_gene_dataset_request'] = \
            v1_gene_dataset_request
        if accept and self.download_gene_package_post_endpoint.headers_map:
            updated_header_maps = self.download_gene_package_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.download_gene_package_post_endpoint.headers_map = updated_header_maps
    ...
    def gene_download_summary_by_accession(
        ...
        **kwargs
        ...
        kwargs['accessions'] = \
            accessions
        if accept and self.gene_download_summary_by_accession_endpoint.headers_map:
            updated_header_maps = self.gene_download_summary_by_accession_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_download_summary_by_accession_endpoint.headers_map = updated_header_maps
    ...
    def gene_download_summary_by_id(
        ...
        **kwargs
        ...
        kwargs['gene_ids'] = \
            gene_ids
        if accept and self.gene_download_summary_by_id_endpoint.headers_map:
            updated_header_maps = self.gene_download_summary_by_id_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_download_summary_by_id_endpoint.headers_map = updated_header_maps
    ...
    def gene_download_summary_by_post(
        ...
        **kwargs
        ...
        kwargs['v1_gene_dataset_request'] = \
            v1_gene_dataset_request
        if accept and self.gene_download_summary_by_post_endpoint.headers_map:
            updated_header_maps = self.gene_download_summary_by_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_download_summary_by_post_endpoint.headers_map = updated_header_maps
    ...
    def gene_download_summary_by_tax_and_symbol(
        ...
        **kwargs
        ...
        kwargs['taxon'] = \
            taxon
        if accept and self.gene_download_summary_by_tax_and_symbol_endpoint.headers_map:
            updated_header_maps = self.gene_download_summary_by_tax_and_symbol_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_download_summary_by_tax_and_symbol_endpoint.headers_map = updated_header_maps
    ...
    def gene_metadata_by_accession(
        ...
        **kwargs
        ...
        kwargs['accessions'] = \
            accessions
        if accept and self.gene_metadata_by_accession_endpoint.headers_map:
            updated_header_maps = self.gene_metadata_by_accession_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_metadata_by_accession_endpoint.headers_map = updated_header_maps
    ...
    def gene_metadata_by_id(
        ...
        **kwargs
        ...
        kwargs['gene_ids'] = \
            gene_ids
        if accept and self.gene_metadata_by_id_endpoint.headers_map:
            updated_header_maps = self.gene_metadata_by_id_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_metadata_by_id_endpoint.headers_map = updated_header_maps
    ...
    def gene_metadata_by_post(
        ...
        **kwargs
        ...
        kwargs['v1_gene_dataset_request'] = \
            v1_gene_dataset_request
        if accept and self.gene_metadata_by_post_endpoint.headers_map:
            updated_header_maps = self.gene_metadata_by_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_metadata_by_post_endpoint.headers_map = updated_header_maps
    ...
    def gene_metadata_by_tax_and_symbol(
        ...
        **kwargs
        ...
        kwargs['taxon'] = \
            taxon
        if accept and self.gene_metadata_by_tax_and_symbol_endpoint.headers_map:
            updated_header_maps = self.gene_metadata_by_tax_and_symbol_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_metadata_by_tax_and_symbol_endpoint.headers_map = updated_header_maps
    ...
    def gene_metadata_stream_by_post(
        ...
        **kwargs
        ...
        kwargs['v1_gene_dataset_request'] = \
            v1_gene_dataset_request
        if accept and self.gene_metadata_stream_by_post_endpoint.headers_map:
            updated_header_maps = self.gene_metadata_stream_by_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_metadata_stream_by_post_endpoint.headers_map = updated_header_maps
    ...
    def gene_orthologs_by_id(
        ...
        **kwargs
        ...
        kwargs['gene_id'] = \
            gene_id
        if accept and self.gene_orthologs_by_id_endpoint.headers_map:
            updated_header_maps = self.gene_orthologs_by_id_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_orthologs_by_id_endpoint.headers_map = updated_header_maps
    ...
    def gene_tax_name_query(
        ...
        **kwargs
        ...
        kwargs['taxon_query'] = \
            taxon_query
        if accept and self.gene_tax_name_query_endpoint.headers_map:
            updated_header_maps = self.gene_tax_name_query_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_tax_name_query_endpoint.headers_map = updated_header_maps
    ...
    def gene_tax_tree(
        ...
        **kwargs
        ...
        kwargs['taxon'] = \
            taxon
        if accept and self.gene_tax_tree_endpoint.headers_map:
            updated_header_maps = self.gene_tax_tree_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.gene_tax_tree_endpoint.headers_map = updated_header_maps
