...
class GenomeApi(object):
    ...
    def assembly_descriptors_by_accessions(
        ...
        **kwargs
        ...
        kwargs['accessions'] = \
            accessions
        if accept and self.assembly_descriptors_by_accessions_endpoint.headers_map:
            updated_header_maps = self.assembly_descriptors_by_accessions_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.assembly_descriptors_by_accessions_endpoint.headers_map = updated_header_maps
    ...
    def assembly_descriptors_by_bioproject(
        ...
        **kwargs
        ...
        kwargs['accessions'] = \
            accessions
        if accept and self.assembly_descriptors_by_bioproject_endpoint.headers_map:
            updated_header_maps = self.assembly_descriptors_by_bioproject_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.assembly_descriptors_by_bioproject_endpoint.headers_map = updated_header_maps
    ...
    def assembly_descriptors_by_taxon(
        ...
        **kwargs
        ...
        kwargs['taxon'] = \
            taxon
        if accept and self.assembly_descriptors_by_taxon_endpoint.headers_map:
            updated_header_maps = self.assembly_descriptors_by_taxon_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.assembly_descriptors_by_taxon_endpoint.headers_map = updated_header_maps
    ...
    def check_assembly_availability(
        ...
        **kwargs
        ...
        kwargs['accessions'] = \
            accessions
        if accept and self.check_assembly_availability_endpoint.headers_map:
            updated_header_maps = self.check_assembly_availability_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.check_assembly_availability_endpoint.headers_map = updated_header_maps
    ...
    def check_assembly_availability_post(
        ...
        **kwargs
        ...
        kwargs['v1_assembly_dataset_request'] = \
            v1_assembly_dataset_request
        if accept and self.check_assembly_availability_post_endpoint.headers_map:
            updated_header_maps = self.check_assembly_availability_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.check_assembly_availability_post_endpoint.headers_map = updated_header_maps
    ...
    def download_assembly_package(
        ...
        **kwargs
        ...
        kwargs['accessions'] = \
            accessions
        if accept and self.download_assembly_package_endpoint.headers_map:
            updated_header_maps = self.download_assembly_package_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.download_assembly_package_endpoint.headers_map = updated_header_maps
    ...
    def download_assembly_package_post(
        ...
        **kwargs
        ...
        kwargs['v1_assembly_dataset_request'] = \
            v1_assembly_dataset_request
        if accept and self.download_assembly_package_post_endpoint.headers_map:
            updated_header_maps = self.download_assembly_package_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.download_assembly_package_post_endpoint.headers_map = updated_header_maps
    ...
    def genome_download_summary(
        ...
        **kwargs
        ...
        kwargs['accessions'] = \
            accessions
        if accept and self.genome_download_summary_endpoint.headers_map:
            updated_header_maps = self.genome_download_summary_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.genome_download_summary_endpoint.headers_map = updated_header_maps
    ...
    def genome_download_summary_by_post(
        ...
        **kwargs
        ...
        kwargs['v1_assembly_dataset_request'] = \
            v1_assembly_dataset_request
        if accept and self.genome_download_summary_by_post_endpoint.headers_map:
            updated_header_maps = self.genome_download_summary_by_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.genome_download_summary_by_post_endpoint.headers_map = updated_header_maps
    ...
    def genome_metadata_by_post(
        ...
        **kwargs
        ...
        kwargs['v1_assembly_metadata_request'] = \
            v1_assembly_metadata_request
        if accept and self.genome_metadata_by_post_endpoint.headers_map:
            updated_header_maps = self.genome_metadata_by_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.genome_metadata_by_post_endpoint.headers_map = updated_header_maps
    ...
    def genome_tax_name_query(
        ...
        **kwargs
        ...
        kwargs['taxon_query'] = \
            taxon_query
        if accept and self.genome_tax_name_query_endpoint.headers_map:
            updated_header_maps = self.genome_tax_name_query_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.genome_tax_name_query_endpoint.headers_map = updated_header_maps
    ...
    def genome_tax_tree(
        ...
        **kwargs
        ...
        kwargs['taxon'] = \
            taxon
        if accept and self.genome_tax_tree_endpoint.headers_map:
            updated_header_maps = self.genome_tax_tree_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.genome_tax_tree_endpoint.headers_map = updated_header_maps
