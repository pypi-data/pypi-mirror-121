...
class VersionApi(object):
    ...
    def version(
        ...
        **kwargs
        ...
        if accept and self.version_endpoint.headers_map:
            updated_header_maps = self.version_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.version_endpoint.headers_map = updated_header_maps
