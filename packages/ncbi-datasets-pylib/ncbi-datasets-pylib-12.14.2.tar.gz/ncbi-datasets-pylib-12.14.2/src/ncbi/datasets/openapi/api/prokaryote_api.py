...
class ProkaryoteApi(object):
    ...
    def download_prokaryote_gene_package(
        ...
        **kwargs
        ...
        kwargs['accessions'] = \
            accessions
        if accept and self.download_prokaryote_gene_package_endpoint.headers_map:
            updated_header_maps = self.download_prokaryote_gene_package_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.download_prokaryote_gene_package_endpoint.headers_map = updated_header_maps
    ...
    def download_prokaryote_gene_package_post(
        ...
        **kwargs
        ...
        kwargs['v1_prokaryote_gene_request'] = \
            v1_prokaryote_gene_request
        if accept and self.download_prokaryote_gene_package_post_endpoint.headers_map:
            updated_header_maps = self.download_prokaryote_gene_package_post_endpoint.headers_map.copy()
            if accept in updated_header_maps:
                updated_header_maps['accept'] = [accept]
                self.download_prokaryote_gene_package_post_endpoint.headers_map = updated_header_maps
