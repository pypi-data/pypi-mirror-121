...
from azureml.dataprep.rslex import Copier, StreamInfo, PyLocationInfo, PyIfDestinationExists
...
class MountOptions:
    def __init__(self,
        ...
        self._disable_dataflow_cache = kwargs.get('disableMetadataCache', "False").lower() == "true"
...
def mount(dataflow: Optional[Dataflow],
    ...
    rslex_mount_context = rslex_mount(
        dataflow, files_column, mount_point, base_path, options, destination)
...
def rslex_mount(dataflow: Optional[Dataflow],
    ...
    rslex_writable_fuse_flight = os.getenv('RSLEX_DIRECT_VOLUME_WRITABLE_MOUNT', default="false")
