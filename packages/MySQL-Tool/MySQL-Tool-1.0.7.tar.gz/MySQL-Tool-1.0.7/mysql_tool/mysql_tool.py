...
class my_mysql():
    ...
    def __init__(self, host, user, database, password, port=3306, pool_count=5, default_character_set="utf-8"):
        self.host = host
        self.user = user
        ...
        self.pool = PooledDB(pymysql, pool_count, host=host, user=user, passwd=password, db=database, port=port, setsession=[
            'SET AUTOCOMMIT = 1'])
