...
def trend_and_season_jm(y):
    ...
    interval = [i for i in range(1,len(y)+1)]

    #return the linear regression coefficients
    coeffs = estimate_coef_jm(interval,y)
    ...
    Trend_season = [(num1 / num2) for num1, num2 in zip(y, seasonal_adj)]
