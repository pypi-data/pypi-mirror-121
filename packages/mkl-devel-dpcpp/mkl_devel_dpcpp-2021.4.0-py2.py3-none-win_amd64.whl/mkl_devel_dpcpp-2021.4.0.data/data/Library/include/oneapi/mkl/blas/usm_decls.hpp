...
DLL_EXPORT cl::sycl::event gemm_batch(cl::sycl::queue &queue,
                                      ...
                                      const sycl::span<std::int64_t> &m, const sycl::span<std::int64_t> &n,
                                      const sycl::span<std::int64_t> &k,
                                      const sycl::span<half> &alpha,
                                      const sycl::span<const half*> &a, const sycl::span<std::int64_t> &lda,
                                      const sycl::span<const half*> &b, const sycl::span<std::int64_t> &ldb, 
                                      const sycl::span<half> &beta,
                                      const sycl::span<half*> &c, const sycl::span<std::int64_t> &ldc,
                                      size_t group_count, const sycl::span<size_t> &groupsize,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event gemm_batch(cl::sycl::queue &queue, const transpose *transa, const transpose *transb,
                           const std::int64_t *m, const std::int64_t *n, const std::int64_t *k, const half *alpha,
                           const half **a, const std::int64_t *lda,
                           const half **b, const std::int64_t *ldb, 
                           const half *beta, half **c, const std::int64_t *ldc,
                           std::int64_t group_count, const std::int64_t *groupsize,
                           const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
