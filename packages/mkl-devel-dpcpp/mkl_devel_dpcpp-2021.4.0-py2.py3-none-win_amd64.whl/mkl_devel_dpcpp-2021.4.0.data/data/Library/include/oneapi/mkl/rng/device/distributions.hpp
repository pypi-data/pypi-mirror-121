...
public:
    ...
    explicit uniform(const param_type& pt) : detail::distribution_base<uniform<Type, Method>>(pt.a_, pt.b_) {}
...
public:
    ...
    explicit lognormal(const param_type& pt)
            : detail::distribution_base<lognormal<RealType, Method>>(pt.m_, pt.s_, pt.displ_, pt.scale_) {}
...
public:
    ...
    using method_type = Method;
    using result_type = RealType;
    using param_type = typename detail::distribution_base<exponential<RealType, Method>>::param_type;
...
public:
    ...
    static_assert(std::is_same<IntType, std::int32_t>::value || std::is_same<IntType, std::uint32_t>::value,
    ...
    poisson()
            : detail::distribution_base<poisson<IntType, Method>>(0.5) {}

    explicit poisson(double lambda)
            : detail::distribution_base<poisson<IntType, Method>>(lambda) {}
