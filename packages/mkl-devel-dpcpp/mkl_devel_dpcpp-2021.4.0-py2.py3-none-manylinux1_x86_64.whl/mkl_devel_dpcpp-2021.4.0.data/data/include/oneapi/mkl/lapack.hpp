...
DLL_EXPORT cl::sycl::event getrf_batch(cl::sycl::queue &queue, int64_t m, int64_t n, std::complex<float> *a,
                                       ...
                                       const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getrf_batch(cl::sycl::queue &queue, int64_t m, int64_t n, double *a, int64_t lda,
                                       int64_t stride_a, int64_t *ipiv, int64_t stride_ipiv, int64_t batch_size,
                                       double *scratchpad, int64_t scratchpad_size,
                                       const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getrf_batch(cl::sycl::queue &queue, int64_t m, int64_t n, float *a, int64_t lda,
                                       int64_t stride_a, int64_t *ipiv, int64_t stride_ipiv, int64_t batch_size,
                                       float *scratchpad, int64_t scratchpad_size,
                                       const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getrf_batch(cl::sycl::queue &queue, int64_t m, int64_t n, std::complex<double> *a,
                                       int64_t lda, int64_t stride_a, int64_t *ipiv, int64_t stride_ipiv,
                                       int64_t batch_size, std::complex<double> *scratchpad, int64_t scratchpad_size,
                                       const cl::sycl::vector_class<cl::sycl::event> &event_list = {});

// getrf_batch_strided: Buffer API
DLL_EXPORT void getrf_batch(cl::sycl::queue &queue, int64_t m, int64_t n, cl::sycl::buffer<std::complex<float>> &a,
                            int64_t lda, int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv,
                            int64_t batch_size, cl::sycl::buffer<std::complex<float>> &scratchpad,
                            int64_t scratchpad_size);
DLL_EXPORT void getrf_batch(cl::sycl::queue &queue, int64_t m, int64_t n, cl::sycl::buffer<double> &a, int64_t lda,
                            int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv, int64_t batch_size,
                            cl::sycl::buffer<double> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getrf_batch(cl::sycl::queue &queue, int64_t m, int64_t n, cl::sycl::buffer<float> &a, int64_t lda,
                            int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv, int64_t batch_size,
                            cl::sycl::buffer<float> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getrf_batch(cl::sycl::queue &queue, int64_t m, int64_t n, cl::sycl::buffer<std::complex<double>> &a,
                            int64_t lda, int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv,
                            int64_t batch_size, cl::sycl::buffer<std::complex<double>> &scratchpad,
                            int64_t scratchpad_size);

// getri_batch_strided: scratchpad size query
template <typename fp_type, internal::is_floating_point<fp_type> = nullptr>
...
// getri_batch_strided: USM API
DLL_EXPORT cl::sycl::event getri_batch(cl::sycl::queue &queue, int64_t n, std::complex<float> *a, int64_t lda,
                                       ...
                                       std::complex<float> *scratchpad, int64_t scratchpad_size,
                                       const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getri_batch(cl::sycl::queue &queue, int64_t n, double *a, int64_t lda, int64_t stride_a,
                                       int64_t *ipiv, int64_t stride_ipiv, double *ainv, int64_t ldainv,
                                       int64_t stride_ainv, int64_t batch_size, double *scratchpad,
                                       int64_t scratchpad_size,
                                       const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getri_batch(cl::sycl::queue &queue, int64_t n, float *a, int64_t lda, int64_t stride_a,
                                       int64_t *ipiv, int64_t stride_ipiv, float *ainv, int64_t ldainv,
                                       int64_t stride_ainv, int64_t batch_size, float *scratchpad,
                                       int64_t scratchpad_size,
                                       const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getri_batch(cl::sycl::queue &queue, int64_t n, std::complex<double> *a, int64_t lda,
                                       int64_t stride_a, int64_t *ipiv, int64_t stride_ipiv, std::complex<double> *ainv,
                                       int64_t ldainv, int64_t stride_ainv, int64_t batch_size,
                                       std::complex<double> *scratchpad, int64_t scratchpad_size,
                                       const cl::sycl::vector_class<cl::sycl::event> &event_list = {});

// getri_batch_strided: Buffer API
DLL_EXPORT void getri_batch(cl::sycl::queue &queue, int64_t n, cl::sycl::buffer<std::complex<float>> &a, int64_t lda,
                            int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv,
                            cl::sycl::buffer<std::complex<float>> &ainv, int64_t ldainv, int64_t stride_ainv,
                            int64_t batch_size, cl::sycl::buffer<std::complex<float>> &scratchpad,
                            int64_t scratchpad_size);
DLL_EXPORT void getri_batch(cl::sycl::queue &queue, int64_t n, cl::sycl::buffer<double> &a, int64_t lda,
                            int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv,
                            cl::sycl::buffer<double> &ainv, int64_t ldainv, int64_t stride_ainv, int64_t batch_size,
                            cl::sycl::buffer<double> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getri_batch(cl::sycl::queue &queue, int64_t n, cl::sycl::buffer<float> &a, int64_t lda,
                            int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv,
                            cl::sycl::buffer<float> &ainv, int64_t ldainv, int64_t stride_ainv, int64_t batch_size,
                            cl::sycl::buffer<float> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getri_batch(cl::sycl::queue &queue, int64_t n, cl::sycl::buffer<std::complex<double>> &a, int64_t lda,
                            int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv,
                            cl::sycl::buffer<std::complex<double>> &ainv, int64_t ldainv, int64_t stride_ainv,
                            int64_t batch_size, cl::sycl::buffer<std::complex<double>> &scratchpad,
                            int64_t scratchpad_size);

// getrs_batch_strided: scratchpad size query
template <typename fp_type, internal::is_floating_point<fp_type> = nullptr>
int64_t getrs_batch_scratchpad_size(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                                    int64_t lda, int64_t stride_a, int64_t stride_ipiv, int64_t ldb, int64_t stride_b,
                                    int64_t batch_size);

// getrs_batch_strided: USM API
DLL_EXPORT cl::sycl::event getrs_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
...
DLL_EXPORT void getrs_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                            cl::sycl::buffer<std::complex<float>> &a, int64_t lda, int64_t stride_a,
                            cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv,
                            cl::sycl::buffer<std::complex<float>> &b, int64_t ldb, int64_t stride_b, int64_t batch_size,
                            cl::sycl::buffer<std::complex<float>> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getrs_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                            cl::sycl::buffer<double> &a, int64_t lda, int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv,
                            int64_t stride_ipiv, cl::sycl::buffer<double> &b, int64_t ldb, int64_t stride_b,
                            int64_t batch_size, cl::sycl::buffer<double> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getrs_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                            cl::sycl::buffer<float> &a, int64_t lda, int64_t stride_a, cl::sycl::buffer<int64_t> &ipiv,
                            int64_t stride_ipiv, cl::sycl::buffer<float> &b, int64_t ldb, int64_t stride_b,
                            int64_t batch_size, cl::sycl::buffer<float> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getrs_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                            cl::sycl::buffer<std::complex<double>> &a, int64_t lda, int64_t stride_a,
                            cl::sycl::buffer<int64_t> &ipiv, int64_t stride_ipiv,
                            cl::sycl::buffer<std::complex<double>> &b, int64_t ldb, int64_t stride_b,
                            int64_t batch_size, cl::sycl::buffer<std::complex<double>> &scratchpad,
                            int64_t scratchpad_size);

// getrsnp_batch_strided: scratchpad size query
template <typename fp_type, internal::is_floating_point<fp_type> = nullptr>
int64_t getrsnp_batch_scratchpad_size(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                                      int64_t lda, int64_t stride_a, int64_t ldb, int64_t stride_b, int64_t batch_size);

// getrsnp_batch_strided: USM API
DLL_EXPORT cl::sycl::event getrsnp_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
...
DLL_EXPORT cl::sycl::event getrsnp_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                                         ...
                                         int64_t stride_b, int64_t batch_size, double *scratchpad,
                                         int64_t scratchpad_size,
                                         const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getrsnp_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                                         float *a, int64_t lda, int64_t stride_a, float *b, int64_t ldb,
                                         int64_t stride_b, int64_t batch_size, float *scratchpad,
                                         int64_t scratchpad_size,
                                         const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getrsnp_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                                         std::complex<double> *a, int64_t lda, int64_t stride_a,
                                         std::complex<double> *b, int64_t ldb, int64_t stride_b, int64_t batch_size,
                                         std::complex<double> *scratchpad, int64_t scratchpad_size,
                                         const cl::sycl::vector_class<cl::sycl::event> &event_list = {});

// getrsnp_batch_strided: Buffer API
DLL_EXPORT void getrsnp_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                              cl::sycl::buffer<std::complex<float>> &a, int64_t lda, int64_t stride_a,
                              cl::sycl::buffer<std::complex<float>> &b, int64_t ldb, int64_t stride_b,
                              int64_t batch_size, cl::sycl::buffer<std::complex<float>> &scratchpad,
                              int64_t scratchpad_size);
DLL_EXPORT void getrsnp_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                              cl::sycl::buffer<double> &a, int64_t lda, int64_t stride_a, cl::sycl::buffer<double> &b,
                              int64_t ldb, int64_t stride_b, int64_t batch_size, cl::sycl::buffer<double> &scratchpad,
                              int64_t scratchpad_size);
DLL_EXPORT void getrsnp_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                              cl::sycl::buffer<float> &a, int64_t lda, int64_t stride_a, cl::sycl::buffer<float> &b,
                              int64_t ldb, int64_t stride_b, int64_t batch_size, cl::sycl::buffer<float> &scratchpad,
                              int64_t scratchpad_size);
DLL_EXPORT void getrsnp_batch(cl::sycl::queue &queue, oneapi::mkl::transpose trans, int64_t n, int64_t nrhs,
                              cl::sycl::buffer<std::complex<double>> &a, int64_t lda, int64_t stride_a,
                              cl::sycl::buffer<std::complex<double>> &b, int64_t ldb, int64_t stride_b,
...
template <typename fp_type, internal::is_floating_point<fp_type> = nullptr>
int64_t getrfnp_batch_strided_scratchpad_size(cl::sycl::queue &queue, int64_t m, int64_t n, int64_t lda,
                                              int64_t stride_a, int64_t batch_size);

// getrfnp_batch_strided: USM API
DLL_EXPORT cl::sycl::event getrfnp_batch_strided(cl::sycl::queue &queue, int64_t m, int64_t n, std::complex<float> *a,
                                                 int64_t lda, int64_t stride_a, int64_t batch_size,
                                                 std::complex<float> *scratchpad, int64_t scratchpad_size,
                                                 const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getrfnp_batch_strided(cl::sycl::queue &queue, int64_t m, int64_t n, double *a, int64_t lda,
                                                 int64_t stride_a, int64_t batch_size, double *scratchpad,
                                                 int64_t scratchpad_size,
                                                 const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getrfnp_batch_strided(cl::sycl::queue &queue, int64_t m, int64_t n, float *a, int64_t lda,
                                                 int64_t stride_a, int64_t batch_size, float *scratchpad,
                                                 int64_t scratchpad_size,
                                                 const cl::sycl::vector_class<cl::sycl::event> &event_list = {});
DLL_EXPORT cl::sycl::event getrfnp_batch_strided(cl::sycl::queue &queue, int64_t m, int64_t n, std::complex<double> *a,
                                                 int64_t lda, int64_t stride_a, int64_t batch_size,
                                                 std::complex<double> *scratchpad, int64_t scratchpad_size,
                                                 const cl::sycl::vector_class<cl::sycl::event> &event_list = {});

// getrfnp_batch_strided: Buffer API
DLL_EXPORT void getrfnp_batch_strided(cl::sycl::queue &queue, int64_t m, int64_t n,
                                      cl::sycl::buffer<std::complex<float>> &a, int64_t lda, int64_t stride_a,
                                      int64_t batch_size, cl::sycl::buffer<std::complex<float>> &scratchpad,
                                      int64_t scratchpad_size);
DLL_EXPORT void getrfnp_batch_strided(cl::sycl::queue &queue, int64_t m, int64_t n, cl::sycl::buffer<double> &a,
                                      int64_t lda, int64_t stride_a, int64_t batch_size,
                                      cl::sycl::buffer<double> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getrfnp_batch_strided(cl::sycl::queue &queue, int64_t m, int64_t n, cl::sycl::buffer<float> &a,
                                      int64_t lda, int64_t stride_a, int64_t batch_size,
                                      cl::sycl::buffer<float> &scratchpad, int64_t scratchpad_size);
DLL_EXPORT void getrfnp_batch_strided(cl::sycl::queue &queue, int64_t m, int64_t n,
                                      cl::sycl::buffer<std::complex<double>> &a, int64_t lda, int64_t stride_a,
