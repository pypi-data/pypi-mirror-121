...
from bbsofa.augment._filaments_augmentation import _FilamentAugmentation
...
class FilamentDataLoader(DataLoader):
    ...
    def collate_fn(self, batch):
        ...
        """
        filament_augmentation = _FilamentAugmentation(self.filament_cutout, self.batch_size,
