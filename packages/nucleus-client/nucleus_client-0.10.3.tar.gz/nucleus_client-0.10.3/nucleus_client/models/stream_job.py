...
class StreamJob(object):
    ...
    def __init__(self, id=None, client_id=None, druid=None, druid_metadata=None, dt_u=None, execution_mode=None, flink_jobs=None, job_name=None, operations=None, partner_id=None, reload_schedule=None, slug=None, yarn_applications=None):  # noqa: E501
