...
from ..layers import EmbeddingLayer, DNN_Layer, FM_Layer

class DeepFM(BaseModel):
    def __init__(self, feature_encoder, model_id='DeepFM', gpu=-1, task='classification', 
        ...
        super(DeepFM, self).__init__(feature_encoder, model_id=model_id, gpu=gpu, **kwargs)
        self.embedding_layer = EmbeddingLayer(feature_encoder, embedding_dim)
        self.fm_layer = FM_Layer(feature_encoder, final_activation=None, use_bias=False)
