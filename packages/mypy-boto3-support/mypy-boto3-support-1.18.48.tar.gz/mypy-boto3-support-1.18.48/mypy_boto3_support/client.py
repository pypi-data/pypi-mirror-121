...
class SupportClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client)
    ...
    def add_attachments_to_set(
        self, *, attachments: Sequence["AttachmentTypeDef"], attachmentSetId: str = None
    ) -> AddAttachmentsToSetResponseTypeDef:
        """
        Adds one or more attachments to an attachment set.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.add_attachments_to_set)
    ...
    def add_communication_to_case(
        ...
        *,
        ...
        caseId: str = None,
        ccEmailAddresses: Sequence[str] = None,
        attachmentSetId: str = None
    ) -> AddCommunicationToCaseResponseTypeDef:
        """
        Adds additional customer communication to an AWS Support case.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.add_communication_to_case)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.can_paginate)
    ...
    def create_case(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.create_case)
    ...
    def describe_attachment(self, *, attachmentId: str) -> DescribeAttachmentResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_attachment)
    ...
    def describe_cases(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_cases)
    ...
    def describe_communications(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_communications)
    ...
    def describe_services(
        self, *, serviceCodeList: Sequence[str] = None, language: str = None
    ) -> DescribeServicesResponseTypeDef:
        """
        Returns the current list of AWS services and a list of service categories for
        each service.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_services)
    ...
    def describe_severity_levels(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_severity_levels)
    ...
    def describe_trusted_advisor_check_refresh_statuses(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_trusted_advisor_check_refresh_statuses)
    ...
    def describe_trusted_advisor_check_result(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_trusted_advisor_check_result)
    ...
    def describe_trusted_advisor_check_summaries(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_trusted_advisor_check_summaries)
    ...
    def describe_trusted_advisor_checks(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.describe_trusted_advisor_checks)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.generate_presigned_url)
    ...
    def refresh_trusted_advisor_check(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.refresh_trusted_advisor_check)
    ...
    def resolve_case(self, *, caseId: str = None) -> ResolveCaseResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Client.resolve_case)
    ...
    def get_paginator(self, operation_name: Literal["describe_cases"]) -> DescribeCasesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Paginator.DescribeCases)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/support.html#Support.Paginator.DescribeCommunications)
