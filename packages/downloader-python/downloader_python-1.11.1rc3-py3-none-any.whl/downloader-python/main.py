...
class window(QtWidgets.QMainWindow,Ui_MainWindow):
        ...
        try:
            ...
            try:
                ...
                with open(self.log_name, 'w') as f:
                    f.write('')
            self.download_list = []
            self.log(f'[{time.ctime()}][main/Info] loading for downloader:{self.version}')
            self.log(f'[{time.ctime()}][main/Info] Connected to log file:{self.log_name}')
            ...
            self.comboBox.addItems(['up','down'])
            self.pushButton_9.clicked.connect(self.addddd)
            self.pushButton_10.clicked.connect(self.aaw)

            self.list_timer = QTimer()
            self.list_timer.timeout.connect(self.list_view)
            self.list_timer.start(1)
    ...
    def list_view(self):
        self.textBrowser_3.setText(str(self.download_list))
    def aaw(self):
        self.download_list.clear()
        result = QtWidgets.QMessageBox.question(self, 'Clean', 'Cleaned',
                                                QtWidgets.QMessageBox.Ok)

    def addddd(self):
        self.download_list.append(self.lineEdit.text()+'|'+self.lineEdit_2.text())
        result = QtWidgets.QMessageBox.question(self, 'Add', f"added:{self.lineEdit.text()+'|'+self.lineEdit_2.text()}",
                                                    QtWidgets.QMessageBox.Ok)
    ...
    def loadt(self,dic):
        ...
        self.pushButton_9.setText(dic['pushButton_9'])
        self.pushButton_10.setText(dic['pushButton_10'])

        self.label_17.setText(dic['label_17'])
        ...
        self.setWindowIcon(QIcon(aw + 'sources/icon.ico'))
    def fffff(self):
        ...
        self.verticalSlider_3.setStyleSheet(f'background-color:rgb({r},0,0)')
        self.verticalSlider_2.setStyleSheet(f'background-color:rgb(0,{g},0)')
        self.verticalSlider.setStyleSheet(f'background-color:rgb(0,0,{b})')
        ...
        self.tabWidget.setStyleSheet(f'background-color: rgb({255-r},{255-g},{255-b});color: rgb({r},{g},{b})')

        self.groupBox.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.label.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.label_2.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.lineEdit.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        self.lineEdit_2.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        self.pushButton.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.pushButton_10.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.pushButton_9.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.groupBox_2.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.label_3.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.label_4.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.label_17.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.pushButton_2.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.textBrowser.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        self.textBrowser_3.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        self.label_5.setStyleSheet(f'color: rgb({r},{g},{b});font: 20pt "Consolas"')
        self.groupBox_3.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.groupBox_4.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.groupBox_5.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.groupBox_6.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.label_6.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.checkBox.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.checkBox_2.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.checkBox_3.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.checkBox_4.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.pushButton_3.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.label_7.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.lineEdit_3.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        self.lineEdit_4.setStyleSheet(
            f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        ...
        self.lineEdit_13.setStyleSheet(
            f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        self.comboBox.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        self.pushButton_4.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.pushButton_5.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.pushButton_6.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.pushButton_7.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.groupBox_7.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.groupBox_8.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.textEdit.setStyleSheet(
            f'color: rgb({r},{g},{b});font: 12pt "Consolas";selection-color: rgb({255-r},{255-g},{255-b});selection-background-color: rgb({r},{g},{b})')
        self.label_16.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.pushButton_8.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
        self.treeView.setStyleSheet(f'color: rgb({r},{g},{b});font: 12pt "Consolas"')
    ...
    def load(self):
        ...
        a = open(aw+'properties/settings.properties')
        ...
        for i in self.download_list:
            ...
            try:
                ...
                if not self.checkBox.isChecked():
                    ...
                    r = requests.get(lis[0],headers = header)
                else:
                    r = requests.get(lis[0])
                self.u(30)
                con = r.content
                self.u(40)
