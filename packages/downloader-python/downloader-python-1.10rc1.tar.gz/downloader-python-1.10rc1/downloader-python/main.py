...
class window(QtWidgets.QMainWindow,Ui_MainWindow):
    ...
    def loadt(self,dic):
        ...
        self.label_16.setText(dic['label_16'])
        self.label_17.setText(dic['label_17'])
        self.label_18.setText(dic['label_18'])
    def fffff(self):

        self.label_15.setStyleSheet(f'color:rgb({self.verticalSlider_3.value()},{self.verticalSlider_2.value()},{self.verticalSlider.value()})')
        self.label_19.setStyleSheet(
            f'color:rgb({255-self.verticalSlider_3.value()},{255-self.verticalSlider_2.value()},{255-self.verticalSlider.value()})')

        self.label_16.setStyleSheet(
            f'color:rgb({self.verticalSlider_3.value()},0,0)')

        self.label_17.setStyleSheet(
            f'color:rgb(0,{self.verticalSlider_2.value()},0)')

        self.label_18.setStyleSheet(
            f'color:rgb(0,0,{self.verticalSlider.value()})')
