...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '4.2.0-alpha.1632761718+3a2328e0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 4.2.0-alpha.1632761718+3a2328e0`
                """)
            else:
                raise
