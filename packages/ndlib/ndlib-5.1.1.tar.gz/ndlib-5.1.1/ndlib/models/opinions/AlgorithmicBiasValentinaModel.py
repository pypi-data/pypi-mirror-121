...
class AlgorithmicBiasValentinaModel(DiffusionModel):
    """
    ...
    def set_initial_status(self, configuration=None):
        ...
        if max_edgees == self.graph.number_of_edges():
            ...
            for i in self.graph.nodes:
                ...
                # per tenere aggiornato node_data() all'interno del for dovrei ciclare ogni item=nodo e se uno dei suoi vicini è n1 o n2 aggiornare l'array sts
                ...
                # a ogni ciclo devo soltanto tirarmi fuori la lista degli stati degli avg_k vicini e prendere i loro stati da actual_status
    ...
    def iteration(self, node_status=True):
        ...
        for i in range(0, n):
            ...
            n2 = np.argmax(
                cumulative_selection_probability >= r)  # ho tolto il -1 perché mi sembrava selezionasse il nodo sbagliato, così mi sembra corretto dai test
