...
class ComputeOptimizerClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.can_paginate)
    ...
    def describe_recommendation_export_jobs(
        self,
        *,
        jobIds: Sequence[str] = None,
        filters: Sequence["JobFilterTypeDef"] = None,
        nextToken: str = None,
        maxResults: int = None
    ) -> DescribeRecommendationExportJobsResponseTypeDef:
        """
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.describe_recommendation_export_jobs)
    ...
    def export_auto_scaling_group_recommendations(
        ...
        *,
        ...
        fieldsToExport: Sequence[ExportableAutoScalingGroupFieldType] = None,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.export_auto_scaling_group_recommendations)
    ...
    def export_ebs_volume_recommendations(
        ...
        *,
        s3DestinationConfig: "S3DestinationConfigTypeDef",
        accountIds: Sequence[str] = None,
        filters: Sequence["EBSFilterTypeDef"] = None,
        fieldsToExport: Sequence[ExportableVolumeFieldType] = None,
        fileFormat: Literal["Csv"] = None,
        includeMemberAccounts: bool = None
    ) -> ExportEBSVolumeRecommendationsResponseTypeDef:
        """
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.export_ebs_volume_recommendations)
    ...
    def export_ec2_instance_recommendations(
        ...
        *,
        ...
        accountIds: Sequence[str] = None,
        filters: Sequence["FilterTypeDef"] = None,
        fieldsToExport: Sequence[ExportableInstanceFieldType] = None,
        fileFormat: Literal["Csv"] = None,
        includeMemberAccounts: bool = None,
        recommendationPreferences: "RecommendationPreferencesTypeDef" = None
    ) -> ExportEC2InstanceRecommendationsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.export_ec2_instance_recommendations)
    ...
    def export_lambda_function_recommendations(
        ...
        *,
        s3DestinationConfig: "S3DestinationConfigTypeDef",
        accountIds: Sequence[str] = None,
        filters: Sequence["LambdaFunctionRecommendationFilterTypeDef"] = None,
        fieldsToExport: Sequence[ExportableLambdaFunctionFieldType] = None,
        fileFormat: Literal["Csv"] = None,
        includeMemberAccounts: bool = None
    ) -> ExportLambdaFunctionRecommendationsResponseTypeDef:
        """
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.export_lambda_function_recommendations)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.generate_presigned_url)
    ...
    def get_auto_scaling_group_recommendations(
        ...
        *,
        accountIds: Sequence[str] = None,
        autoScalingGroupArns: Sequence[str] = None,
        nextToken: str = None,
        maxResults: int = None,
        filters: Sequence["FilterTypeDef"] = None,
        recommendationPreferences: "RecommendationPreferencesTypeDef" = None
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.get_auto_scaling_group_recommendations)
    ...
    def get_ebs_volume_recommendations(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.get_ebs_volume_recommendations)
    ...
    def get_ec2_instance_recommendations(
        self,
        *,
        instanceArns: Sequence[str] = None,
        nextToken: str = None,
        maxResults: int = None,
        filters: Sequence["FilterTypeDef"] = None,
        accountIds: Sequence[str] = None,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.get_ec2_instance_recommendations)
    ...
    def get_ec2_recommendation_projected_metrics(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.get_ec2_recommendation_projected_metrics)
    ...
    def get_enrollment_status(self) -> GetEnrollmentStatusResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.get_enrollment_status)
    ...
    def get_enrollment_statuses_for_organization(
        self,
        *,
        filters: Sequence["EnrollmentFilterTypeDef"] = None,
        nextToken: str = None,
        maxResults: int = None
    ) -> GetEnrollmentStatusesForOrganizationResponseTypeDef:
        """
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.get_enrollment_statuses_for_organization)
    ...
    def get_lambda_function_recommendations(
        self,
        *,
        functionArns: Sequence[str] = None,
        accountIds: Sequence[str] = None,
        filters: Sequence["LambdaFunctionRecommendationFilterTypeDef"] = None,
        nextToken: str = None,
        maxResults: int = None
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.get_lambda_function_recommendations)
    ...
    def get_recommendation_summaries(
        self, *, accountIds: Sequence[str] = None, nextToken: str = None, maxResults: int = None
    ) -> GetRecommendationSummariesResponseTypeDef:
        """
        Returns the optimization findings for an account.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.get_recommendation_summaries)
    ...
    def update_enrollment_status(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.48/reference/services/compute-optimizer.html#ComputeOptimizer.Client.update_enrollment_status)
