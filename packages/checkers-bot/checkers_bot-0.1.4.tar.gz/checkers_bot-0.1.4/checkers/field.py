...
class Field():
	def __init__(self,turn = "white"):
		...
		'''self.map = [[None,_Checker('black',self),None,_Checker('black',self),None,_Checker('black',self),None,_Checker('black',self)],
					[_Checker('black',self),None,None,None,_Checker('black',self),None,_Checker('black',self),None],
					[None,None,None,_Checker('black',self),None,None,None,_Checker('white',self)],
					[_Checker('black',self),None,None,None,None,None,None,None],
					[None,None,None,_Checker('white',self),None,_Checker('black',self),None,_Checker('white',self)],
					[_Checker('white',self),None,_Checker('white',self),None,_Checker('white',self),None,None,None],
					[None,_Checker('white',self),None,_Checker('white',self),None,None,None,None],
					[_Checker('white',self),None,_Checker('white',self),None,_Checker('white',self),None,None,None]]'''
