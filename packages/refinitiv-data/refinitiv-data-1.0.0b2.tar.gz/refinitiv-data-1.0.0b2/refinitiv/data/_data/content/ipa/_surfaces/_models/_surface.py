...
class Surface:
    ...
    Examples
    -------
    >>> from refinitiv.data.content.ipa.surfaces import surface_eti
    >>> definition = surface_eti.Definition(
    ...     underlying_definition=surface_eti.EtiSurfaceDefinition(
    ...         instrument_code="BNPP.PA@RIC"
    ...     ),
    ...     surface_parameters=surface_eti.EtiCalculationParams(
    ...         price_side=surface_eti.PriceSide.MID,
    ...         volatility_model=surface_eti.VolatilityModel.SVI,
    ...         x_axis=surface_eti.Axis.STRIKE,
    ...         y_axis=surface_eti.Axis.DATE,
    ...     ),
    ...     surface_tag="1_MATRIX",
    ...     surface_layout=surface_eti.SurfaceLayout(
    ...         format=surface_eti.Format.MATRIX,
    ...         y_point_count=10
    ...     ),
    ... )
    >>> response = definition.get_data()
    >>> surface = response.data.surface
    >>> curve = surface.get_curve("25.35", surface_eti.Axis.X)
    >>> curve = surface.get_curve("2021-08-20", surface_eti.Axis.Y)
