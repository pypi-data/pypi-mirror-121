...
class NATMCHTelnet:
    ...
    def _start_slot(self, amc_num, sleep: int = 2):
        ...
        if state == "M4":
            ...
            if "Upstream Power Up Delay active!" in fru_start:
                self.logger.logger.info(
                    "Slot has upstream delay set. Waiting 30s for AMC to power on..."
                )
                sleep = 35
