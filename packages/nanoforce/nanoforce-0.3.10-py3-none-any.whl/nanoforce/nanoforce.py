...
class AFM:
    ...
    def calc_modulus_sneddon(
        ...
        curve can be selected by setting the 'start_force' and 'end_force' as a fraction
        of the total force, where start force is the highest indentation force to use.
        ...
        for curve_number in range(0, self.z_approach.shape[1]):
            ...
            max_depth = next(n for n in _z if n == n)

            force = force[depth > max_depth * end_force]
            depth = depth[depth > max_depth * end_force]
            force = force[depth < max_depth * start_force]
            depth = depth[depth < max_depth * start_force]
