...
class PaymentLastRefundReason(object):
    ...
    allowable_values = [DUPLICATED, FRAUDULENT, REQUESTED_BY_CUSTOMER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """PaymentLastRefundReason - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentLastRefundReason):
            return False
