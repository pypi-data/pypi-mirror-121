...
namespace __pythran_subpix
{
  ...
  struct compute_subpix_2d_gaussian2
  {
    ...
    struct type
    {
      ...
      typedef decltype(pythonic::types::make_tuple(std::declval<__type0>(), std::declval<__type0>())) __type24;
      typedef decltype(std::declval<__type23>()[std::declval<__type24>()]) __type25;
      typedef decltype(std::declval<__type1>()(std::declval<__type25>())) __type26;
      typedef decltype(pythonic::operator_::mul(std::declval<__type0>(), std::declval<__type26>())) __type27;
      typedef decltype(pythonic::operator_::div(std::declval<__type27>(), std::declval<__type0>())) __type28;
      typedef typename pythonic::assignable<long>::type __type29;
      ...
      typedef decltype(pythonic::operator_::add(std::declval<__type31>(), std::declval<__type27>())) __type32;
      typedef typename __combined<__type31,__type32>::type __type33;
      typedef decltype(pythonic::operator_::add(std::declval<__type33>(), std::declval<__type27>())) __type34;
      typedef typename __combined<__type33,__type34>::type __type35;
      typedef decltype(pythonic::operator_::add(std::declval<__type35>(), std::declval<__type27>())) __type36;
      typedef typename __combined<__type35,__type36>::type __type37;
      typedef decltype(pythonic::operator_::add(std::declval<__type37>(), std::declval<__type27>())) __type38;
      typedef typename __combined<__type37,__type38>::type __type39;
      typedef decltype(pythonic::operator_::add(std::declval<__type39>(), std::declval<__type27>())) __type40;
      typedef typename __combined<__type39,__type40>::type __type41;
      typedef decltype(pythonic::operator_::add(std::declval<__type41>(), std::declval<__type27>())) __type42;
      typedef typename __combined<__type41,__type42>::type __type43;
      typedef decltype(pythonic::operator_::add(std::declval<__type43>(), std::declval<__type27>())) __type44;
      typedef typename __combined<__type43,__type44>::type __type45;
      typedef decltype(pythonic::operator_::add(std::declval<__type45>(), std::declval<__type27>())) __type46;
      typedef typename __combined<__type45,__type46>::type __type47;
      typedef typename __combined<__type47,__type27>::type __type48;
      typedef decltype(pythonic::operator_::div(std::declval<__type48>(), std::declval<__type0>())) __type49;
      typedef typename pythonic::assignable<decltype(pythonic::types::make_tuple(std::declval<__type28>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>()))>::type __type50;
      typedef typename pythonic::assignable<typename std::tuple_element<3,typename std::remove_reference<__type50>::type>::type>::type __type51;
      typedef typename pythonic::assignable<typename std::tuple_element<2,typename std::remove_reference<__type50>::type>::type>::type __type52;
      typedef decltype(pythonic::operator_::mul(std::declval<__type51>(), std::declval<__type52>())) __type53;
      typedef typename pythonic::assignable<typename std::tuple_element<1,typename std::remove_reference<__type50>::type>::type>::type __type54;
      typedef decltype(pythonic::operator_::mul(std::declval<__type0>(), std::declval<__type54>())) __type55;
      typedef typename pythonic::assignable<typename std::tuple_element<5,typename std::remove_reference<__type50>::type>::type>::type __type56;
      typedef decltype(pythonic::operator_::mul(std::declval<__type55>(), std::declval<__type56>())) __type57;
      typedef decltype(pythonic::operator_::sub(std::declval<__type53>(), std::declval<__type57>())) __type58;
      typedef typename pythonic::assignable<typename std::tuple_element<4,typename std::remove_reference<__type50>::type>::type>::type __type59;
      typedef decltype(pythonic::operator_::mul(std::declval<__type0>(), std::declval<__type59>())) __type60;
      typedef decltype(pythonic::operator_::mul(std::declval<__type60>(), std::declval<__type56>())) __type61;
      typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::numpy::functor::square{})>::type>::type __type62;
      typedef decltype(std::declval<__type62>()(std::declval<__type51>())) __type63;
      typedef decltype(pythonic::operator_::sub(std::declval<__type61>(), std::declval<__type63>())) __type64;
      typedef decltype(pythonic::operator_::div(std::declval<__type58>(), std::declval<__type64>())) __type65;
      typedef decltype(pythonic::operator_::mul(std::declval<__type51>(), std::declval<__type54>())) __type66;
      typedef decltype(pythonic::operator_::mul(std::declval<__type0>(), std::declval<__type52>())) __type67;
      typedef decltype(pythonic::operator_::mul(std::declval<__type67>(), std::declval<__type59>())) __type68;
      typedef decltype(pythonic::operator_::sub(std::declval<__type66>(), std::declval<__type68>())) __type69;
      typedef decltype(pythonic::operator_::div(std::declval<__type69>(), std::declval<__type64>())) __type70;
      typedef typename pythonic::returnable<decltype(pythonic::types::make_tuple(std::declval<__type65>(), std::declval<__type70>(), std::declval<__type23>()))>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 >
  ...
  typename compute_subpix_2d_gaussian2::type<argument_type0, argument_type1, argument_type2>::result_type compute_subpix_2d_gaussian2::operator()(argument_type0&& correl, argument_type1&& ix, argument_type2&& iy) const
  {
    ...
    typedef decltype(pythonic::types::make_tuple(std::declval<__type5>(), std::declval<__type5>())) __type25;
    ...
    typedef decltype(pythonic::operator_::mul(std::declval<__type5>(), std::declval<__type27>())) __type28;
    typedef decltype(pythonic::operator_::add(std::declval<__type23>(), std::declval<__type28>())) __type29;
    typedef typename __combined<__type23,__type29>::type __type30;
    typedef decltype(pythonic::operator_::add(std::declval<__type30>(), std::declval<__type28>())) __type31;
    typedef typename __combined<__type30,__type31>::type __type32;
    typedef decltype(pythonic::operator_::add(std::declval<__type32>(), std::declval<__type28>())) __type33;
    typedef typename __combined<__type32,__type33>::type __type34;
    typedef decltype(pythonic::operator_::add(std::declval<__type34>(), std::declval<__type28>())) __type35;
    typedef typename __combined<__type34,__type35>::type __type36;
    typedef decltype(pythonic::operator_::add(std::declval<__type36>(), std::declval<__type28>())) __type37;
    ...
    typedef decltype(pythonic::operator_::add(std::declval<__type40>(), std::declval<__type28>())) __type41;
    typedef typename __combined<__type40,__type41>::type __type42;
    typedef decltype(pythonic::operator_::add(std::declval<__type42>(), std::declval<__type28>())) __type43;
    typedef typename __combined<__type42,__type43>::type __type44;
    typedef decltype(pythonic::operator_::add(std::declval<__type44>(), std::declval<__type28>())) __type45;
    typedef typename __combined<__type44,__type45>::type __type46;
    typedef decltype(pythonic::operator_::div(std::declval<__type28>(), std::declval<__type5>())) __type47;
    typedef typename __combined<__type46,__type28>::type __type48;
    typedef decltype(pythonic::operator_::div(std::declval<__type48>(), std::declval<__type5>())) __type49;
    typedef typename pythonic::assignable<decltype(pythonic::types::make_tuple(std::declval<__type47>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>()))>::type __type50;
    typename pythonic::assignable<typename __combined<__type22,__type18>::type>::type correl_crop = correl(pythonic::types::contiguous_slice(pythonic::operator_::sub(iy, 1L),pythonic::operator_::add(iy, 2L)),pythonic::types::contiguous_slice(pythonic::operator_::sub(ix, 1L),pythonic::operator_::add(ix, 2L)));
    ...
    typename pythonic::assignable<typename __combined<__type46,__type28>::type>::type c10 = 0L;
    typename pythonic::assignable<typename __combined<__type46,__type28>::type>::type c01 = 0L;
    typename pythonic::assignable<typename __combined<__type46,__type28>::type>::type c11 = 0L;
    typename pythonic::assignable<typename __combined<__type46,__type28>::type>::type c20 = 0L;
    typename pythonic::assignable<typename __combined<__type46,__type28>::type>::type c02 = 0L;
    ...
    typename pythonic::assignable<typename pythonic::assignable<decltype(pythonic::types::make_tuple(std::declval<__type47>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>(), std::declval<__type49>()))>::type>::type __tuple1 = pythonic::types::make_tuple(pythonic::operator_::div(pythonic::operator_::mul(-1L, pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 2L)))), 9L), pythonic::operator_::div(c10, 6L), pythonic::operator_::div(c01, 6L), pythonic::operator_::div(c11, 4L), pythonic::operator_::div(c20, 6L), pythonic::operator_::div(c02, 6L));
    typename pythonic::assignable<typename pythonic::assignable<typename std::tuple_element<1,typename std::remove_reference<__type50>::type>::type>::type>::type c10_ = std::get<1>(__tuple1);
    typename pythonic::assignable<typename pythonic::assignable<typename std::tuple_element<2,typename std::remove_reference<__type50>::type>::type>::type>::type c01_ = std::get<2>(__tuple1);
    typename pythonic::assignable<typename pythonic::assignable<typename std::tuple_element<3,typename std::remove_reference<__type50>::type>::type>::type>::type c11_ = std::get<3>(__tuple1);
    typename pythonic::assignable<typename pythonic::assignable<typename std::tuple_element<4,typename std::remove_reference<__type50>::type>::type>::type>::type c20_ = std::get<4>(__tuple1);
    typename pythonic::assignable<typename pythonic::assignable<typename std::tuple_element<5,typename std::remove_reference<__type50>::type>::type>::type>::type c02_ = std::get<5>(__tuple1);
...
PYTHRAN_MODULE_INIT(subpix)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.9",
                                      "2021-05-03 16:20:40.986766",
                                      "f277e17d898d5b8d5632f2fba362edea1795083867b75582d0280fe170cd7f8f");
    if(! theDoc)
        PYTHRAN_RETURN;
