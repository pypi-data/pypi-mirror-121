...
namespace __pythran_correl
{
  ...
  typename correl_numpy::type<argument_type0, argument_type1, argument_type2>::result_type correl_numpy::operator()(argument_type0&& im0, argument_type1&& im1, argument_type2&& disp_max) const
  {
    ...
    {
      long  __target140255127120528 = pythonic::operator_::add(disp_max, 1L);
      for (long  xiy=0L; xiy < __target140255127120528; xiy += 1L)
      {
        ...
        {
          long  __target140255127276848 = pythonic::operator_::add(disp_max, 1L);
          for (long  xix=0L; xix < __target140255127276848; xix += 1L)
          {
            ...
            {
              long  __target140255125702256 = nymax;
              for (long  iy=0L; iy < __target140255125702256; iy += 1L)
              {
                {
                  long  __target140255125695264 = pythonic::operator_::add(nx1, pythonic::builtins::functor::min{}(pythonic::operator_::add(pythonic::operator_::sub(pythonic::operator_::functor::floordiv()(nx0, 2L), pythonic::operator_::functor::floordiv()(nx1, 2L)), dispx), 0L));
                  for (long  ix=0L; ix < __target140255125695264; ix += 1L)
                  {
        ...
        {
          long  __target140255127277376 = disp_max;
          for (long  xix_=0L; xix_ < __target140255127277376; xix_ += 1L)
          {
            ...
            {
              long  __target140255125669488 = nymax;
              for (long  iy_=0L; iy_ < __target140255125669488; iy_ += 1L)
              {
                {
                  long  __target140255125489072 = pythonic::operator_::sub(nx1, pythonic::builtins::functor::max{}(pythonic::operator_::sub(pythonic::operator_::add(pythonic::operator_::add(pythonic::operator_::functor::floordiv()(nx0, 2L), pythonic::operator_::functor::floordiv()(nx1, 2L)), dispx_), nx0), 0L));
                  for (long  ix_=0L; ix_ < __target140255125489072; ix_ += 1L)
                  {
    ...
    {
      long  __target140255127121296 = disp_max;
      for (long  xiy_=0L; xiy_ < __target140255127121296; xiy_ += 1L)
      {
        ...
        {
          long  __target140255125639024 = pythonic::operator_::add(disp_max, 1L);
          for (long  xix__=0L; xix__ < __target140255125639024; xix__ += 1L)
          {
            ...
            {
              long  __target140255125538080 = nymax_;
              for (long  iy__=0L; iy__ < __target140255125538080; iy__ += 1L)
              {
                {
                  long  __target140255125501072 = pythonic::operator_::add(nx1, pythonic::builtins::functor::min{}(pythonic::operator_::add(pythonic::operator_::sub(pythonic::operator_::functor::floordiv()(nx0, 2L), pythonic::operator_::functor::floordiv()(nx1, 2L)), dispx__), 0L));
                  for (long  ix__=0L; ix__ < __target140255125501072; ix__ += 1L)
                  {
        ...
        {
          long  __target140255125578176 = disp_max;
          for (long  xix___=0L; xix___ < __target140255125578176; xix___ += 1L)
          {
            ...
            {
              long  __target140255126018128 = nymax_;
              for (long  iy___=0L; iy___ < __target140255126018128; iy___ += 1L)
              {
                {
                  long  __target140255126010896 = pythonic::operator_::sub(nx1, pythonic::builtins::functor::max{}(pythonic::operator_::sub(pythonic::operator_::add(pythonic::operator_::add(pythonic::operator_::functor::floordiv()(nx0, 2L), pythonic::operator_::functor::floordiv()(nx1, 2L)), dispx___), nx0), 0L));
                  for (long  ix___=0L; ix___ < __target140255126010896; ix___ += 1L)
                  {
...
PYTHRAN_MODULE_INIT(correl)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.10.0",
                                      "2021-09-30 15:37:32.966414",
                                      "c04146be8349ca926d8d5320ee87541568f19bc8fccf8da4ffdf3584cea10747");
    if(! theDoc)
        PYTHRAN_RETURN;
