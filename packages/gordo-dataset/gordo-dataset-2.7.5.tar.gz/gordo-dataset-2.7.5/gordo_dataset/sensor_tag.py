...
TAG_TO_ASSET = [
    ...
    TagPatternToAsset(re.compile(r"^kri.", re.IGNORECASE), "1175-kris"),
    ...
    TagPatternToAsset(re.compile(r"^osf.", re.IGNORECASE), "1774-osf"),
    TagPatternToAsset(re.compile(r"^hld.", re.IGNORECASE), "1970-mla"),
]
...
def normalize_sensor_tags(
    ...
    asset : str
            ...
            provided we will not attempt to deduce the asset from the tag name.
    default_asset : str
