import unittest
import TestrailLibrary ##import TestrailLibrary
#import ..src.TestrailLibrary 
import random
import string
import io
...
#from TestrailLibrary.apiclient import Apiclient
...
class BasicTests(unittest.TestCase):     
    ...
    def setUp(self) -> None:
        ...
        #TestrailLibrary.apiclient.Apiclient.send_get = Mock()
    ...
    def test_get_run_by_name_when_duplicates(self, mock_get):
        ...
        mock_get.return_value = runs.get
        with self.assertRaises(TestrailLibrary.DuplicateException): 
    ...
    @patch('TestrailLibrary.os.listdir')
    @patch('TestrailLibrary.Apiclient.send_post')
