...
###################################################################################
def firstmdl(x, y, w, cnames, st0, smin, mtp, ivi, pm0, metpminit, met_opt, maxiter, fcnv, afcnv, xcnv, gcnv, sc,
...
def mdl(x, y, w, ivi, n2, st0, pm0, cnames, metpminit, meth, maxiter, fcnv, afcnv, xcnv, gcnv, sc, dsp_op, smeth, su,
    ...
    grad = 1
    hes = 1
    pm, F, g, H, Hinv, __ = newton(pm, func, grad, hes, args, meth, maxiter, fcnv, afcnv, xcnv, gcnv, sc, dsp_op, smeth, su, p_decr, p_incr)
    # # Denormalization
...
###################################################################################
def swlogr(x, y, w, cnames=None, SLE=0.05, SLS=0.05, pm0=1, dsp='all', nbm_crit=np.array([]), mtp='full', met='SWR',
    ...
    iterate = 1
    st0 = stats(x, y, w, smin, pm0, cnames, metpminit, ivi, met_opt, maxiter, fcnv, afcnv, xcnv, gcnv, sc, dsp_op, dsp,
                smeth, su, p_decr, p_incr)
    model, step, st0 = firstmdl(x, y, w, cnames, st0, smin, mtp, ivi, pm0, metpminit, met_opt, maxiter, fcnv, afcnv,
                                xcnv, gcnv, sc, dsp_op, smeth, su, p_decr, p_incr)
    while iterate:
