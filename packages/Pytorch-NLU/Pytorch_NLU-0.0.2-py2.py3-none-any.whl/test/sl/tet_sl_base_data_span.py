...
if __name__ == "__main__":
    # 训练-验证语料地址, 可以只输入训练地址
    path_corpus = os.path.join(path_root, "corpus", "sequence_labeling", "ner_china_people_daily_1998_span")
    path_train = os.path.join(path_corpus, "train.span")
    path_dev = os.path.join(path_corpus, "dev.span")
