            ...
            for pallet_name,stacks in self.stacks.value.items():
                ...
                for stack in stacks:
                    for name,offset,part_size,kind,real_size in stack:
                        ...
                        p0 = pos[0] + offset[0], pos[1] + offset[1], pos[2] + offset[2]
                        p1 = pos[0] + offset[0], pos[1] + offset[1] + real_size[1], pos[2] + offset[2]
                        p2 = pos[0] + offset[0] + real_size[0], pos[1] + offset[1] + real_size[1], pos[2] + offset[2]
                        p3 = pos[0] + offset[0] + real_size[0], pos[1] + offset[1], pos[2] + offset[2]
                        self.rectangle(p0,p1,p2,p3)
