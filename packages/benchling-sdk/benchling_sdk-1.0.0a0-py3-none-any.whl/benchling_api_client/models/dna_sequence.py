...
from ..models.dna_sequence_entity_type import DnaSequenceEntityType
...
class DnaSequence:
    ...
    _entity_type: Union[Unset, DnaSequenceEntityType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _entity_type is not None and _entity_type is not UNSET:
            try:
                entity_type = DnaSequenceEntityType(_entity_type)
            except ValueError:
                entity_type = DnaSequenceEntityType.of_unknown(_entity_type)
    ...
    @property
    def entity_type(self) -> DnaSequenceEntityType:
        if isinstance(self._entity_type, Unset):
            raise NotPresentError(self, "entity_type")
        return self._entity_type

    @entity_type.setter
    def entity_type(self, value: DnaSequenceEntityType) -> None:
