...
from ..models.mixture_entity_type import MixtureEntityType
...
class Mixture:
    ...
    _entity_type: Union[Unset, MixtureEntityType] = UNSET
    _fields: Union[Unset, MixtureFields] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _entity_type is not None and _entity_type is not UNSET:
            try:
                entity_type = MixtureEntityType(_entity_type)
            except ValueError:
                entity_type = MixtureEntityType.of_unknown(_entity_type)

        fields: Union[Unset, MixtureFields] = UNSET
        _fields = d.pop("fields", UNSET)
        if not isinstance(_fields, Unset):
            fields = MixtureFields.from_dict(_fields)
    ...
    @property
    def entity_type(self) -> MixtureEntityType:
        if isinstance(self._entity_type, Unset):
            raise NotPresentError(self, "entity_type")
        return self._entity_type

    @entity_type.setter
    def entity_type(self, value: MixtureEntityType) -> None:
