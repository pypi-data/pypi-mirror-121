...
class Batch:
    ...
    _entity: Union[Unset, DnaSequence, AaSequence, CustomEntity, UnknownType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ) -> Union[Unset, DnaSequence, AaSequence, CustomEntity, UnknownType]:
            entity: Union[Unset, DnaSequence, AaSequence, CustomEntity, UnknownType]
    ...
    @property
    def entity(self) -> Union[DnaSequence, AaSequence, CustomEntity, UnknownType]:
        if isinstance(self._entity, Unset):
            raise NotPresentError(self, "entity")
        return self._entity

    @entity.setter
    def entity(self, value: Union[DnaSequence, AaSequence, CustomEntity, UnknownType]) -> None:
        self._entity = value
