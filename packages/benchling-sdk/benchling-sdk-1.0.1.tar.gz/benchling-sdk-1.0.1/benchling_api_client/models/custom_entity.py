...
from ..models.custom_entity_entity_type import CustomEntityEntityType
...
class CustomEntity:
    ...
    _entity_type: Union[Unset, CustomEntityEntityType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _entity_type is not None and _entity_type is not UNSET:
            try:
                entity_type = CustomEntityEntityType(_entity_type)
            except ValueError:
                entity_type = CustomEntityEntityType.of_unknown(_entity_type)
    ...
    @property
    def entity_type(self) -> CustomEntityEntityType:
        if isinstance(self._entity_type, Unset):
            raise NotPresentError(self, "entity_type")
        return self._entity_type

    @entity_type.setter
    def entity_type(self, value: CustomEntityEntityType) -> None:
