...
from tflash import string_int_label_map_pb2
...
def convert_to_categories(label_map, max_num_classes, use_display_name=True):
...
def load(path):
    ...
    num_classes = max([item.id for item in label_map.item])
