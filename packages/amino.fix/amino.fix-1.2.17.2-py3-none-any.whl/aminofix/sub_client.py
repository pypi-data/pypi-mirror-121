...
class SubClient(client.Client):
    ...
    def get_chat_messages(self, chatId: str, size: int = 25, pageToken: str = None):
        ...
        **Returns**
            - **Success** : :meth:`Message List <aminofix.lib.util.objects.MessageList>`
    ...
    def get_blog_comments(self, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None, sorting: str = "newest", start: int = 0, size: int = 25):
        ...
        if blogId or quizId:
            if quizId is not None: blogId = quizId
            response = requests.get(f"{self.apip}/x{self.comId}/s/blog/{blogId}/comment?sort={sorting}&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif wikiId: response = requests.get(f"{self.apip}/x{self.comId}/s/item/{wikiId}/comment?sort={sorting}&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
    ...
    def edit_chat(self, chatId: str, doNotDisturb: bool = None, pinChat: bool = None, title: str = None, icon: str = None, backgroundImage: str = None, content: str = None, announcement: str = None, coHosts: list = None, keywords: list = None, pinAnnouncement: bool = None, publishToGlobal: bool = None, canTip: bool = None, viewOnly: bool = None, canInvite: bool = None, fansOnly: bool = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.apip}/x{self.comId}/s/chat/thread/{chatId}", headers=headers.Headers().s_headers, data=data, verify=self.certificatePath)
        if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
        else: res.append(response.status_code)
    ...
    def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None, isGuest: bool = False):
        ...
        if userId:
            ...
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/{comType}", headers=headers.Headers().s_headers, data=data, verify=self.certificatePath)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{blogId}/{comType}", headers=headers.Headers().s_headers, data=data, verify=self.certificatePath)
    ...
    def delete_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        if userId: response = requests.delete(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/comment/{commentId}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif blogId: response = requests.delete(f"{self.apip}/x{self.comId}/s/blog/{blogId}/comment/{commentId}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        ...
        **Returns**
        ...
        if blogId:
            if isinstance(blogId, str):
                data["eventSource"] = "UserProfileView"
                data = json.dumps(data)
                response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{blogId}/vote?cv=1.2", headers=headers.Headers().s_headers, data=data, verify=self.certificatePath)

            elif isinstance(blogId, list):
                data["targetIdList"] = blogId
                data = json.dumps(data)
                response = requests.post(f"{self.apip}/x{self.comId}/s/feed/vote", headers=headers.Headers().s_headers, data=data, verify=self.certificatePath)
    ...
    def unlike_blog(self, blogId: str = None, wikiId: str = None):
        if blogId: response = requests.delete(f"{self.apip}/x{self.comId}/s/blog/{blogId}/vote?eventSource=UserProfileView", headers=headers.Headers().s_headers, verify=self.certificatePath)
    ...
    def like_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        if userId:
            data["eventSource"] = "UserProfileView"
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/comment/{commentId}/vote?cv=1.2&value=1", headers=headers.Headers().s_headers, data=data, verify=self.certificatePath)
    ...
    def unlike_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        if userId: response = requests.delete(f"{self.apip}/x{self.comId}/s/user-profile/{userId}/comment/{commentId}/g-vote?eventSource=UserProfileView", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif blogId: response = requests.delete(f"{self.apip}/x{self.comId}/s/blog/{blogId}/comment/{commentId}/g-vote?eventSource=PostDetailView", headers=headers.Headers().s_headers, verify=self.certificatePath)
    ...
    def send_active_obj(self, startTime: int = None, endTime: int = None, optInAdsFlags: int = 2147483647, tz: int = -timezone // 1000, timers: list = None, timestamp: int = int(timestamp() * 1000)):
        ...
        response = requests.post(f"{self.apip}/x{self.comId}/s/community/stats/user-active-time", headers=headers.Headers(data=data, sig=signature, deviceId=self.device_id).headers, data=data, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def get_all_users(self, type: str = "recent", start: int = 0, size: int = 25):
        if type == "recent": response = requests.get(f"{self.apip}/x{self.comId}/s/user-profile?type=recent&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif type == "banned": response = requests.get(f"{self.apip}/x{self.comId}/s/user-profile?type=banned&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif type == "featured": response = requests.get(f"{self.apip}/x{self.comId}/s/user-profile?type=featured&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif type == "leaders": response = requests.get(f"{self.apip}/x{self.comId}/s/user-profile?type=leaders&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
    ...
    def get_user_info(self, userId: str):
        ...
        **Parameters**
            - **userId** : ID of the User.
        **Returns**
            - **Success** : :meth:`User Object <aminofix.lib.util.objects.UserProfile>`
            - **Fail** : :meth:`Exceptions <aminofix.lib.util.exceptions>`
        """
    ...
    def get_user_visitors(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Parameters**
            ...
            - *size* : Size of the list.
        **Returns**
            - **Success** : :meth:`Visitors List <amino.libfix.util.objects.visitorsList>`
            - **Fail** : :meth:`Exceptions <aminofix.lib.util.exceptions>`
        """
    ...
    def get_leaderboard_info(self, type: str, start: int = 0, size: int = 25):
        if "24" in type or "hour" in type: response = requests.get(f"{self.apip}/g/s-x{self.comId}/community/leaderboard?rankingType=1&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif "7" in type or "day" in type: response = requests.get(f"{self.apip}/g/s-x{self.comId}/community/leaderboard?rankingType=2&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif "rep" in type: response = requests.get(f"{self.apip}/g/s-x{self.comId}/community/leaderboard?rankingType=3&start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
    ...
    def get_tipped_users(self, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None, chatId: str = None, start: int = 0, size: int = 25):
        if blogId or quizId:
            if quizId is not None: blogId = quizId
            response = requests.get(f"{self.apip}/x{self.comId}/s/blog/{blogId}/tipping/tipped-users-summary?start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif wikiId: response = requests.get(f"{self.apip}/x{self.comId}/s/item/{wikiId}/tipping/tipped-users-summary?start={start}&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
    ...
    def moderation_history(self, userId: str = None, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None, size: int = 25):
        if userId: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?objectId={userId}&objectType=0&pagingType=t&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif blogId: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?objectId={blogId}&objectType=1&pagingType=t&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
        elif quizId: response = requests.get(f"{self.apip}/x{self.comId}/s/admin/operation?objectId={quizId}&objectType=1&pagingType=t&size={size}", headers=headers.Headers().s_headers, verify=self.certificatePath)
    ...
    def feature(self, time: int, userId: str = None, chatId: str = None, blogId: str = None, wikiId: str = None):
        ...
        if userId:
            ...
            data["adminOpValue"] = {"featuredType": 1}
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/item/{wikiId}/admin", headers=headers.Headers().s_headers, data=data, verify=self.certificatePath)
    ...
    def hide(self, userId: str = None, chatId: str = None, blogId: str = None, wikiId: str = None, quizId: str = None, fileId: str = None, reason: str = None):
        ...
        if userId:
            ...
            data["adminOpValue"] = 9
            data = json.dumps(data)
            response = requests.post(f"{self.apip}/x{self.comId}/s/blog/{quizId}/admin", headers=headers.Headers().s_headers, data=data, verify=self.certificatePath)
