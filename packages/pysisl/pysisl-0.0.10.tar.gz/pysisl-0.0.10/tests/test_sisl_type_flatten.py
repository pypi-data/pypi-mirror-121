...
class SislFlatteningTests(unittest.TestCase):
    ...
    def test_anonymous_string(self):
        self.assertEqual("stuff", SISLTypeFlatten.flatten({"_": {"type": "_str", "value": "stuff"}}))
    ...
    def test_two_element_list(self):
        ...
        self.assertEqual({"abc": [[1], [5]]}, SISLTypeFlatten.flatten(
            {"abc": {"type": "list", "value": {
                "_0": {"type": "list", "value": {"_0": {"type": "int", "value": "1"}}},
                "_1": {"type": "list", "value": {"_0": {"type": "int", "value": "5"}}}
            }}}))
    ...
    def test_single_element_anonymous_list(self):
        self.assertEqual([1], SISLTypeFlatten.flatten({"_": {"type": "_list", "value": {"_0": {"type": "int", "value": "1"}}}}))

    def test_two_element_anonymous_list(self):
        self.assertEqual([1, 5], SISLTypeFlatten.flatten(
            {"_": {"type": "_list", "value": {
                "_0": {"type": "int", "value": "1"},
                "_1": {"type": "int", "value": "5"}
            }}}))
