...
def chemistry_factory(obj_type):
    if obj_type is None:
        log.warning("No chemistry given. If you want one, set chemistry type. See pytmosph3r.chemistry and pytmosph3r.InputAtmosphere.chemistry for more information.")
        return None
    if obj_type.lower() in ('parmentier2018','dissociation'):
        ...
        log.error("No chemistry given. If you want one, set chemistry type with %s.")
        chemistry = None
    else:
