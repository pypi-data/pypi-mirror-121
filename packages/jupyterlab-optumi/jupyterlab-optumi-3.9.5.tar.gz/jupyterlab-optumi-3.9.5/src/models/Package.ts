...
export class Package {
    ...
    constructor(timestamp: Date, nbKey: string, label: string, packageState: PackageState, originalNotebook: any, originalConfig: OptumiConfig, optimizedNotebook: any, optimizedConfig: OptumiConfig) {
    ...
    static fromMap(map: any = {}): Package {
        return new Package(new Date(map.timestamp), map.nbKey, map.label, map.packageState as PackageState, 
