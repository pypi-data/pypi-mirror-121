...
class PackageStepper extends React.Component<IProps, IState> {
    ...
    constructor(props: IProps) {
        ...
        this.state = Object.assign({
            ...
            notebookRuns: optumi.package.notebookRuns,
            runHours: optumi.package.runHours,
            runMinutes: optumi.package.runMinutes,
            runPlatform: optumi.package.runPlatform,
            kaggleAccelerator: optumi.package.kaggleAccelerator,
