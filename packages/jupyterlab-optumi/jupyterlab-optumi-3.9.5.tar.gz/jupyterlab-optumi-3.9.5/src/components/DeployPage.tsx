		...
		const flipCardHeader = (
			<div style={{display: 'inline-flex', width: '100%'}}>
				...
				<span style={{
					...
					{this.state.isFlipped ? 'Manual' : 'Automatic'}
				</span>
				<IconButton
					onClick={() => {
									...
									>
										<div>
											...
											{!this.state.isFlipped && (
												<>
													{!Global.metadata.isFirstPackage() && (<PreviewLaunchButton key={'preview-launch'}/>)}
												</>
											)}
										</div>
										...
										<div>
											...
											{this.state.isFlipped && (
												<>
													<PreviewLaunchButton key={'preview-launch'}/>
												</>
											)}
										</div>
									</ReactCardFlip>
