...
import { Theme, withTheme, Stepper as OtherStepper } from '@material-ui/core'
...
class Stepper extends React.Component<IProps, IState> {
    ...
    private setStepDisabled = (step: number, disabled: boolean): void => {
        this.state.stepsDisabled[step] = disabled
    }

    private setStepComplete = (step: number, complete: boolean): void => {
        this.state.stepsCompleted[step] = complete
    }

    private setStepError = (step: number, error: boolean): void => {
        this.state.stepsErrored[step] = error
    }
    ...
    public render = (): JSX.Element => {
        ...
        return (
            <OtherStepper
                style={Object.assign({padding: '12px'}, this.props.style)}
...
const ThemedStepper = withTheme(Stepper)
export { ThemedStepper as Stepper }