...
import { Step as OtherStep, StepContent, StepButton, Button, StepIcon, SvgIcon, StepConnector, useTheme, withStyles } from '@material-ui/core';
...
export default function Step(props: IProps) {
    const {
        ...
        step, stepperCallbacks, children, style,
    ...
    return (
        ...
        >
            ...
            <StepContent style={{marginTop: '4px'}}>
                {children}
                {!actuallyDisabled && (
