...
'''
GL 09/03/2017
 This is minimal implementation of PDB parsing and coordinates mangament
...
class Structure(object):
	...
	def getResID(self):
		...
		return self._resID
	# Browse model and create a new pdbObject with a sinlge model that satifies the provided conditions
