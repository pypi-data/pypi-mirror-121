...
class Statistics:
    ...
    graph_objects_cache_exceedes_loaded_count: OrderedDict = None
    ...
    def __init__(self, manager):
        ...
        self.graph_objects_cache_exceedes_loaded_count = OrderedDict()
    ...
    def update_statistics(
        ...
        self.graph_objects_cache_exceedes_loaded_count[current_time] = (
            self.get_cached_graphobjects_total() - self.get_loaded_graphobjects_total()
        )
    ...
    def get_mean_graph_objects_cache_exceedes_loaded_count(
        self,
        timeframe: int = 120,
        graphset_type: Type[Union[graphio.NodeSet, graphio.RelationshipSet]] = None,
    ) -> int:
        ...
        for (
            timestamp,
            graph_objects_count,
        ) in self.graph_objects_cache_exceedes_loaded_count.items():
            if timestamp > timeframe_start:
    ...
    def get_report(self):
        ...
        sync_rep["cache_to_load_advantage_count_current"] = {
            ...
            "desc": "Current exceeding cached graphobjects compared to loaded",
            "humanfriendly_transformer": humanfriendly.format_number,
        }

        sync_rep["cache_to_load_advantage_count_mean"] = {
            "val": self.get_mean_graph_objects_cache_exceedes_loaded_count(),
            "desc": "Mean exceeding cached graphobjects compared to loaded",
            "humanfriendly_transformer": humanfriendly.format_number,
        }

        sync_rep["cache_to_load_advantage_count_max"] = {
            "val": self.manager.strategy.max_advantage_cache_graphobjects_count,
            "desc": "Max exceeding graphobjects count before pausing sourcing workers",
            "humanfriendly_transformer": humanfriendly.format_number,
        }
