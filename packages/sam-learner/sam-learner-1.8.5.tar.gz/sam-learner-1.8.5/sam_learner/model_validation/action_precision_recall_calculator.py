...
def calculate_true_positive_value(
	...
	:return:
	"""
	return len(set(learned_predicates).intersection(set(expected_predicates)))
...
def calculate_false_positive_value(
	...
	:return:
	"""
	return len(set(learned_predicates).difference(set(expected_predicates)))
...
def calculate_false_negative_value(
	...
	:return:
	"""
	return len(set(expected_predicates).difference(set(learned_predicates)))


def calculate_recall(
		learned_preconditions: List[ComparablePredicate], actual_preconditions: List[ComparablePredicate]) -> float:
	"""

	:param learned_preconditions:
	:param actual_preconditions:
	:return:
	"""
	true_positives = calculate_true_positive_value(learned_preconditions, actual_preconditions)
	false_negatives = calculate_false_negative_value(learned_preconditions, actual_preconditions)
...
def calculate_precision(
	...
	"""
	true_positives = calculate_true_positive_value(learned_preconditions, actual_preconditions)
	false_positives = calculate_false_positive_value(learned_preconditions, actual_preconditions)
