...
from sam_learner.sam_models import ComparablePredicate, Trajectory

STATISTICS_COLUMNS_NAMES = ["domain_name", "num_trajectories", "action_name", "number_consistent_models"]
...
class SafeConsistentModelsCalculator:
	...
	def calculate_safe_models_consistency(
			...
			trajectories: List[Trajectory], known_actions: List[str]) -> NoReturn:
		"""
