...
def calculate_false_positive_value(
	...
	:return:
	"""
	return len([predicate for predicate in learned_predicates if predicate not in expected_predicates])
...
def calculate_false_negative_value(
	...
	:return:
	"""
	return len([predicate for predicate in expected_predicates if predicate in learned_predicates])
