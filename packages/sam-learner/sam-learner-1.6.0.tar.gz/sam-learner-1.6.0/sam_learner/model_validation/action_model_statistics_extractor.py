...
class AMStatisticsExtractor:
	...
	def write_learned_actions_statistics(
		...
		for action_name in learned_actions:
			...
			action_statistics["learned_preconditions"] = [str(precond) for precond in action_preconditions]
			action_statistics["learned_add_effects"] = [str(add_effect) for add_effect in action_add_effects]
			action_statistics["learned_delete_effects"] = [str(del_effect) for del_effect in action_delete_effects]
