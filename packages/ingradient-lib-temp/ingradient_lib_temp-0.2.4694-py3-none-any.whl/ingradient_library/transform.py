...
class Transform(object):
    ...
    def __call__(self, images, seg, info):
        ...
        print("error check transform_2", torch.unique(seg))
        ...
        print("error check transform_3", torch.unique(seg))
