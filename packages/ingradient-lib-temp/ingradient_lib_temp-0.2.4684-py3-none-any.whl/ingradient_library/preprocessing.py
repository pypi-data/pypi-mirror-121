...
class Resampling(object):
    def __init__(self, anisotropy_axis_index = None, target_spacing = [1.0, 1.0, 1.0], random = False):
        self.device = None
    ...
    def __call__(self, data, info_data, mode = 'x'):
        ...
        if self.random:
            self.target_spacing = original_spacing * np.random.uniform(0.20, 5.0, size = original_spacing.shape)
