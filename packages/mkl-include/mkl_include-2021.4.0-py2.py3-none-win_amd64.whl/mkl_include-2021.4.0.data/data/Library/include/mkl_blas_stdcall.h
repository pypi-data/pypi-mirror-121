...
void __stdcall HGEMM(const char *transa, int transa_len, const char *transb, int transb_len,
...
size_t  __stdcall HGEMM_PACK_GET_SIZE (const char *identifier, int identifier_len, const MKL_INT *m, 
                                       const MKL_INT *n, const MKL_INT *k);
void  __stdcall HGEMM_PACK (const char *identifier, int identifier_len, const char *trans, 
...
void  __stdcall HGEMM_COMPUTE(const char *transa, int transa_len, const char *transb, int transb_len, 
                              const MKL_INT *m, const MKL_INT *n, const MKL_INT *k,
